...
class NullableArrayOfOneBinaries_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableArrayOfOneBinaries_5 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableArrayOfOneBinaries_5("+ URI +")"

   def copy(nullableArrayOfOneBinaries: Option[Array[Array[Byte]]] = this._nullableArrayOfOneBinaries): NullableArrayOfOneBinaries_5 = {
  ...
  com.dslplatform.api.Guards.checkArrayNulls(nullableArrayOfOneBinaries)
    new NullableArrayOfOneBinaries_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableArrayOfOneBinaries = nullableArrayOfOneBinaries)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableArrayOfOneBinaries_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableArrayOfOneBinaries_5](URI), duration)
  }
...
object NullableArrayOfOneBinaries_5 extends AggregateRootCompanion[NullableArrayOfOneBinaries_5]{
  ...
  def apply(
    ...
    require(nullableArrayOfOneBinaries ne null, "Null value was provided for property \"nullableArrayOfOneBinaries\"")
    if (nullableArrayOfOneBinaries.isDefined) require(nullableArrayOfOneBinaries.get ne null, "Null value was provided for property \"nullableArrayOfOneBinaries\"")
    new NullableArrayOfOneBinaries_5(
      __locator = None
