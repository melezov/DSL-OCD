...
case object `dsl.Linked List<Json>`   extends DslJson with `box.OneLinkedListOfOne`
case object `dsl.Linked List<Json>?`  extends DslJson with `box.NullableLinkedListOfOne`
case object `dsl.Linked List<Json?>`  extends DslJson with `box.OneLinkedListOfNullable`
case object `dsl.Linked List<Json?>?` extends DslJson with `box.NullableLinkedListOfNullable`
case object `dsl.Stack<Json>`         extends DslJson with `box.OneStackOfOne`
case object `dsl.Stack<Json>?`        extends DslJson with `box.NullableStackOfOne`
case object `dsl.Stack<Json?>`        extends DslJson with `box.OneStackOfNullable`
case object `dsl.Stack<Json?>?`       extends DslJson with `box.NullableStackOfNullable`
case object `dsl.Vector<Json>`        extends DslJson with `box.OneVectorOfOne`
case object `dsl.Vector<Json>?`       extends DslJson with `box.NullableVectorOfOne`
case object `dsl.Vector<Json?>`       extends DslJson with `box.OneVectorOfNullable`
case object `dsl.Vector<Json?>?`      extends DslJson with `box.NullableVectorOfNullable`

object DslJsonGrammarAliases1 {
  case object `dsl.JSON`                extends DslJson with `box.One`
  case object `dsl.JSON?`               extends DslJson with `box.Nullable`
  case object `dsl.ARRAY<JSON>`         extends DslJson with `box.OneArrayOfOne`
  case object `dsl.JSON[]`              extends DslJson with `box.OneBracketsOfOne`
