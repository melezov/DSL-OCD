...
public final class OneArrayOfOneMapsValue3 implements java.io.Serializable {
    public OneArrayOfOneMapsValue3(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1240123331;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfOneMapsValue3)) return false;
        final OneArrayOfOneMapsValue3 other = (OneArrayOfOneMapsValue3) obj;
    ...
    public String toString() {
        return "OneArrayOfOneMapsValue3(" + oneArrayOfOneMaps + ')';
    }
    ...
    public OneArrayOfOneMapsValue3 setOneArrayOfOneMaps(
