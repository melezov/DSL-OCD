...
class NullableSetOfOneXmls_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableSetOfOneXmls_5 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableSetOfOneXmls_5("+ URI +")"

   def copy(nullableSetOfOneXmls: Option[Set[scala.xml.Elem]] = this._nullableSetOfOneXmls): NullableSetOfOneXmls_5 = {
  ...
  com.dslplatform.api.Guards.checkCollectionNulls(nullableSetOfOneXmls)
    new NullableSetOfOneXmls_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableSetOfOneXmls = nullableSetOfOneXmls)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableSetOfOneXmls_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableSetOfOneXmls_5](URI), duration)
  }
...
object NullableSetOfOneXmls_5 extends AggregateRootCompanion[NullableSetOfOneXmls_5]{
