...
public final class NullableSetOfNullableIntegersValue6 implements
        java.io.Serializable {
    public NullableSetOfNullableIntegersValue6(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 2020502185;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof NullableSetOfNullableIntegersValue6))
            return false;
        final NullableSetOfNullableIntegersValue6 other = (NullableSetOfNullableIntegersValue6) obj;
    ...
    public String toString() {
        return "NullableSetOfNullableIntegersValue6("
    ...
    public NullableSetOfNullableIntegersValue6 setNullableSetOfNullableIntegers(
