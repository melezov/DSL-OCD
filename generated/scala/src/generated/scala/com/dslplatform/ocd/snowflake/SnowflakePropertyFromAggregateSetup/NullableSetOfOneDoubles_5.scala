...
class NullableSetOfOneDoubles_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableSetOfOneDoubles_5 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableSetOfOneDoubles_5("+ URI +")"

   def copy(nullableSetOfOneDoubles: Option[Set[Double]] = this._nullableSetOfOneDoubles): NullableSetOfOneDoubles_5 = {
  ...
  if(nullableSetOfOneDoubles.isDefined) require(nullableSetOfOneDoubles.get ne null, "Null value was provided for property \"nullableSetOfOneDoubles\"")
    new NullableSetOfOneDoubles_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableSetOfOneDoubles = nullableSetOfOneDoubles)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableSetOfOneDoubles_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableSetOfOneDoubles_5](URI), duration)
  }
...
object NullableSetOfOneDoubles_5 extends AggregateRootCompanion[NullableSetOfOneDoubles_5]{
