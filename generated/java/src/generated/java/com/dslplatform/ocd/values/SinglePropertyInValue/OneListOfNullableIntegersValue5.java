...
public final class OneListOfNullableIntegersValue5 implements
        java.io.Serializable {
    public OneListOfNullableIntegersValue5(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1062354021;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneListOfNullableIntegersValue5)) return false;
        final OneListOfNullableIntegersValue5 other = (OneListOfNullableIntegersValue5) obj;
    ...
    public String toString() {
        return "OneListOfNullableIntegersValue5(" + oneListOfNullableIntegers
                + ')';
    }
    ...
    public OneListOfNullableIntegersValue5 setOneListOfNullableIntegers(
