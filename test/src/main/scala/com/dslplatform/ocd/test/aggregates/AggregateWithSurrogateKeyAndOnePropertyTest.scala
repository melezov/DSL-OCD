...
//
//  private val dslPath =
//    s"aggregates/${ModuleName}/${propertyType.typeNameSafe}/${AggregateName}.dsl"
//
//  private val dslBody =
//s"""module ${ModuleName}
//{
...
//      // testing the surrogate primary key
//      new TestJavaPropertyFieldType {
//        def conceptName = concept
//        def propertyName = "ID"
//        def propertyType = `java.Integer`
...
//    , new TestJavaPropertyFieldType {
//        def conceptName = concept
//        def propertyName = "URI"
//        def propertyType = `java.String`
//        def visibility = Visibility.Private
//        def modifiers = Set.empty
//      }
//    , new TestJavaPropertyGetterType {
