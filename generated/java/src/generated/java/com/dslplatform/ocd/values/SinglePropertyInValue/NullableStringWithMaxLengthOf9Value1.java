...
public final class NullableStringWithMaxLengthOf9Value1 implements
        java.io.Serializable {
    public NullableStringWithMaxLengthOf9Value1(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1531203436;
        result = prime
                * result
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof NullableStringWithMaxLengthOf9Value1))
            return false;
        final NullableStringWithMaxLengthOf9Value1 other = (NullableStringWithMaxLengthOf9Value1) obj;
    ...
    public String toString() {
        return "NullableStringWithMaxLengthOf9Value1("
    ...
    public NullableStringWithMaxLengthOf9Value1 setNullableStringWithMaxLengthOf9(
            final String value) {
        if (value != null)
