...
public final class NullableListOfOneImagesValue6 implements
        java.io.Serializable {
    public NullableListOfOneImagesValue6(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1894389303;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof NullableListOfOneImagesValue6)) return false;
        final NullableListOfOneImagesValue6 other = (NullableListOfOneImagesValue6) obj;
    ...
    public String toString() {
        return "NullableListOfOneImagesValue6(" + nullableListOfOneImages + ')';
    }
    ...
    public NullableListOfOneImagesValue6 setNullableListOfOneImages(
