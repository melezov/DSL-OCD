...
class NullableSetOfNullableDecimals_2 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableSetOfNullableDecimals_2 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableSetOfNullableDecimals_2("+ URI +")"

   def copy(nullableSetOfNullableDecimals: Option[Set[Option[BigDecimal]]] = this._nullableSetOfNullableDecimals): NullableSetOfNullableDecimals_2 = {
  ...
  com.dslplatform.api.Guards.checkCollectionOptionRefNulls(nullableSetOfNullableDecimals)
    new NullableSetOfNullableDecimals_2(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableSetOfNullableDecimals = nullableSetOfNullableDecimals)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.aggregates.SurrogatePrimaryKeyWithOnePropertyInAggregate.NullableSetOfNullableDecimals_2): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.aggregates.SurrogatePrimaryKeyWithOnePropertyInAggregate.NullableSetOfNullableDecimals_2](URI), duration)
  }

  @com.fasterxml.jackson.annotation.JsonGetter("nullableSetOfNullableDecimals")
...
object NullableSetOfNullableDecimals_2 extends AggregateRootCompanion[NullableSetOfNullableDecimals_2]{
  ...
  def apply(
    ...
    require(nullableSetOfNullableDecimals ne null, "Null value was provided for property \"nullableSetOfNullableDecimals\"")
    if (nullableSetOfNullableDecimals.isDefined) require(nullableSetOfNullableDecimals.get ne null, "Null value was provided for property \"nullableSetOfNullableDecimals\"")
    new NullableSetOfNullableDecimals_2(
      __locator = None
