...
public final class OneArrayOfNullableDecimalsWithScaleOf9Value1 implements
        java.io.Serializable {
    public OneArrayOfNullableDecimalsWithScaleOf9Value1(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1051371111;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfNullableDecimalsWithScaleOf9Value1))
            return false;
        final OneArrayOfNullableDecimalsWithScaleOf9Value1 other = (OneArrayOfNullableDecimalsWithScaleOf9Value1) obj;
    ...
    public String toString() {
        return "OneArrayOfNullableDecimalsWithScaleOf9Value1("
    ...
    public OneArrayOfNullableDecimalsWithScaleOf9Value1 setOneArrayOfNullableDecimalsWithScaleOf9(
