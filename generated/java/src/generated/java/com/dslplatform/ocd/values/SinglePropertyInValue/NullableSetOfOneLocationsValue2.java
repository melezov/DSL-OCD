...
public final class NullableSetOfOneLocationsValue2 implements
        java.io.Serializable {
    public NullableSetOfOneLocationsValue2(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1037664037;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof NullableSetOfOneLocationsValue2)) return false;
        final NullableSetOfOneLocationsValue2 other = (NullableSetOfOneLocationsValue2) obj;
    ...
    public String toString() {
        return "NullableSetOfOneLocationsValue2(" + nullableSetOfOneLocations
                + ')';
    }
    ...
    public NullableSetOfOneLocationsValue2 setNullableSetOfOneLocations(
