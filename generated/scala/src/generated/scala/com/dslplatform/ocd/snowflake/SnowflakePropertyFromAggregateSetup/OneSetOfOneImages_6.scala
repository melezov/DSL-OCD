...
class OneSetOfOneImages_6 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: OneSetOfOneImages_6 => c.URI == URI
    case _ => false
  }

  override def toString = "OneSetOfOneImages_6("+ URI +")"

   def copy(oneSetOfOneImages: Set[java.awt.image.BufferedImage] = this._oneSetOfOneImages): OneSetOfOneImages_6 = {
  ...
  com.dslplatform.api.Guards.checkCollectionNulls(oneSetOfOneImages)
    new OneSetOfOneImages_6(_URI = this.URI, __locator = this.__locator, _ID = _ID, _oneSetOfOneImages = oneSetOfOneImages)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneSetOfOneImages_6): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneSetOfOneImages_6](URI), duration)
  }
...
object OneSetOfOneImages_6 extends AggregateRootCompanion[OneSetOfOneImages_6]{
