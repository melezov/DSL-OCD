...
class NullableListOfNullableTexts_2 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableListOfNullableTexts_2 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableListOfNullableTexts_2("+ URI +")"

   def copy(nullableListOfNullableTexts: Option[IndexedSeq[Option[String]]] = this._nullableListOfNullableTexts): NullableListOfNullableTexts_2 = {
  ...
  com.dslplatform.api.Guards.checkCollectionOptionRefNulls(nullableListOfNullableTexts)
    new NullableListOfNullableTexts_2(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableListOfNullableTexts = nullableListOfNullableTexts)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.aggregates.SurrogatePrimaryKeyWithOnePropertyInAggregate.NullableListOfNullableTexts_2): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.aggregates.SurrogatePrimaryKeyWithOnePropertyInAggregate.NullableListOfNullableTexts_2](URI), duration)
  }

  @com.fasterxml.jackson.annotation.JsonGetter("nullableListOfNullableTexts")
...
object NullableListOfNullableTexts_2 extends AggregateRootCompanion[NullableListOfNullableTexts_2]{
  ...
  def apply(
    ...
    require(nullableListOfNullableTexts ne null, "Null value was provided for property \"nullableListOfNullableTexts\"")
    if (nullableListOfNullableTexts.isDefined) require(nullableListOfNullableTexts.get ne null, "Null value was provided for property \"nullableListOfNullableTexts\"")
    new NullableListOfNullableTexts_2(
      __locator = None
