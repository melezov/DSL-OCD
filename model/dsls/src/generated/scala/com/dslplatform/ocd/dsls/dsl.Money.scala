...
sealed abstract class DslMoney
...
case object `dsl.Linked List<Money>`   extends DslMoney with `box.OneLinkedListOfOne`
case object `dsl.Linked List<Money>?`  extends DslMoney with `box.NullableLinkedListOfOne`
case object `dsl.Linked List<Money?>`  extends DslMoney with `box.OneLinkedListOfNullable`
case object `dsl.Linked List<Money?>?` extends DslMoney with `box.NullableLinkedListOfNullable`
case object `dsl.Stack<Money>`         extends DslMoney with `box.OneStackOfOne`
case object `dsl.Stack<Money>?`        extends DslMoney with `box.NullableStackOfOne`
case object `dsl.Stack<Money?>`        extends DslMoney with `box.OneStackOfNullable`
case object `dsl.Stack<Money?>?`       extends DslMoney with `box.NullableStackOfNullable`
case object `dsl.Vector<Money>`        extends DslMoney with `box.OneVectorOfOne`
case object `dsl.Vector<Money>?`       extends DslMoney with `box.NullableVectorOfOne`
case object `dsl.Vector<Money?>`       extends DslMoney with `box.OneVectorOfNullable`
case object `dsl.Vector<Money?>?`      extends DslMoney with `box.NullableVectorOfNullable`

object DslMoneyGrammarAliases1 {
  case object `dsl.MONEY`                extends DslMoney with `box.One`
  case object `dsl.MONEY?`               extends DslMoney with `box.Nullable`
  case object `dsl.ARRAY<MONEY>`         extends DslMoney with `box.OneArrayOfOne`
  case object `dsl.MONEY[]`              extends DslMoney with `box.OneBracketsOfOne`
...
object DslMoneyGrammarAliases2 {
  case object `dsl.money`                extends DslMoney with `box.One`
  case object `dsl.money?`               extends DslMoney with `box.Nullable`
  case object `dsl.array<money>`         extends DslMoney with `box.OneArrayOfOne`
  case object `dsl.money[]`              extends DslMoney with `box.OneBracketsOfOne`
