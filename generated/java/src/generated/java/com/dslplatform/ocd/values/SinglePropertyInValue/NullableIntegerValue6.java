...
public final class NullableIntegerValue6 implements java.io.Serializable {
    public NullableIntegerValue6(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1325358450;
        result = prime
                * result
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof NullableIntegerValue6)) return false;
        final NullableIntegerValue6 other = (NullableIntegerValue6) obj;
    ...
    public String toString() {
        return "NullableIntegerValue6(" + nullableInteger + ')';
    }
    ...
    public NullableIntegerValue6 setNullableInteger(final Integer value) {
