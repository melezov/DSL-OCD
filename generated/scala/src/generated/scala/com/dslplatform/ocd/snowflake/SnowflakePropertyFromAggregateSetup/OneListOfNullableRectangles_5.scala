...
class OneListOfNullableRectangles_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: OneListOfNullableRectangles_5 => c.URI == URI
    case _ => false
  }

  override def toString = "OneListOfNullableRectangles_5("+ URI +")"

   def copy(oneListOfNullableRectangles: IndexedSeq[Option[java.awt.geom.Rectangle2D]] = this._oneListOfNullableRectangles): OneListOfNullableRectangles_5 = {
  ...
  com.dslplatform.api.Guards.checkCollectionOptionRefNulls(oneListOfNullableRectangles)
    new OneListOfNullableRectangles_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _oneListOfNullableRectangles = oneListOfNullableRectangles)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneListOfNullableRectangles_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneListOfNullableRectangles_5](URI), duration)
  }
...
object OneListOfNullableRectangles_5 extends AggregateRootCompanion[OneListOfNullableRectangles_5]{
  ...
  def apply(
    ...
    com.dslplatform.api.Guards.checkCollectionOptionRefNulls(oneListOfNullableRectangles)
    require(oneListOfNullableRectangles ne null, "Null value was provided for property \"oneListOfNullableRectangles\"")
    new OneListOfNullableRectangles_5(
      __locator = None
