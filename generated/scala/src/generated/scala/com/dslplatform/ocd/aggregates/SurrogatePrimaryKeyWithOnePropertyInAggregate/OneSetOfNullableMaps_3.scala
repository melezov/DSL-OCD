...
class OneSetOfNullableMaps_3 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: OneSetOfNullableMaps_3 => c.URI == URI
    case _ => false
  }

  override def toString = "OneSetOfNullableMaps_3("+ URI +")"

   def copy(oneSetOfNullableMaps: Set[Option[Map[String, String]]] = this._oneSetOfNullableMaps): OneSetOfNullableMaps_3 = {
  ...
  com.dslplatform.api.Guards.checkCollectionOptionRefNulls(oneSetOfNullableMaps)
    new OneSetOfNullableMaps_3(_URI = this.URI, __locator = this.__locator, _ID = _ID, _oneSetOfNullableMaps = oneSetOfNullableMaps)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.aggregates.SurrogatePrimaryKeyWithOnePropertyInAggregate.OneSetOfNullableMaps_3): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.aggregates.SurrogatePrimaryKeyWithOnePropertyInAggregate.OneSetOfNullableMaps_3](URI), duration)
  }
...
object OneSetOfNullableMaps_3 extends AggregateRootCompanion[OneSetOfNullableMaps_3]{
