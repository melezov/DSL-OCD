...
public final class NullableArrayOfNullableDecimalsWithScaleOf9Value6 implements
        java.io.Serializable {
    public NullableArrayOfNullableDecimalsWithScaleOf9Value6(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1782710795;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof NullableArrayOfNullableDecimalsWithScaleOf9Value6))
            return false;
        final NullableArrayOfNullableDecimalsWithScaleOf9Value6 other = (NullableArrayOfNullableDecimalsWithScaleOf9Value6) obj;
    ...
    public String toString() {
        return "NullableArrayOfNullableDecimalsWithScaleOf9Value6("
    ...
    public NullableArrayOfNullableDecimalsWithScaleOf9Value6 setNullableArrayOfNullableDecimalsWithScaleOf9(
