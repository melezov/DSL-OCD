...
public final class OneArrayOfOneStringsWithMaxLengthOf9Value2 implements
        java.io.Serializable {
    public OneArrayOfOneStringsWithMaxLengthOf9Value2(
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfOneStringsWithMaxLengthOf9Value2))
            return false;
        final OneArrayOfOneStringsWithMaxLengthOf9Value2 other = (OneArrayOfOneStringsWithMaxLengthOf9Value2) obj;
    ...
    public String toString() {
        return "OneArrayOfOneStringsWithMaxLengthOf9Value2("
    ...
    public OneArrayOfOneStringsWithMaxLengthOf9Value2 setOneArrayOfOneStringsWithMaxLengthOf9(
            final String[] value) {
        if (value == null)
