...
class OneSetOfNullableRectangles_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: OneSetOfNullableRectangles_5 => c.URI == URI
    case _ => false
  }

  override def toString = "OneSetOfNullableRectangles_5("+ URI +")"

   def copy(oneSetOfNullableRectangles: Set[Option[java.awt.geom.Rectangle2D]] = this._oneSetOfNullableRectangles): OneSetOfNullableRectangles_5 = {
  ...
  com.dslplatform.api.Guards.checkCollectionOptionRefNulls(oneSetOfNullableRectangles)
    new OneSetOfNullableRectangles_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _oneSetOfNullableRectangles = oneSetOfNullableRectangles)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneSetOfNullableRectangles_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneSetOfNullableRectangles_5](URI), duration)
  }
...
object OneSetOfNullableRectangles_5 extends AggregateRootCompanion[OneSetOfNullableRectangles_5]{
  ...
  def apply(
    ...
    com.dslplatform.api.Guards.checkCollectionOptionRefNulls(oneSetOfNullableRectangles)
    require(oneSetOfNullableRectangles ne null, "Null value was provided for property \"oneSetOfNullableRectangles\"")
    new OneSetOfNullableRectangles_5(
      __locator = None
