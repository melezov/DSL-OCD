...
public final class OneArrayOfOneIntegersValue8 implements java.io.Serializable {
    public OneArrayOfOneIntegersValue8(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1196467554;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfOneIntegersValue8)) return false;
        final OneArrayOfOneIntegersValue8 other = (OneArrayOfOneIntegersValue8) obj;
    ...
    public String toString() {
        return "OneArrayOfOneIntegersValue8(" + oneArrayOfOneIntegers + ')';
    }
    ...
    public OneArrayOfOneIntegersValue8 setOneArrayOfOneIntegers(
            final int[] value) {
        if (value == null)
