...
public final class NullableArrayOfOneImagesValue3 implements
        java.io.Serializable {
    public NullableArrayOfOneImagesValue3(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1434523303;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof NullableArrayOfOneImagesValue3)) return false;
        final NullableArrayOfOneImagesValue3 other = (NullableArrayOfOneImagesValue3) obj;
    ...
    public String toString() {
        return "NullableArrayOfOneImagesValue3(" + nullableArrayOfOneImages
                + ')';
    }
    ...
    public NullableArrayOfOneImagesValue3 setNullableArrayOfOneImages(
