...
class NullableListOfOneMonies_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableListOfOneMonies_5 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableListOfOneMonies_5("+ URI +")"

   def copy(nullableListOfOneMonies: Option[IndexedSeq[BigDecimal]] = this._nullableListOfOneMonies): NullableListOfOneMonies_5 = {
  ...
  com.dslplatform.api.Guards.checkCollectionNulls(nullableListOfOneMonies)
    new NullableListOfOneMonies_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableListOfOneMonies = nullableListOfOneMonies)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableListOfOneMonies_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableListOfOneMonies_5](URI), duration)
  }
...
object NullableListOfOneMonies_5 extends AggregateRootCompanion[NullableListOfOneMonies_5]{
