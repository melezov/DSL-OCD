...
class OneSetOfOneMonies_6 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: OneSetOfOneMonies_6 => c.URI == URI
    case _ => false
  }

  override def toString = "OneSetOfOneMonies_6("+ URI +")"

   def copy(oneSetOfOneMonies: Set[BigDecimal] = this._oneSetOfOneMonies): OneSetOfOneMonies_6 = {
  ...
  com.dslplatform.api.Guards.checkCollectionNulls(oneSetOfOneMonies)
    new OneSetOfOneMonies_6(_URI = this.URI, __locator = this.__locator, _ID = _ID, _oneSetOfOneMonies = oneSetOfOneMonies)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneSetOfOneMonies_6): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneSetOfOneMonies_6](URI), duration)
  }
...
object OneSetOfOneMonies_6 extends AggregateRootCompanion[OneSetOfOneMonies_6]{
