...
public final class OneDecimalValue3 implements java.io.Serializable {
    public OneDecimalValue3(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1744957199;
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneDecimalValue3)) return false;
        final OneDecimalValue3 other = (OneDecimalValue3) obj;
    ...
    public String toString() {
        return "OneDecimalValue3(" + oneDecimal + ')';
    }
    ...
    public OneDecimalValue3 setOneDecimal(final java.math.BigDecimal value) {
        if (value == null)
