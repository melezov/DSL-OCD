...
public final class NullableSetOfNullableGuidsValue2 implements
        java.io.Serializable {
    public NullableSetOfNullableGuidsValue2(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1162604660;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof NullableSetOfNullableGuidsValue2)) return false;
        final NullableSetOfNullableGuidsValue2 other = (NullableSetOfNullableGuidsValue2) obj;
    ...
    public String toString() {
        return "NullableSetOfNullableGuidsValue2(" + nullableSetOfNullableGuids
                + ')';
    }
    ...
    public NullableSetOfNullableGuidsValue2 setNullableSetOfNullableGuids(
