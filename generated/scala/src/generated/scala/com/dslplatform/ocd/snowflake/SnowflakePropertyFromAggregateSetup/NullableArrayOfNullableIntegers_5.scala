...
class NullableArrayOfNullableIntegers_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableArrayOfNullableIntegers_5 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableArrayOfNullableIntegers_5("+ URI +")"

   def copy(nullableArrayOfNullableIntegers: Option[Array[Option[Int]]] = this._nullableArrayOfNullableIntegers): NullableArrayOfNullableIntegers_5 = {
  ...
  com.dslplatform.api.Guards.checkArrayOptionValNulls(nullableArrayOfNullableIntegers)
    new NullableArrayOfNullableIntegers_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableArrayOfNullableIntegers = nullableArrayOfNullableIntegers)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableArrayOfNullableIntegers_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableArrayOfNullableIntegers_5](URI), duration)
  }
...
object NullableArrayOfNullableIntegers_5 extends AggregateRootCompanion[NullableArrayOfNullableIntegers_5]{
  ...
  def apply(
    ...
    require(nullableArrayOfNullableIntegers ne null, "Null value was provided for property \"nullableArrayOfNullableIntegers\"")
    if (nullableArrayOfNullableIntegers.isDefined) require(nullableArrayOfNullableIntegers.get ne null, "Null value was provided for property \"nullableArrayOfNullableIntegers\"")
    new NullableArrayOfNullableIntegers_5(
      __locator = None
