...
case class NullableArrayOfNullableGuids_4 @com.fasterxml.jackson.annotation.JsonIgnore() (
     nullableArrayOfNullableGuids: Option[Array[Option[java.util.UUID]]] = None,
     calculatedNullableArrayOfNullableGuids: Option[Array[Option[java.util.UUID]]] = None,
     persistedNullableArrayOfNullableGuids: Option[Array[Option[java.util.UUID]]] = None
  ) {
  ...
  , @com.fasterxml.jackson.annotation.JsonProperty("persistedNullableArrayOfNullableGuids") persistedNullableArrayOfNullableGuids: Option[Array[Option[java.util.UUID]]]
    ...
    this( nullableArrayOfNullableGuids = nullableArrayOfNullableGuids, calculatedNullableArrayOfNullableGuids = calculatedNullableArrayOfNullableGuids, persistedNullableArrayOfNullableGuids = persistedNullableArrayOfNullableGuids)
