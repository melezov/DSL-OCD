...
public final class OneTimestampValue6 implements java.io.Serializable {
    public OneTimestampValue6(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 2114970655;
        result = prime
                * result
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneTimestampValue6)) return false;
        final OneTimestampValue6 other = (OneTimestampValue6) obj;
    ...
    public String toString() {
        return "OneTimestampValue6(" + oneTimestamp + ')';
    }
    ...
    public OneTimestampValue6 setOneTimestamp(final org.joda.time.DateTime value) {
        if (value == null)
