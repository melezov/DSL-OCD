...
class NullableArrayOfNullableImages_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableArrayOfNullableImages_5 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableArrayOfNullableImages_5("+ URI +")"

   def copy(nullableArrayOfNullableImages: Option[Array[Option[java.awt.image.BufferedImage]]] = this._nullableArrayOfNullableImages): NullableArrayOfNullableImages_5 = {
  ...
  com.dslplatform.api.Guards.checkArrayOptionRefNulls(nullableArrayOfNullableImages)
    new NullableArrayOfNullableImages_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableArrayOfNullableImages = nullableArrayOfNullableImages)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableArrayOfNullableImages_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableArrayOfNullableImages_5](URI), duration)
  }
...
object NullableArrayOfNullableImages_5 extends AggregateRootCompanion[NullableArrayOfNullableImages_5]{
  ...
  def apply(
    ...
    require(nullableArrayOfNullableImages ne null, "Null value was provided for property \"nullableArrayOfNullableImages\"")
    if (nullableArrayOfNullableImages.isDefined) require(nullableArrayOfNullableImages.get ne null, "Null value was provided for property \"nullableArrayOfNullableImages\"")
    new NullableArrayOfNullableImages_5(
      __locator = None
