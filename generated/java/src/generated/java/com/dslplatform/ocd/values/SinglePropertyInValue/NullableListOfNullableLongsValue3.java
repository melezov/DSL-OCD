...
public final class NullableListOfNullableLongsValue3 implements
        java.io.Serializable {
    public NullableListOfNullableLongsValue3(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 2032501744;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof NullableListOfNullableLongsValue3)) return false;
        final NullableListOfNullableLongsValue3 other = (NullableListOfNullableLongsValue3) obj;
    ...
    public String toString() {
        return "NullableListOfNullableLongsValue3("
    ...
    public NullableListOfNullableLongsValue3 setNullableListOfNullableLongs(
