...
public final class OneArrayOfOneS3sValue3 implements java.io.Serializable {
    public OneArrayOfOneS3sValue3(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1637568357;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfOneS3sValue3)) return false;
        final OneArrayOfOneS3sValue3 other = (OneArrayOfOneS3sValue3) obj;
    ...
    public String toString() {
        return "OneArrayOfOneS3sValue3(" + oneArrayOfOneS3s + ')';
    }
    ...
    public OneArrayOfOneS3sValue3 setOneArrayOfOneS3s(
