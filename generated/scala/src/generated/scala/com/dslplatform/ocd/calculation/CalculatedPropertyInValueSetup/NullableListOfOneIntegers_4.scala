...
case class NullableListOfOneIntegers_4 @com.fasterxml.jackson.annotation.JsonIgnore() (
     nullableListOfOneIntegers: Option[IndexedSeq[Int]] = None,
     calculatedNullableListOfOneIntegers: Option[IndexedSeq[Int]] = None,
     persistedNullableListOfOneIntegers: Option[IndexedSeq[Int]] = None
  ) {
  ...
  , @com.fasterxml.jackson.annotation.JsonProperty("persistedNullableListOfOneIntegers") persistedNullableListOfOneIntegers: Option[IndexedSeq[Int]]
    ...
    this( nullableListOfOneIntegers = nullableListOfOneIntegers, calculatedNullableListOfOneIntegers = calculatedNullableListOfOneIntegers, persistedNullableListOfOneIntegers = persistedNullableListOfOneIntegers)
