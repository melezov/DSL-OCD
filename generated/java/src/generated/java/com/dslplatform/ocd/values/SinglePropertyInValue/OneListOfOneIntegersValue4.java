...
public final class OneListOfOneIntegersValue4 implements java.io.Serializable {
    public OneListOfOneIntegersValue4(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1225450441;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneListOfOneIntegersValue4)) return false;
        final OneListOfOneIntegersValue4 other = (OneListOfOneIntegersValue4) obj;
    ...
    public String toString() {
        return "OneListOfOneIntegersValue4(" + oneListOfOneIntegers + ')';
    }
    ...
    public OneListOfOneIntegersValue4 setOneListOfOneIntegers(
