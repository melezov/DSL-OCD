...
public final class NullableListOfNullableStringsValue1 implements
        java.io.Serializable {
    public NullableListOfNullableStringsValue1(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1100293907;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof NullableListOfNullableStringsValue1))
            return false;
        final NullableListOfNullableStringsValue1 other = (NullableListOfNullableStringsValue1) obj;
    ...
    public String toString() {
        return "NullableListOfNullableStringsValue1("
    ...
    public NullableListOfNullableStringsValue1 setNullableListOfNullableStrings(
