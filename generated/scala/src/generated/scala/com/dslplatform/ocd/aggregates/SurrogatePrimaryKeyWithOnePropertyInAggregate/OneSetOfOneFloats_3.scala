...
class OneSetOfOneFloats_3 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: OneSetOfOneFloats_3 => c.URI == URI
    case _ => false
  }

  override def toString = "OneSetOfOneFloats_3("+ URI +")"

   def copy(oneSetOfOneFloats: Set[Float] = this._oneSetOfOneFloats): OneSetOfOneFloats_3 = {
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.aggregates.SurrogatePrimaryKeyWithOnePropertyInAggregate.OneSetOfOneFloats_3): this.type = {
...
object OneSetOfOneFloats_3 extends AggregateRootCompanion[OneSetOfOneFloats_3]{

  def apply(
    oneSetOfOneFloats: Set[Float] = Set.empty
  ) = {
    require(oneSetOfOneFloats ne null, "Null value was provided for property \"oneSetOfOneFloats\"")
    new OneSetOfOneFloats_3(
      __locator = None
