...
class NullableArrayOfOneDecimalsWithScaleOf9_2 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableArrayOfOneDecimalsWithScaleOf9_2 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableArrayOfOneDecimalsWithScaleOf9_2("+ URI +")"

   def copy(nullableArrayOfOneDecimalsWithScaleOf9: Option[Array[BigDecimal]] = this._nullableArrayOfOneDecimalsWithScaleOf9): NullableArrayOfOneDecimalsWithScaleOf9_2 = {
  ...
  com.dslplatform.api.Guards.checkArrayNulls(nullableArrayOfOneDecimalsWithScaleOf9)
    new NullableArrayOfOneDecimalsWithScaleOf9_2(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableArrayOfOneDecimalsWithScaleOf9 = nullableArrayOfOneDecimalsWithScaleOf9)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.aggregates.SurrogatePrimaryKeyWithOnePropertyInAggregate.NullableArrayOfOneDecimalsWithScaleOf9_2): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.aggregates.SurrogatePrimaryKeyWithOnePropertyInAggregate.NullableArrayOfOneDecimalsWithScaleOf9_2](URI), duration)
  }

  @com.fasterxml.jackson.annotation.JsonGetter("nullableArrayOfOneDecimalsWithScaleOf9")
...
object NullableArrayOfOneDecimalsWithScaleOf9_2 extends AggregateRootCompanion[NullableArrayOfOneDecimalsWithScaleOf9_2]{
