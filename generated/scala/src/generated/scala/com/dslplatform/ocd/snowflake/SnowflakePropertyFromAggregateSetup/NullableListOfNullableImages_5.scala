...
class NullableListOfNullableImages_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableListOfNullableImages_5 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableListOfNullableImages_5("+ URI +")"

   def copy(nullableListOfNullableImages: Option[IndexedSeq[Option[java.awt.image.BufferedImage]]] = this._nullableListOfNullableImages): NullableListOfNullableImages_5 = {
  ...
  com.dslplatform.api.Guards.checkCollectionOptionRefNulls(nullableListOfNullableImages)
    new NullableListOfNullableImages_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableListOfNullableImages = nullableListOfNullableImages)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableListOfNullableImages_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableListOfNullableImages_5](URI), duration)
  }
...
object NullableListOfNullableImages_5 extends AggregateRootCompanion[NullableListOfNullableImages_5]{
  ...
  def apply(
    ...
    require(nullableListOfNullableImages ne null, "Null value was provided for property \"nullableListOfNullableImages\"")
    if (nullableListOfNullableImages.isDefined) require(nullableListOfNullableImages.get ne null, "Null value was provided for property \"nullableListOfNullableImages\"")
    new NullableListOfNullableImages_5(
      __locator = None
