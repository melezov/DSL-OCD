...
class OneArrayOfNullableRectangles_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: OneArrayOfNullableRectangles_5 => c.URI == URI
    case _ => false
  }

  override def toString = "OneArrayOfNullableRectangles_5("+ URI +")"

   def copy(oneArrayOfNullableRectangles: Array[Option[java.awt.geom.Rectangle2D]] = this._oneArrayOfNullableRectangles): OneArrayOfNullableRectangles_5 = {
  ...
  com.dslplatform.api.Guards.checkArrayOptionRefNulls(oneArrayOfNullableRectangles)
    new OneArrayOfNullableRectangles_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _oneArrayOfNullableRectangles = oneArrayOfNullableRectangles)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneArrayOfNullableRectangles_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneArrayOfNullableRectangles_5](URI), duration)
  }
...
object OneArrayOfNullableRectangles_5 extends AggregateRootCompanion[OneArrayOfNullableRectangles_5]{
  ...
  def apply(
    ...
    com.dslplatform.api.Guards.checkArrayOptionRefNulls(oneArrayOfNullableRectangles)
    require(oneArrayOfNullableRectangles ne null, "Null value was provided for property \"oneArrayOfNullableRectangles\"")
    new OneArrayOfNullableRectangles_5(
      __locator = None
