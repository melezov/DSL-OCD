...
public class TestOptListOptBoolValue {
    ...
    public void testLackOfSetterNullGuard() {
        final OptListOptBoolValue value = new OptListOptBoolValue();
    ...
    public void testValueEquality() {
      final OptListOptBoolValue v1 = new OptListOptBoolValue();
      final OptListOptBoolValue v2 = new OptListOptBoolValue();
