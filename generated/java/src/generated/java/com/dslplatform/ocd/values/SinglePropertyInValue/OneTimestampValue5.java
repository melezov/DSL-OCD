...
public final class OneTimestampValue5 implements java.io.Serializable {
    public OneTimestampValue5(
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneTimestampValue5)) return false;
        final OneTimestampValue5 other = (OneTimestampValue5) obj;
    ...
    public String toString() {
        return "OneTimestampValue5(" + oneTimestamp + ')';
    }
    ...
    public OneTimestampValue5 setOneTimestamp(final org.joda.time.DateTime value) {
        if (value == null)
