...
class OneDecimalWithScaleOf9_6 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: OneDecimalWithScaleOf9_6 => c.URI == URI
    case _ => false
  }

  override def toString = "OneDecimalWithScaleOf9_6("+ URI +")"

   def copy(oneDecimalWithScaleOf9: BigDecimal = this._oneDecimalWithScaleOf9): OneDecimalWithScaleOf9_6 = {
  ...
  com.dslplatform.api.Guards.checkScale(oneDecimalWithScaleOf9, 9)
    new OneDecimalWithScaleOf9_6(_URI = this.URI, __locator = this.__locator, _ID = _ID, _oneDecimalWithScaleOf9 = oneDecimalWithScaleOf9)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneDecimalWithScaleOf9_6): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneDecimalWithScaleOf9_6](URI), duration)
  }
...
object OneDecimalWithScaleOf9_6 extends AggregateRootCompanion[OneDecimalWithScaleOf9_6]{
