...
public final class NullableArrayOfNullableDecimalsWithScaleOf9Value4 implements
        java.io.Serializable {
    public NullableArrayOfNullableDecimalsWithScaleOf9Value4(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1782710797;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof NullableArrayOfNullableDecimalsWithScaleOf9Value4))
            return false;
        final NullableArrayOfNullableDecimalsWithScaleOf9Value4 other = (NullableArrayOfNullableDecimalsWithScaleOf9Value4) obj;
    ...
    public String toString() {
        return "NullableArrayOfNullableDecimalsWithScaleOf9Value4("
    ...
    public NullableArrayOfNullableDecimalsWithScaleOf9Value4 setNullableArrayOfNullableDecimalsWithScaleOf9(
