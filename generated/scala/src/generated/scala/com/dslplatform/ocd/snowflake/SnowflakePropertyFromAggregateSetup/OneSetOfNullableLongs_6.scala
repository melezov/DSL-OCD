...
class OneSetOfNullableLongs_6 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: OneSetOfNullableLongs_6 => c.URI == URI
    case _ => false
  }

  override def toString = "OneSetOfNullableLongs_6("+ URI +")"

   def copy(oneSetOfNullableLongs: Set[Option[Long]] = this._oneSetOfNullableLongs): OneSetOfNullableLongs_6 = {
  ...
  com.dslplatform.api.Guards.checkCollectionOptionValNulls(oneSetOfNullableLongs)
    new OneSetOfNullableLongs_6(_URI = this.URI, __locator = this.__locator, _ID = _ID, _oneSetOfNullableLongs = oneSetOfNullableLongs)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneSetOfNullableLongs_6): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneSetOfNullableLongs_6](URI), duration)
  }
...
object OneSetOfNullableLongs_6 extends AggregateRootCompanion[OneSetOfNullableLongs_6]{
