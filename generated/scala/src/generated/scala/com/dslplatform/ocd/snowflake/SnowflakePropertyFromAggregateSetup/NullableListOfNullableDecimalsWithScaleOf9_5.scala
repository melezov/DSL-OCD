...
class NullableListOfNullableDecimalsWithScaleOf9_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableListOfNullableDecimalsWithScaleOf9_5 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableListOfNullableDecimalsWithScaleOf9_5("+ URI +")"

   def copy(nullableListOfNullableDecimalsWithScaleOf9: Option[IndexedSeq[Option[BigDecimal]]] = this._nullableListOfNullableDecimalsWithScaleOf9): NullableListOfNullableDecimalsWithScaleOf9_5 = {
  ...
  com.dslplatform.api.Guards.checkCollectionOptionRefNulls(nullableListOfNullableDecimalsWithScaleOf9)
    new NullableListOfNullableDecimalsWithScaleOf9_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableListOfNullableDecimalsWithScaleOf9 = nullableListOfNullableDecimalsWithScaleOf9)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableListOfNullableDecimalsWithScaleOf9_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableListOfNullableDecimalsWithScaleOf9_5](URI), duration)
  }
...
object NullableListOfNullableDecimalsWithScaleOf9_5 extends AggregateRootCompanion[NullableListOfNullableDecimalsWithScaleOf9_5]{
