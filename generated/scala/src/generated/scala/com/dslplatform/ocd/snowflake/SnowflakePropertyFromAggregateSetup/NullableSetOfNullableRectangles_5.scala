...
class NullableSetOfNullableRectangles_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableSetOfNullableRectangles_5 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableSetOfNullableRectangles_5("+ URI +")"

   def copy(nullableSetOfNullableRectangles: Option[Set[Option[java.awt.geom.Rectangle2D]]] = this._nullableSetOfNullableRectangles): NullableSetOfNullableRectangles_5 = {
  ...
  com.dslplatform.api.Guards.checkCollectionOptionRefNulls(nullableSetOfNullableRectangles)
    new NullableSetOfNullableRectangles_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableSetOfNullableRectangles = nullableSetOfNullableRectangles)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableSetOfNullableRectangles_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableSetOfNullableRectangles_5](URI), duration)
  }
...
object NullableSetOfNullableRectangles_5 extends AggregateRootCompanion[NullableSetOfNullableRectangles_5]{
  ...
  def apply(
    ...
    require(nullableSetOfNullableRectangles ne null, "Null value was provided for property \"nullableSetOfNullableRectangles\"")
    if (nullableSetOfNullableRectangles.isDefined) require(nullableSetOfNullableRectangles.get ne null, "Null value was provided for property \"nullableSetOfNullableRectangles\"")
    new NullableSetOfNullableRectangles_5(
      __locator = None
