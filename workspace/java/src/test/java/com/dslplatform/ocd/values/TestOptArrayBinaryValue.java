...
public class TestOptArrayBinaryValue {
    ...
    public void testLackOfSetterNullGuard() {
        final OptArrayBinaryValue value = new OptArrayBinaryValue();
    ...
    public void testValueEquality() {
      final OptArrayBinaryValue v1 = new OptArrayBinaryValue();
      final OptArrayBinaryValue v2 = new OptArrayBinaryValue();
