...
public final class OneArrayOfOneImagesValue9 implements java.io.Serializable {
    public OneArrayOfOneImagesValue9(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1231038604;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfOneImagesValue9)) return false;
        final OneArrayOfOneImagesValue9 other = (OneArrayOfOneImagesValue9) obj;
    ...
    public String toString() {
        return "OneArrayOfOneImagesValue9(" + oneArrayOfOneImages + ')';
    }
    ...
    public OneArrayOfOneImagesValue9 setOneArrayOfOneImages(
