...
public final class OneSetOfNullableDecimalsWithScaleOf9Value1 implements
        java.io.Serializable {
    public OneSetOfNullableDecimalsWithScaleOf9Value1(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1857012852;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneSetOfNullableDecimalsWithScaleOf9Value1))
            return false;
        final OneSetOfNullableDecimalsWithScaleOf9Value1 other = (OneSetOfNullableDecimalsWithScaleOf9Value1) obj;
    ...
    public String toString() {
        return "OneSetOfNullableDecimalsWithScaleOf9Value1("
    ...
    public OneSetOfNullableDecimalsWithScaleOf9Value1 setOneSetOfNullableDecimalsWithScaleOf9(
