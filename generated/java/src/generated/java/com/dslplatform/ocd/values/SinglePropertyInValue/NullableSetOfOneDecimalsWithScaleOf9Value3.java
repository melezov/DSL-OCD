...
public final class NullableSetOfOneDecimalsWithScaleOf9Value3 implements
        java.io.Serializable {
    public NullableSetOfOneDecimalsWithScaleOf9Value3(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1101471504;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof NullableSetOfOneDecimalsWithScaleOf9Value3))
            return false;
        final NullableSetOfOneDecimalsWithScaleOf9Value3 other = (NullableSetOfOneDecimalsWithScaleOf9Value3) obj;
    ...
    public String toString() {
        return "NullableSetOfOneDecimalsWithScaleOf9Value3("
    ...
    public NullableSetOfOneDecimalsWithScaleOf9Value3 setNullableSetOfOneDecimalsWithScaleOf9(
