...
public final class OneArrayOfNullableGuidsValue2 implements
        java.io.Serializable {
    public OneArrayOfNullableGuidsValue2(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1455438854;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfNullableGuidsValue2)) return false;
        final OneArrayOfNullableGuidsValue2 other = (OneArrayOfNullableGuidsValue2) obj;
    ...
    public String toString() {
        return "OneArrayOfNullableGuidsValue2(" + oneArrayOfNullableGuids + ')';
    }
    ...
    public OneArrayOfNullableGuidsValue2 setOneArrayOfNullableGuids(
