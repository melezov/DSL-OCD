...
public final class OneArrayOfOneMoniesValue5 implements java.io.Serializable {
    public OneArrayOfOneMoniesValue5(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1676550755;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfOneMoniesValue5)) return false;
        final OneArrayOfOneMoniesValue5 other = (OneArrayOfOneMoniesValue5) obj;
    ...
    public String toString() {
        return "OneArrayOfOneMoniesValue5(" + oneArrayOfOneMonies + ')';
    }
    ...
    public OneArrayOfOneMoniesValue5 setOneArrayOfOneMonies(
