...
class NullableSetOfNullableDoubles_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableSetOfNullableDoubles_5 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableSetOfNullableDoubles_5("+ URI +")"

   def copy(nullableSetOfNullableDoubles: Option[Set[Option[Double]]] = this._nullableSetOfNullableDoubles): NullableSetOfNullableDoubles_5 = {
  ...
  com.dslplatform.api.Guards.checkCollectionOptionValNulls(nullableSetOfNullableDoubles)
    new NullableSetOfNullableDoubles_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableSetOfNullableDoubles = nullableSetOfNullableDoubles)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableSetOfNullableDoubles_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableSetOfNullableDoubles_5](URI), duration)
  }
...
object NullableSetOfNullableDoubles_5 extends AggregateRootCompanion[NullableSetOfNullableDoubles_5]{
  ...
  def apply(
    ...
    require(nullableSetOfNullableDoubles ne null, "Null value was provided for property \"nullableSetOfNullableDoubles\"")
    if (nullableSetOfNullableDoubles.isDefined) require(nullableSetOfNullableDoubles.get ne null, "Null value was provided for property \"nullableSetOfNullableDoubles\"")
    new NullableSetOfNullableDoubles_5(
      __locator = None
