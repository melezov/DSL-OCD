...
class OneArrayOfOneIps_3 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: OneArrayOfOneIps_3 => c.URI == URI
    case _ => false
  }

  override def toString = "OneArrayOfOneIps_3("+ URI +")"

   def copy(oneArrayOfOneIps: Array[java.net.InetAddress] = this._oneArrayOfOneIps): OneArrayOfOneIps_3 = {
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.aggregates.SurrogatePrimaryKeyWithOnePropertyInAggregate.OneArrayOfOneIps_3): this.type = {
...
object OneArrayOfOneIps_3 extends AggregateRootCompanion[OneArrayOfOneIps_3]{
