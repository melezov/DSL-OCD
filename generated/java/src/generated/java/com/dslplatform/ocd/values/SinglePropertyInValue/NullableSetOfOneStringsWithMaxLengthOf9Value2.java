...
public final class NullableSetOfOneStringsWithMaxLengthOf9Value2 implements
        java.io.Serializable {
    public NullableSetOfOneStringsWithMaxLengthOf9Value2(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1082980045;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof NullableSetOfOneStringsWithMaxLengthOf9Value2))
            return false;
        final NullableSetOfOneStringsWithMaxLengthOf9Value2 other = (NullableSetOfOneStringsWithMaxLengthOf9Value2) obj;
    ...
    public String toString() {
        return "NullableSetOfOneStringsWithMaxLengthOf9Value2("
    ...
    public NullableSetOfOneStringsWithMaxLengthOf9Value2 setNullableSetOfOneStringsWithMaxLengthOf9(
