...
public final class NullableSetOfOneStringsWithMaxLengthOf9Value3 implements
        java.io.Serializable {
    public NullableSetOfOneStringsWithMaxLengthOf9Value3(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1082980046;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof NullableSetOfOneStringsWithMaxLengthOf9Value3))
            return false;
        final NullableSetOfOneStringsWithMaxLengthOf9Value3 other = (NullableSetOfOneStringsWithMaxLengthOf9Value3) obj;
    ...
    public String toString() {
        return "NullableSetOfOneStringsWithMaxLengthOf9Value3("
    ...
    public NullableSetOfOneStringsWithMaxLengthOf9Value3 setNullableSetOfOneStringsWithMaxLengthOf9(
