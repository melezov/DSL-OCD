...
public final class OneSetOfOneStringsWithMaxLengthOf9Value2 implements
        java.io.Serializable {
    public OneSetOfOneStringsWithMaxLengthOf9Value2(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1474963814;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneSetOfOneStringsWithMaxLengthOf9Value2))
            return false;
        final OneSetOfOneStringsWithMaxLengthOf9Value2 other = (OneSetOfOneStringsWithMaxLengthOf9Value2) obj;
    ...
    public String toString() {
        return "OneSetOfOneStringsWithMaxLengthOf9Value2("
    ...
    public OneSetOfOneStringsWithMaxLengthOf9Value2 setOneSetOfOneStringsWithMaxLengthOf9(
