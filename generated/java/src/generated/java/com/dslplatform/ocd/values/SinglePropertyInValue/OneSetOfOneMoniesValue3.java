...
public final class OneSetOfOneMoniesValue3 implements java.io.Serializable {
    public OneSetOfOneMoniesValue3(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1830538094;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneSetOfOneMoniesValue3)) return false;
        final OneSetOfOneMoniesValue3 other = (OneSetOfOneMoniesValue3) obj;
    ...
    public String toString() {
        return "OneSetOfOneMoniesValue3(" + oneSetOfOneMonies + ')';
    }
    ...
    public OneSetOfOneMoniesValue3 setOneSetOfOneMonies(
