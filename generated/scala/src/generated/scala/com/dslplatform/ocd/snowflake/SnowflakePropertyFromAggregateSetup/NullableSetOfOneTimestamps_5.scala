...
class NullableSetOfOneTimestamps_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableSetOfOneTimestamps_5 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableSetOfOneTimestamps_5("+ URI +")"

   def copy(nullableSetOfOneTimestamps: Option[Set[org.joda.time.DateTime]] = this._nullableSetOfOneTimestamps): NullableSetOfOneTimestamps_5 = {
  ...
  com.dslplatform.api.Guards.checkCollectionNulls(nullableSetOfOneTimestamps)
    new NullableSetOfOneTimestamps_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableSetOfOneTimestamps = nullableSetOfOneTimestamps)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableSetOfOneTimestamps_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableSetOfOneTimestamps_5](URI), duration)
  }
...
object NullableSetOfOneTimestamps_5 extends AggregateRootCompanion[NullableSetOfOneTimestamps_5]{
  ...
  def apply(
    ...
    require(nullableSetOfOneTimestamps ne null, "Null value was provided for property \"nullableSetOfOneTimestamps\"")
    if (nullableSetOfOneTimestamps.isDefined) require(nullableSetOfOneTimestamps.get ne null, "Null value was provided for property \"nullableSetOfOneTimestamps\"")
    new NullableSetOfOneTimestamps_5(
      __locator = None
