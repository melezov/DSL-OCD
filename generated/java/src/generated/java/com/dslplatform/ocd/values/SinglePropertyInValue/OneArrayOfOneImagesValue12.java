...
public final class OneArrayOfOneImagesValue12 implements java.io.Serializable {
    public OneArrayOfOneImagesValue12(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 2039855150;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfOneImagesValue12)) return false;
        final OneArrayOfOneImagesValue12 other = (OneArrayOfOneImagesValue12) obj;
    ...
    public String toString() {
        return "OneArrayOfOneImagesValue12(" + oneArrayOfOneImages + ')';
    }
    ...
    public OneArrayOfOneImagesValue12 setOneArrayOfOneImages(
