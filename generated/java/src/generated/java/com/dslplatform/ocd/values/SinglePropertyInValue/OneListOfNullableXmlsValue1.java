...
public final class OneListOfNullableXmlsValue1 implements java.io.Serializable {
    public OneListOfNullableXmlsValue1(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1007811764;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneListOfNullableXmlsValue1)) return false;
        final OneListOfNullableXmlsValue1 other = (OneListOfNullableXmlsValue1) obj;
    ...
    public String toString() {
        return "OneListOfNullableXmlsValue1(" + oneListOfNullableXmls + ')';
    }
    ...
    public OneListOfNullableXmlsValue1 setOneListOfNullableXmls(
