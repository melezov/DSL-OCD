...
public final class OneSetOfOneMoniesValue2 implements java.io.Serializable {
    public OneSetOfOneMoniesValue2(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1830538093;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneSetOfOneMoniesValue2)) return false;
        final OneSetOfOneMoniesValue2 other = (OneSetOfOneMoniesValue2) obj;
    ...
    public String toString() {
        return "OneSetOfOneMoniesValue2(" + oneSetOfOneMonies + ')';
    }
    ...
    public OneSetOfOneMoniesValue2 setOneSetOfOneMonies(
