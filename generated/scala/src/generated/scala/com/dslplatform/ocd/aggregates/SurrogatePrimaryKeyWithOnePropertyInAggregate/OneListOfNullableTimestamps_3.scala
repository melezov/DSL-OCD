...
class OneListOfNullableTimestamps_3 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: OneListOfNullableTimestamps_3 => c.URI == URI
    case _ => false
  }

  override def toString = "OneListOfNullableTimestamps_3("+ URI +")"

   def copy(oneListOfNullableTimestamps: IndexedSeq[Option[org.joda.time.DateTime]] = this._oneListOfNullableTimestamps): OneListOfNullableTimestamps_3 = {
  ...
  com.dslplatform.api.Guards.checkCollectionOptionRefNulls(oneListOfNullableTimestamps)
    new OneListOfNullableTimestamps_3(_URI = this.URI, __locator = this.__locator, _ID = _ID, _oneListOfNullableTimestamps = oneListOfNullableTimestamps)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.aggregates.SurrogatePrimaryKeyWithOnePropertyInAggregate.OneListOfNullableTimestamps_3): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.aggregates.SurrogatePrimaryKeyWithOnePropertyInAggregate.OneListOfNullableTimestamps_3](URI), duration)
  }
...
object OneListOfNullableTimestamps_3 extends AggregateRootCompanion[OneListOfNullableTimestamps_3]{
  ...
  def apply(
    ...
    com.dslplatform.api.Guards.checkCollectionOptionRefNulls(oneListOfNullableTimestamps)
    require(oneListOfNullableTimestamps ne null, "Null value was provided for property \"oneListOfNullableTimestamps\"")
    new OneListOfNullableTimestamps_3(
      __locator = None
