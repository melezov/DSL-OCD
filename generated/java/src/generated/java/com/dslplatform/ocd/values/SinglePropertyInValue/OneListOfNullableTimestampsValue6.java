...
public final class OneListOfNullableTimestampsValue6 implements
        java.io.Serializable {
    public OneListOfNullableTimestampsValue6(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1614442462;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneListOfNullableTimestampsValue6)) return false;
        final OneListOfNullableTimestampsValue6 other = (OneListOfNullableTimestampsValue6) obj;
    ...
    public String toString() {
        return "OneListOfNullableTimestampsValue6("
    ...
    public OneListOfNullableTimestampsValue6 setOneListOfNullableTimestamps(
