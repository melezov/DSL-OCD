...
class NullableListOfNullableBooleans_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableListOfNullableBooleans_5 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableListOfNullableBooleans_5("+ URI +")"

   def copy(nullableListOfNullableBooleans: Option[IndexedSeq[Option[Boolean]]] = this._nullableListOfNullableBooleans): NullableListOfNullableBooleans_5 = {
  ...
  com.dslplatform.api.Guards.checkCollectionOptionValNulls(nullableListOfNullableBooleans)
    new NullableListOfNullableBooleans_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableListOfNullableBooleans = nullableListOfNullableBooleans)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableListOfNullableBooleans_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableListOfNullableBooleans_5](URI), duration)
  }
...
object NullableListOfNullableBooleans_5 extends AggregateRootCompanion[NullableListOfNullableBooleans_5]{
  ...
  def apply(
    ...
    require(nullableListOfNullableBooleans ne null, "Null value was provided for property \"nullableListOfNullableBooleans\"")
    if (nullableListOfNullableBooleans.isDefined) require(nullableListOfNullableBooleans.get ne null, "Null value was provided for property \"nullableListOfNullableBooleans\"")
    new NullableListOfNullableBooleans_5(
      __locator = None
