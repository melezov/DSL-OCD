...
public final class OneListOfOneBinariesValue1 implements java.io.Serializable {
    public OneListOfOneBinariesValue1(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1266026788;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneListOfOneBinariesValue1)) return false;
        final OneListOfOneBinariesValue1 other = (OneListOfOneBinariesValue1) obj;
    ...
    public String toString() {
        return "OneListOfOneBinariesValue1(" + oneListOfOneBinaries + ')';
    }
    ...
    public OneListOfOneBinariesValue1 setOneListOfOneBinaries(
