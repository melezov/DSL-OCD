...
trait OneLinkedListOfNullableAsserts { self: JavaAsserts =>
  def oneLinkedListOfNullableAsserts = s"""
    private static void assertLinkedListOfNullableEquals(final String message, final ${clazz} expecteds, final ${clazz} actuals${factors.signature}) {${assertLinkedListOfNullableEquals}
    }

    private static void assert${boxName}Equals(final String message, final ${clazz} expecteds, final ${clazz} actuals${factors.signature}) {${assertOneLinkedListOfNullableEquals}
...
""" + factors.method
  ...
  def assertLinkedListOfNullableEquals = s"""
  ...
  def assertOneLinkedListOfNullableEquals = s"""
