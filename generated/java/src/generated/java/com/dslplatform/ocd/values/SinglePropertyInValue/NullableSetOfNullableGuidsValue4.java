...
public final class NullableSetOfNullableGuidsValue4 implements
        java.io.Serializable {
    public NullableSetOfNullableGuidsValue4(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1969563222;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof NullableSetOfNullableGuidsValue4)) return false;
        final NullableSetOfNullableGuidsValue4 other = (NullableSetOfNullableGuidsValue4) obj;
    ...
    public String toString() {
        return "NullableSetOfNullableGuidsValue4(" + nullableSetOfNullableGuids
                + ')';
    }
    ...
    public NullableSetOfNullableGuidsValue4 setNullableSetOfNullableGuids(
