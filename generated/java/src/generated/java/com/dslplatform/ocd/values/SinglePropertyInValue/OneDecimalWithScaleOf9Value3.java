...
public final class OneDecimalWithScaleOf9Value3 implements java.io.Serializable {
    public OneDecimalWithScaleOf9Value3(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1119056841;
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneDecimalWithScaleOf9Value3)) return false;
        final OneDecimalWithScaleOf9Value3 other = (OneDecimalWithScaleOf9Value3) obj;
    ...
    public String toString() {
        return "OneDecimalWithScaleOf9Value3(" + oneDecimalWithScaleOf9 + ')';
    }
    ...
    public OneDecimalWithScaleOf9Value3 setOneDecimalWithScaleOf9(
