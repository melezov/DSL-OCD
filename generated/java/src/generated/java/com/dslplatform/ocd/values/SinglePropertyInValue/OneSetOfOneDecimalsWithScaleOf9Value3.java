...
public final class OneSetOfOneDecimalsWithScaleOf9Value3 implements
        java.io.Serializable {
    public OneSetOfOneDecimalsWithScaleOf9Value3(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1336709703;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneSetOfOneDecimalsWithScaleOf9Value3))
            return false;
        final OneSetOfOneDecimalsWithScaleOf9Value3 other = (OneSetOfOneDecimalsWithScaleOf9Value3) obj;
    ...
    public String toString() {
        return "OneSetOfOneDecimalsWithScaleOf9Value3("
    ...
    public OneSetOfOneDecimalsWithScaleOf9Value3 setOneSetOfOneDecimalsWithScaleOf9(
