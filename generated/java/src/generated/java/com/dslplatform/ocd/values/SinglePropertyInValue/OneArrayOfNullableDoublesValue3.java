...
public final class OneArrayOfNullableDoublesValue3 implements
        java.io.Serializable {
    public OneArrayOfNullableDoublesValue3(
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfNullableDoublesValue3)) return false;
        final OneArrayOfNullableDoublesValue3 other = (OneArrayOfNullableDoublesValue3) obj;
    ...
    public String toString() {
        return "OneArrayOfNullableDoublesValue3(" + oneArrayOfNullableDoubles
                + ')';
    }
    ...
    public OneArrayOfNullableDoublesValue3 setOneArrayOfNullableDoubles(
            final Double[] value) {
        if (value == null)
