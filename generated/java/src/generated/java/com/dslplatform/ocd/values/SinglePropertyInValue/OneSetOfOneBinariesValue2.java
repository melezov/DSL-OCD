...
public final class OneSetOfOneBinariesValue2 implements java.io.Serializable {
    public OneSetOfOneBinariesValue2(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1497761211;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneSetOfOneBinariesValue2)) return false;
        final OneSetOfOneBinariesValue2 other = (OneSetOfOneBinariesValue2) obj;
    ...
    public String toString() {
        return "OneSetOfOneBinariesValue2(" + oneSetOfOneBinaries + ')';
    }
    ...
    public OneSetOfOneBinariesValue2 setOneSetOfOneBinaries(
