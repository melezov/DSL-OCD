...
scalacOptions in(Compile, doc) ++= Seq(
  ...
  "-doc-source-url", if (isSnapshot.value) {
    s"""https://github.com/dsl-platform/DSL-OCD/tree/master/model/dsls\u20AC{FILE_PATH}.scala"""
  } else {
    s"""https://github.com/dsl-platform/DSL-OCD/blob/v${version.value}/model/dsls\u20AC{FILE_PATH}.scala"""
  }
)
