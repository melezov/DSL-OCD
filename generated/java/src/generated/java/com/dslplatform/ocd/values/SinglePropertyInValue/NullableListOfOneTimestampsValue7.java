...
public final class NullableListOfOneTimestampsValue7 implements
        java.io.Serializable {
    public NullableListOfOneTimestampsValue7(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1032046713;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof NullableListOfOneTimestampsValue7)) return false;
        final NullableListOfOneTimestampsValue7 other = (NullableListOfOneTimestampsValue7) obj;
    ...
    public String toString() {
        return "NullableListOfOneTimestampsValue7("
    ...
    public NullableListOfOneTimestampsValue7 setNullableListOfOneTimestamps(
