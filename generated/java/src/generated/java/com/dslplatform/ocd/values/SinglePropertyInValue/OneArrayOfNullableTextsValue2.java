...
public final class OneArrayOfNullableTextsValue2 implements
        java.io.Serializable {
    public OneArrayOfNullableTextsValue2(
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfNullableTextsValue2)) return false;
        final OneArrayOfNullableTextsValue2 other = (OneArrayOfNullableTextsValue2) obj;
    ...
    public String toString() {
        return "OneArrayOfNullableTextsValue2(" + oneArrayOfNullableTexts + ')';
    }
    ...
    public OneArrayOfNullableTextsValue2 setOneArrayOfNullableTexts(
            final String[] value) {
        if (value == null)
