...
public final class NullableListOfOneMapsValue2 implements java.io.Serializable {
    public NullableListOfOneMapsValue2(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 2144169408;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof NullableListOfOneMapsValue2)) return false;
        final NullableListOfOneMapsValue2 other = (NullableListOfOneMapsValue2) obj;
    ...
    public String toString() {
        return "NullableListOfOneMapsValue2(" + nullableListOfOneMaps + ')';
    }
    ...
    public NullableListOfOneMapsValue2 setNullableListOfOneMaps(
