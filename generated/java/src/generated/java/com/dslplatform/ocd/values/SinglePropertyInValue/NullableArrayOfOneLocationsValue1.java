...
public final class NullableArrayOfOneLocationsValue1 implements
        java.io.Serializable {
    public NullableArrayOfOneLocationsValue1(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1420359793;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof NullableArrayOfOneLocationsValue1)) return false;
        final NullableArrayOfOneLocationsValue1 other = (NullableArrayOfOneLocationsValue1) obj;
    ...
    public String toString() {
        return "NullableArrayOfOneLocationsValue1("
    ...
    public NullableArrayOfOneLocationsValue1 setNullableArrayOfOneLocations(
