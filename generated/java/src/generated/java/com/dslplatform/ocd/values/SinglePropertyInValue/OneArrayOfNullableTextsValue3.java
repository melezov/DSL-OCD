...
public final class OneArrayOfNullableTextsValue3 implements
        java.io.Serializable {
    public OneArrayOfNullableTextsValue3(
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfNullableTextsValue3)) return false;
        final OneArrayOfNullableTextsValue3 other = (OneArrayOfNullableTextsValue3) obj;
    ...
    public String toString() {
        return "OneArrayOfNullableTextsValue3(" + oneArrayOfNullableTexts + ')';
    }
    ...
    public OneArrayOfNullableTextsValue3 setOneArrayOfNullableTexts(
            final String[] value) {
        if (value == null)
