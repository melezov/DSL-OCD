...
public final class OneSetOfOneMapsValue2 implements java.io.Serializable {
    public OneSetOfOneMapsValue2(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1780008025;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneSetOfOneMapsValue2)) return false;
        final OneSetOfOneMapsValue2 other = (OneSetOfOneMapsValue2) obj;
    ...
    public String toString() {
        return "OneSetOfOneMapsValue2(" + oneSetOfOneMaps + ')';
    }
    ...
    public OneSetOfOneMapsValue2 setOneSetOfOneMaps(
