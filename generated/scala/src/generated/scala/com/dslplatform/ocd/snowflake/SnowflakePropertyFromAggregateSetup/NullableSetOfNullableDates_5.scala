...
class NullableSetOfNullableDates_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableSetOfNullableDates_5 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableSetOfNullableDates_5("+ URI +")"

   def copy(nullableSetOfNullableDates: Option[Set[Option[org.joda.time.LocalDate]]] = this._nullableSetOfNullableDates): NullableSetOfNullableDates_5 = {
  ...
  com.dslplatform.api.Guards.checkCollectionOptionRefNulls(nullableSetOfNullableDates)
    new NullableSetOfNullableDates_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableSetOfNullableDates = nullableSetOfNullableDates)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableSetOfNullableDates_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableSetOfNullableDates_5](URI), duration)
  }
...
object NullableSetOfNullableDates_5 extends AggregateRootCompanion[NullableSetOfNullableDates_5]{
  ...
  def apply(
    ...
    require(nullableSetOfNullableDates ne null, "Null value was provided for property \"nullableSetOfNullableDates\"")
    if (nullableSetOfNullableDates.isDefined) require(nullableSetOfNullableDates.get ne null, "Null value was provided for property \"nullableSetOfNullableDates\"")
    new NullableSetOfNullableDates_5(
      __locator = None
