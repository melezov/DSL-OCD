...
public final class OneListOfNullableMapsValue6 implements java.io.Serializable {
    public OneListOfNullableMapsValue6(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1552057416;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneListOfNullableMapsValue6)) return false;
        final OneListOfNullableMapsValue6 other = (OneListOfNullableMapsValue6) obj;
    ...
    public String toString() {
        return "OneListOfNullableMapsValue6(" + oneListOfNullableMaps + ')';
    }
    ...
    public OneListOfNullableMapsValue6 setOneListOfNullableMaps(
