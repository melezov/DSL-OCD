...
class OneSetOfOneTimestamps_6 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: OneSetOfOneTimestamps_6 => c.URI == URI
    case _ => false
  }

  override def toString = "OneSetOfOneTimestamps_6("+ URI +")"

   def copy(oneSetOfOneTimestamps: Set[org.joda.time.DateTime] = this._oneSetOfOneTimestamps): OneSetOfOneTimestamps_6 = {
  ...
  com.dslplatform.api.Guards.checkCollectionNulls(oneSetOfOneTimestamps)
    new OneSetOfOneTimestamps_6(_URI = this.URI, __locator = this.__locator, _ID = _ID, _oneSetOfOneTimestamps = oneSetOfOneTimestamps)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneSetOfOneTimestamps_6): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneSetOfOneTimestamps_6](URI), duration)
  }
...
object OneSetOfOneTimestamps_6 extends AggregateRootCompanion[OneSetOfOneTimestamps_6]{
