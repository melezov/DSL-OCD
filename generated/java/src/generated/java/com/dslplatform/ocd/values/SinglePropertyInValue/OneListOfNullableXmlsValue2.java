...
public final class OneListOfNullableXmlsValue2 implements java.io.Serializable {
    public OneListOfNullableXmlsValue2(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1007811763;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneListOfNullableXmlsValue2)) return false;
        final OneListOfNullableXmlsValue2 other = (OneListOfNullableXmlsValue2) obj;
    ...
    public String toString() {
        return "OneListOfNullableXmlsValue2(" + oneListOfNullableXmls + ')';
    }
    ...
    public OneListOfNullableXmlsValue2 setOneListOfNullableXmls(
