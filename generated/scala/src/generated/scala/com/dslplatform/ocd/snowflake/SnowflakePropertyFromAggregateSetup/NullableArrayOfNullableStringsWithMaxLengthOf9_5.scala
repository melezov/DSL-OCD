...
class NullableArrayOfNullableStringsWithMaxLengthOf9_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableArrayOfNullableStringsWithMaxLengthOf9_5 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableArrayOfNullableStringsWithMaxLengthOf9_5("+ URI +")"

   def copy(nullableArrayOfNullableStringsWithMaxLengthOf9: Option[Array[Option[String]]] = this._nullableArrayOfNullableStringsWithMaxLengthOf9): NullableArrayOfNullableStringsWithMaxLengthOf9_5 = {
  ...
  com.dslplatform.api.Guards.checkArrayOptionRefNulls(nullableArrayOfNullableStringsWithMaxLengthOf9)
    new NullableArrayOfNullableStringsWithMaxLengthOf9_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableArrayOfNullableStringsWithMaxLengthOf9 = nullableArrayOfNullableStringsWithMaxLengthOf9)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableArrayOfNullableStringsWithMaxLengthOf9_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableArrayOfNullableStringsWithMaxLengthOf9_5](URI), duration)
  }
...
object NullableArrayOfNullableStringsWithMaxLengthOf9_5 extends AggregateRootCompanion[NullableArrayOfNullableStringsWithMaxLengthOf9_5]{
