...
public final class NullableArrayOfOneImagesValue6 implements
        java.io.Serializable {
    public NullableArrayOfOneImagesValue6(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1031238776;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof NullableArrayOfOneImagesValue6)) return false;
        final NullableArrayOfOneImagesValue6 other = (NullableArrayOfOneImagesValue6) obj;
    ...
    public String toString() {
        return "NullableArrayOfOneImagesValue6(" + nullableArrayOfOneImages
                + ')';
    }
    ...
    public NullableArrayOfOneImagesValue6 setNullableArrayOfOneImages(
