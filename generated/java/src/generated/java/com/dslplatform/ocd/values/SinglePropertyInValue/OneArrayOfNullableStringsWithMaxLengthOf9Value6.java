...
public final class OneArrayOfNullableStringsWithMaxLengthOf9Value6 implements
        java.io.Serializable {
    public OneArrayOfNullableStringsWithMaxLengthOf9Value6(
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfNullableStringsWithMaxLengthOf9Value6))
            return false;
        final OneArrayOfNullableStringsWithMaxLengthOf9Value6 other = (OneArrayOfNullableStringsWithMaxLengthOf9Value6) obj;
    ...
    public String toString() {
        return "OneArrayOfNullableStringsWithMaxLengthOf9Value6("
    ...
    public OneArrayOfNullableStringsWithMaxLengthOf9Value6 setOneArrayOfNullableStringsWithMaxLengthOf9(
            final String[] value) {
        if (value == null)
