...
class OneSetOfNullableTexts_6 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: OneSetOfNullableTexts_6 => c.URI == URI
    case _ => false
  }

  override def toString = "OneSetOfNullableTexts_6("+ URI +")"

   def copy(oneSetOfNullableTexts: Set[Option[String]] = this._oneSetOfNullableTexts): OneSetOfNullableTexts_6 = {
  ...
  com.dslplatform.api.Guards.checkCollectionOptionRefNulls(oneSetOfNullableTexts)
    new OneSetOfNullableTexts_6(_URI = this.URI, __locator = this.__locator, _ID = _ID, _oneSetOfNullableTexts = oneSetOfNullableTexts)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneSetOfNullableTexts_6): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneSetOfNullableTexts_6](URI), duration)
  }
...
object OneSetOfNullableTexts_6 extends AggregateRootCompanion[OneSetOfNullableTexts_6]{
