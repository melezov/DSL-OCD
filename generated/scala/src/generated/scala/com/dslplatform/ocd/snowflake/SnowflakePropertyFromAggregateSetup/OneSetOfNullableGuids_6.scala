...
class OneSetOfNullableGuids_6 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: OneSetOfNullableGuids_6 => c.URI == URI
    case _ => false
  }

  override def toString = "OneSetOfNullableGuids_6("+ URI +")"

   def copy(oneSetOfNullableGuids: Set[Option[java.util.UUID]] = this._oneSetOfNullableGuids): OneSetOfNullableGuids_6 = {
  ...
  com.dslplatform.api.Guards.checkCollectionOptionRefNulls(oneSetOfNullableGuids)
    new OneSetOfNullableGuids_6(_URI = this.URI, __locator = this.__locator, _ID = _ID, _oneSetOfNullableGuids = oneSetOfNullableGuids)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneSetOfNullableGuids_6): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneSetOfNullableGuids_6](URI), duration)
  }
...
object OneSetOfNullableGuids_6 extends AggregateRootCompanion[OneSetOfNullableGuids_6]{
