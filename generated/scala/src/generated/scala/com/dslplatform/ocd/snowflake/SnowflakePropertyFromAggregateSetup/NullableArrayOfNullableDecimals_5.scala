...
class NullableArrayOfNullableDecimals_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableArrayOfNullableDecimals_5 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableArrayOfNullableDecimals_5("+ URI +")"

   def copy(nullableArrayOfNullableDecimals: Option[Array[Option[BigDecimal]]] = this._nullableArrayOfNullableDecimals): NullableArrayOfNullableDecimals_5 = {
  ...
  com.dslplatform.api.Guards.checkArrayOptionRefNulls(nullableArrayOfNullableDecimals)
    new NullableArrayOfNullableDecimals_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableArrayOfNullableDecimals = nullableArrayOfNullableDecimals)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableArrayOfNullableDecimals_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableArrayOfNullableDecimals_5](URI), duration)
  }
...
object NullableArrayOfNullableDecimals_5 extends AggregateRootCompanion[NullableArrayOfNullableDecimals_5]{
  ...
  def apply(
    ...
    require(nullableArrayOfNullableDecimals ne null, "Null value was provided for property \"nullableArrayOfNullableDecimals\"")
    if (nullableArrayOfNullableDecimals.isDefined) require(nullableArrayOfNullableDecimals.get ne null, "Null value was provided for property \"nullableArrayOfNullableDecimals\"")
    new NullableArrayOfNullableDecimals_5(
      __locator = None
