...
public final class NullableArrayOfNullableStringsWithMaxLengthOf9Value5
        implements java.io.Serializable {
    public NullableArrayOfNullableStringsWithMaxLengthOf9Value5(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1942587376;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof NullableArrayOfNullableStringsWithMaxLengthOf9Value5))
            return false;
        final NullableArrayOfNullableStringsWithMaxLengthOf9Value5 other = (NullableArrayOfNullableStringsWithMaxLengthOf9Value5) obj;
    ...
    public String toString() {
        return "NullableArrayOfNullableStringsWithMaxLengthOf9Value5("
    ...
    public NullableArrayOfNullableStringsWithMaxLengthOf9Value5 setNullableArrayOfNullableStringsWithMaxLengthOf9(
            final String[] value) {
        if (value != null)
