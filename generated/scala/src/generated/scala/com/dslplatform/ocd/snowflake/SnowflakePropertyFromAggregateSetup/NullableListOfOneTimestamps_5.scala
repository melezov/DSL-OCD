...
class NullableListOfOneTimestamps_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableListOfOneTimestamps_5 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableListOfOneTimestamps_5("+ URI +")"

   def copy(nullableListOfOneTimestamps: Option[IndexedSeq[org.joda.time.DateTime]] = this._nullableListOfOneTimestamps): NullableListOfOneTimestamps_5 = {
  ...
  com.dslplatform.api.Guards.checkCollectionNulls(nullableListOfOneTimestamps)
    new NullableListOfOneTimestamps_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableListOfOneTimestamps = nullableListOfOneTimestamps)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableListOfOneTimestamps_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableListOfOneTimestamps_5](URI), duration)
  }
...
object NullableListOfOneTimestamps_5 extends AggregateRootCompanion[NullableListOfOneTimestamps_5]{
  ...
  def apply(
    ...
    require(nullableListOfOneTimestamps ne null, "Null value was provided for property \"nullableListOfOneTimestamps\"")
    if (nullableListOfOneTimestamps.isDefined) require(nullableListOfOneTimestamps.get ne null, "Null value was provided for property \"nullableListOfOneTimestamps\"")
    new NullableListOfOneTimestamps_5(
      __locator = None
