...
class NullableListOfOneDecimalsWithScaleOf9_2 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableListOfOneDecimalsWithScaleOf9_2 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableListOfOneDecimalsWithScaleOf9_2("+ URI +")"

   def copy(nullableListOfOneDecimalsWithScaleOf9: Option[IndexedSeq[BigDecimal]] = this._nullableListOfOneDecimalsWithScaleOf9): NullableListOfOneDecimalsWithScaleOf9_2 = {
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.aggregates.SurrogatePrimaryKeyWithOnePropertyInAggregate.NullableListOfOneDecimalsWithScaleOf9_2): this.type = {
...
object NullableListOfOneDecimalsWithScaleOf9_2 extends AggregateRootCompanion[NullableListOfOneDecimalsWithScaleOf9_2]{
