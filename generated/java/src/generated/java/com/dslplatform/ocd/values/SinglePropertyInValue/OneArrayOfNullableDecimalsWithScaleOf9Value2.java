...
public final class OneArrayOfNullableDecimalsWithScaleOf9Value2 implements
        java.io.Serializable {
    public OneArrayOfNullableDecimalsWithScaleOf9Value2(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1677512244;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfNullableDecimalsWithScaleOf9Value2))
            return false;
        final OneArrayOfNullableDecimalsWithScaleOf9Value2 other = (OneArrayOfNullableDecimalsWithScaleOf9Value2) obj;
    ...
    public String toString() {
        return "OneArrayOfNullableDecimalsWithScaleOf9Value2("
    ...
    public OneArrayOfNullableDecimalsWithScaleOf9Value2 setOneArrayOfNullableDecimalsWithScaleOf9(
