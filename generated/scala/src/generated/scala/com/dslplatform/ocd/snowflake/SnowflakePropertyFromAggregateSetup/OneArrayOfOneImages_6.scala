...
class OneArrayOfOneImages_6 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: OneArrayOfOneImages_6 => c.URI == URI
    case _ => false
  }

  override def toString = "OneArrayOfOneImages_6("+ URI +")"

   def copy(oneArrayOfOneImages: Array[java.awt.image.BufferedImage] = this._oneArrayOfOneImages): OneArrayOfOneImages_6 = {
  ...
  com.dslplatform.api.Guards.checkArrayNulls(oneArrayOfOneImages)
    new OneArrayOfOneImages_6(_URI = this.URI, __locator = this.__locator, _ID = _ID, _oneArrayOfOneImages = oneArrayOfOneImages)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneArrayOfOneImages_6): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneArrayOfOneImages_6](URI), duration)
  }
...
object OneArrayOfOneImages_6 extends AggregateRootCompanion[OneArrayOfOneImages_6]{
