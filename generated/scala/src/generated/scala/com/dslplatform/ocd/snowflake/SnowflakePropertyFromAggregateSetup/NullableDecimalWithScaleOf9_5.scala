...
class NullableDecimalWithScaleOf9_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableDecimalWithScaleOf9_5 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableDecimalWithScaleOf9_5("+ URI +")"

   def copy(nullableDecimalWithScaleOf9: Option[BigDecimal] = this._nullableDecimalWithScaleOf9): NullableDecimalWithScaleOf9_5 = {
  ...
  com.dslplatform.api.Guards.checkScale(nullableDecimalWithScaleOf9, 9)
    new NullableDecimalWithScaleOf9_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableDecimalWithScaleOf9 = nullableDecimalWithScaleOf9)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableDecimalWithScaleOf9_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableDecimalWithScaleOf9_5](URI), duration)
  }
...
object NullableDecimalWithScaleOf9_5 extends AggregateRootCompanion[NullableDecimalWithScaleOf9_5]{
  ...
  def apply(
    ...
    require(nullableDecimalWithScaleOf9 ne null, "Null value was provided for property \"nullableDecimalWithScaleOf9\"")
    if (nullableDecimalWithScaleOf9.isDefined) require(nullableDecimalWithScaleOf9.get ne null, "Null value was provided for property \"nullableDecimalWithScaleOf9\"")
    new NullableDecimalWithScaleOf9_5(
      __locator = None
