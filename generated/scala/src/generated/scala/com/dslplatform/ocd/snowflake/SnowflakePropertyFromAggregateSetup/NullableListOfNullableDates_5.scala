...
class NullableListOfNullableDates_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableListOfNullableDates_5 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableListOfNullableDates_5("+ URI +")"

   def copy(nullableListOfNullableDates: Option[IndexedSeq[Option[org.joda.time.LocalDate]]] = this._nullableListOfNullableDates): NullableListOfNullableDates_5 = {
  ...
  com.dslplatform.api.Guards.checkCollectionOptionRefNulls(nullableListOfNullableDates)
    new NullableListOfNullableDates_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableListOfNullableDates = nullableListOfNullableDates)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableListOfNullableDates_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableListOfNullableDates_5](URI), duration)
  }
...
object NullableListOfNullableDates_5 extends AggregateRootCompanion[NullableListOfNullableDates_5]{
  ...
  def apply(
    ...
    require(nullableListOfNullableDates ne null, "Null value was provided for property \"nullableListOfNullableDates\"")
    if (nullableListOfNullableDates.isDefined) require(nullableListOfNullableDates.get ne null, "Null value was provided for property \"nullableListOfNullableDates\"")
    new NullableListOfNullableDates_5(
      __locator = None
