...
public final class OneArrayOfOneGuidsValue3 implements java.io.Serializable {
    public OneArrayOfOneGuidsValue3(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1687988842;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfOneGuidsValue3)) return false;
        final OneArrayOfOneGuidsValue3 other = (OneArrayOfOneGuidsValue3) obj;
    ...
    public String toString() {
        return "OneArrayOfOneGuidsValue3(" + oneArrayOfOneGuids + ')';
    }
    ...
    public OneArrayOfOneGuidsValue3 setOneArrayOfOneGuids(
