...
class OneArrayOfNullableTimestamps_6 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: OneArrayOfNullableTimestamps_6 => c.URI == URI
    case _ => false
  }

  override def toString = "OneArrayOfNullableTimestamps_6("+ URI +")"

   def copy(oneArrayOfNullableTimestamps: Array[Option[org.joda.time.DateTime]] = this._oneArrayOfNullableTimestamps): OneArrayOfNullableTimestamps_6 = {
  ...
  com.dslplatform.api.Guards.checkArrayOptionRefNulls(oneArrayOfNullableTimestamps)
    new OneArrayOfNullableTimestamps_6(_URI = this.URI, __locator = this.__locator, _ID = _ID, _oneArrayOfNullableTimestamps = oneArrayOfNullableTimestamps)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneArrayOfNullableTimestamps_6): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneArrayOfNullableTimestamps_6](URI), duration)
  }
...
object OneArrayOfNullableTimestamps_6 extends AggregateRootCompanion[OneArrayOfNullableTimestamps_6]{
  ...
  def apply(
    ...
    com.dslplatform.api.Guards.checkArrayOptionRefNulls(oneArrayOfNullableTimestamps)
    require(oneArrayOfNullableTimestamps ne null, "Null value was provided for property \"oneArrayOfNullableTimestamps\"")
    new OneArrayOfNullableTimestamps_6(
      __locator = None
