...
public final class NullableListOfNullableDecimalsWithScaleOf9Value1 implements
        java.io.Serializable {
    public NullableListOfNullableDecimalsWithScaleOf9Value1(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1424276337;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof NullableListOfNullableDecimalsWithScaleOf9Value1))
            return false;
        final NullableListOfNullableDecimalsWithScaleOf9Value1 other = (NullableListOfNullableDecimalsWithScaleOf9Value1) obj;
    ...
    public String toString() {
        return "NullableListOfNullableDecimalsWithScaleOf9Value1("
    ...
    public NullableListOfNullableDecimalsWithScaleOf9Value1 setNullableListOfNullableDecimalsWithScaleOf9(
