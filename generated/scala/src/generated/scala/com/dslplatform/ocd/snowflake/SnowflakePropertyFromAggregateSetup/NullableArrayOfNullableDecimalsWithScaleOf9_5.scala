...
class NullableArrayOfNullableDecimalsWithScaleOf9_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableArrayOfNullableDecimalsWithScaleOf9_5 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableArrayOfNullableDecimalsWithScaleOf9_5("+ URI +")"

   def copy(nullableArrayOfNullableDecimalsWithScaleOf9: Option[Array[Option[BigDecimal]]] = this._nullableArrayOfNullableDecimalsWithScaleOf9): NullableArrayOfNullableDecimalsWithScaleOf9_5 = {
  ...
  com.dslplatform.api.Guards.checkArrayOptionRefNulls(nullableArrayOfNullableDecimalsWithScaleOf9)
    new NullableArrayOfNullableDecimalsWithScaleOf9_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableArrayOfNullableDecimalsWithScaleOf9 = nullableArrayOfNullableDecimalsWithScaleOf9)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableArrayOfNullableDecimalsWithScaleOf9_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableArrayOfNullableDecimalsWithScaleOf9_5](URI), duration)
  }
...
object NullableArrayOfNullableDecimalsWithScaleOf9_5 extends AggregateRootCompanion[NullableArrayOfNullableDecimalsWithScaleOf9_5]{
