...
public final class OneListOfOneDecimalsWithScaleOf9Value1 implements
        java.io.Serializable {
    public OneListOfOneDecimalsWithScaleOf9Value1(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1307736213;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneListOfOneDecimalsWithScaleOf9Value1))
            return false;
        final OneListOfOneDecimalsWithScaleOf9Value1 other = (OneListOfOneDecimalsWithScaleOf9Value1) obj;
    ...
    public String toString() {
        return "OneListOfOneDecimalsWithScaleOf9Value1("
    ...
    public OneListOfOneDecimalsWithScaleOf9Value1 setOneListOfOneDecimalsWithScaleOf9(
