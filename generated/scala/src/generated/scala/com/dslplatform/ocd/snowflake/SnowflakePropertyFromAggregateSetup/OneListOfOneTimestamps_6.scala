...
class OneListOfOneTimestamps_6 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: OneListOfOneTimestamps_6 => c.URI == URI
    case _ => false
  }

  override def toString = "OneListOfOneTimestamps_6("+ URI +")"

   def copy(oneListOfOneTimestamps: IndexedSeq[org.joda.time.DateTime] = this._oneListOfOneTimestamps): OneListOfOneTimestamps_6 = {
  ...
  com.dslplatform.api.Guards.checkCollectionNulls(oneListOfOneTimestamps)
    new OneListOfOneTimestamps_6(_URI = this.URI, __locator = this.__locator, _ID = _ID, _oneListOfOneTimestamps = oneListOfOneTimestamps)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneListOfOneTimestamps_6): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneListOfOneTimestamps_6](URI), duration)
  }
...
object OneListOfOneTimestamps_6 extends AggregateRootCompanion[OneListOfOneTimestamps_6]{
