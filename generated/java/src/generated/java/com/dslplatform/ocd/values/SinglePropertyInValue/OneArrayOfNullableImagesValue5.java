...
public final class OneArrayOfNullableImagesValue5 implements
        java.io.Serializable {
    public OneArrayOfNullableImagesValue5(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1118757101;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfNullableImagesValue5)) return false;
        final OneArrayOfNullableImagesValue5 other = (OneArrayOfNullableImagesValue5) obj;
    ...
    public String toString() {
        return "OneArrayOfNullableImagesValue5(" + oneArrayOfNullableImages
                + ')';
    }
    ...
    public OneArrayOfNullableImagesValue5 setOneArrayOfNullableImages(
