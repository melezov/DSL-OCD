...
class NullableArrayOfOneStringsWithMaxLengthOf9_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableArrayOfOneStringsWithMaxLengthOf9_5 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableArrayOfOneStringsWithMaxLengthOf9_5("+ URI +")"

   def copy(nullableArrayOfOneStringsWithMaxLengthOf9: Option[Array[String]] = this._nullableArrayOfOneStringsWithMaxLengthOf9): NullableArrayOfOneStringsWithMaxLengthOf9_5 = {
  ...
  com.dslplatform.api.Guards.checkArrayNulls(nullableArrayOfOneStringsWithMaxLengthOf9)
    new NullableArrayOfOneStringsWithMaxLengthOf9_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableArrayOfOneStringsWithMaxLengthOf9 = nullableArrayOfOneStringsWithMaxLengthOf9)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableArrayOfOneStringsWithMaxLengthOf9_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableArrayOfOneStringsWithMaxLengthOf9_5](URI), duration)
  }
...
object NullableArrayOfOneStringsWithMaxLengthOf9_5 extends AggregateRootCompanion[NullableArrayOfOneStringsWithMaxLengthOf9_5]{
