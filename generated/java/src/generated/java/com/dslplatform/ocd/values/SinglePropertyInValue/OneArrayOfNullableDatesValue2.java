...
public final class OneArrayOfNullableDatesValue2 implements
        java.io.Serializable {
    public OneArrayOfNullableDatesValue2(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1685906621;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfNullableDatesValue2)) return false;
        final OneArrayOfNullableDatesValue2 other = (OneArrayOfNullableDatesValue2) obj;
    ...
    public String toString() {
        return "OneArrayOfNullableDatesValue2(" + oneArrayOfNullableDates + ')';
    }
    ...
    public OneArrayOfNullableDatesValue2 setOneArrayOfNullableDates(
