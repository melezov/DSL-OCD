...
public final class NullableArrayOfOneGuidsValue12 implements
        java.io.Serializable {
    public NullableArrayOfOneGuidsValue12(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 2063209477;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof NullableArrayOfOneGuidsValue12)) return false;
        final NullableArrayOfOneGuidsValue12 other = (NullableArrayOfOneGuidsValue12) obj;
    ...
    public String toString() {
        return "NullableArrayOfOneGuidsValue12(" + nullableArrayOfOneGuids
                + ')';
    }
    ...
    public NullableArrayOfOneGuidsValue12 setNullableArrayOfOneGuids(
