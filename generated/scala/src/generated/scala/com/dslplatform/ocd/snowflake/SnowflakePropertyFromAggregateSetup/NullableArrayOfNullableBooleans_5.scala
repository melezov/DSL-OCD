...
class NullableArrayOfNullableBooleans_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableArrayOfNullableBooleans_5 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableArrayOfNullableBooleans_5("+ URI +")"

   def copy(nullableArrayOfNullableBooleans: Option[Array[Option[Boolean]]] = this._nullableArrayOfNullableBooleans): NullableArrayOfNullableBooleans_5 = {
  ...
  com.dslplatform.api.Guards.checkArrayOptionValNulls(nullableArrayOfNullableBooleans)
    new NullableArrayOfNullableBooleans_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableArrayOfNullableBooleans = nullableArrayOfNullableBooleans)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableArrayOfNullableBooleans_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableArrayOfNullableBooleans_5](URI), duration)
  }
...
object NullableArrayOfNullableBooleans_5 extends AggregateRootCompanion[NullableArrayOfNullableBooleans_5]{
  ...
  def apply(
    ...
    require(nullableArrayOfNullableBooleans ne null, "Null value was provided for property \"nullableArrayOfNullableBooleans\"")
    if (nullableArrayOfNullableBooleans.isDefined) require(nullableArrayOfNullableBooleans.get ne null, "Null value was provided for property \"nullableArrayOfNullableBooleans\"")
    new NullableArrayOfNullableBooleans_5(
      __locator = None
