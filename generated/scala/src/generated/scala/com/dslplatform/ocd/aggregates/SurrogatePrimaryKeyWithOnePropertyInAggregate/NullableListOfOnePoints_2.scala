...
class NullableListOfOnePoints_2 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableListOfOnePoints_2 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableListOfOnePoints_2("+ URI +")"

   def copy(nullableListOfOnePoints: Option[IndexedSeq[java.awt.geom.Point2D]] = this._nullableListOfOnePoints): NullableListOfOnePoints_2 = {
  ...
  com.dslplatform.api.Guards.checkCollectionNulls(nullableListOfOnePoints)
    new NullableListOfOnePoints_2(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableListOfOnePoints = nullableListOfOnePoints)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.aggregates.SurrogatePrimaryKeyWithOnePropertyInAggregate.NullableListOfOnePoints_2): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.aggregates.SurrogatePrimaryKeyWithOnePropertyInAggregate.NullableListOfOnePoints_2](URI), duration)
  }

  @com.fasterxml.jackson.annotation.JsonGetter("nullableListOfOnePoints")
...
object NullableListOfOnePoints_2 extends AggregateRootCompanion[NullableListOfOnePoints_2]{
