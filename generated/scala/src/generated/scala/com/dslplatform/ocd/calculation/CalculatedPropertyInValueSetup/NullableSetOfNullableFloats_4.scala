...
case class NullableSetOfNullableFloats_4 @com.fasterxml.jackson.annotation.JsonIgnore() (
     nullableSetOfNullableFloats: Option[Set[Option[Float]]] = None,
     calculatedNullableSetOfNullableFloats: Option[Set[Option[Float]]] = None,
     persistedNullableSetOfNullableFloats: Option[Set[Option[Float]]] = None
  ) {
  ...
  , @com.fasterxml.jackson.annotation.JsonProperty("persistedNullableSetOfNullableFloats") persistedNullableSetOfNullableFloats: Option[Set[Option[Float]]]
    ...
    this( nullableSetOfNullableFloats = nullableSetOfNullableFloats, calculatedNullableSetOfNullableFloats = calculatedNullableSetOfNullableFloats, persistedNullableSetOfNullableFloats = persistedNullableSetOfNullableFloats)
