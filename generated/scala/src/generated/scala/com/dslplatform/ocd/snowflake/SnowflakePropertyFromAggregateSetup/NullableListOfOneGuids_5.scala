...
class NullableListOfOneGuids_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableListOfOneGuids_5 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableListOfOneGuids_5("+ URI +")"

   def copy(nullableListOfOneGuids: Option[IndexedSeq[java.util.UUID]] = this._nullableListOfOneGuids): NullableListOfOneGuids_5 = {
  ...
  com.dslplatform.api.Guards.checkCollectionNulls(nullableListOfOneGuids)
    new NullableListOfOneGuids_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableListOfOneGuids = nullableListOfOneGuids)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableListOfOneGuids_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableListOfOneGuids_5](URI), duration)
  }
...
object NullableListOfOneGuids_5 extends AggregateRootCompanion[NullableListOfOneGuids_5]{
