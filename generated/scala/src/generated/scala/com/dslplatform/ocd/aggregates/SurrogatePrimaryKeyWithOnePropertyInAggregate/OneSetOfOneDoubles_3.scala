...
class OneSetOfOneDoubles_3 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: OneSetOfOneDoubles_3 => c.URI == URI
    case _ => false
  }

  override def toString = "OneSetOfOneDoubles_3("+ URI +")"

   def copy(oneSetOfOneDoubles: Set[Double] = this._oneSetOfOneDoubles): OneSetOfOneDoubles_3 = {
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.aggregates.SurrogatePrimaryKeyWithOnePropertyInAggregate.OneSetOfOneDoubles_3): this.type = {
...
object OneSetOfOneDoubles_3 extends AggregateRootCompanion[OneSetOfOneDoubles_3]{

  def apply(
    oneSetOfOneDoubles: Set[Double] = Set.empty
  ) = {
    require(oneSetOfOneDoubles ne null, "Null value was provided for property \"oneSetOfOneDoubles\"")
    new OneSetOfOneDoubles_3(
      __locator = None
