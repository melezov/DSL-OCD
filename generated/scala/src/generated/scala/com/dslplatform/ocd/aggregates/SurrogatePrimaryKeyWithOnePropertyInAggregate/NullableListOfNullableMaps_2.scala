...
class NullableListOfNullableMaps_2 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableListOfNullableMaps_2 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableListOfNullableMaps_2("+ URI +")"

   def copy(nullableListOfNullableMaps: Option[IndexedSeq[Option[Map[String, String]]]] = this._nullableListOfNullableMaps): NullableListOfNullableMaps_2 = {
  ...
  com.dslplatform.api.Guards.checkCollectionOptionRefNulls(nullableListOfNullableMaps)
    new NullableListOfNullableMaps_2(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableListOfNullableMaps = nullableListOfNullableMaps)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.aggregates.SurrogatePrimaryKeyWithOnePropertyInAggregate.NullableListOfNullableMaps_2): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.aggregates.SurrogatePrimaryKeyWithOnePropertyInAggregate.NullableListOfNullableMaps_2](URI), duration)
  }

  @com.fasterxml.jackson.annotation.JsonGetter("nullableListOfNullableMaps")
...
object NullableListOfNullableMaps_2 extends AggregateRootCompanion[NullableListOfNullableMaps_2]{
  ...
  def apply(
    ...
    require(nullableListOfNullableMaps ne null, "Null value was provided for property \"nullableListOfNullableMaps\"")
    if (nullableListOfNullableMaps.isDefined) require(nullableListOfNullableMaps.get ne null, "Null value was provided for property \"nullableListOfNullableMaps\"")
    new NullableListOfNullableMaps_2(
      __locator = None
