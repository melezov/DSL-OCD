...
class NullableSetOfOneStringsWithMaxLengthOf9_2 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableSetOfOneStringsWithMaxLengthOf9_2 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableSetOfOneStringsWithMaxLengthOf9_2("+ URI +")"

   def copy(nullableSetOfOneStringsWithMaxLengthOf9: Option[Set[String]] = this._nullableSetOfOneStringsWithMaxLengthOf9): NullableSetOfOneStringsWithMaxLengthOf9_2 = {
  ...
  com.dslplatform.api.Guards.checkCollectionNulls(nullableSetOfOneStringsWithMaxLengthOf9)
    new NullableSetOfOneStringsWithMaxLengthOf9_2(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableSetOfOneStringsWithMaxLengthOf9 = nullableSetOfOneStringsWithMaxLengthOf9)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.aggregates.SurrogatePrimaryKeyWithOnePropertyInAggregate.NullableSetOfOneStringsWithMaxLengthOf9_2): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.aggregates.SurrogatePrimaryKeyWithOnePropertyInAggregate.NullableSetOfOneStringsWithMaxLengthOf9_2](URI), duration)
  }

  @com.fasterxml.jackson.annotation.JsonGetter("nullableSetOfOneStringsWithMaxLengthOf9")
...
object NullableSetOfOneStringsWithMaxLengthOf9_2 extends AggregateRootCompanion[NullableSetOfOneStringsWithMaxLengthOf9_2]{
