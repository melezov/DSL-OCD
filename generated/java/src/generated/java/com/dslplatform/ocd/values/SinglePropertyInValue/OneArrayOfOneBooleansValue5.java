...
public final class OneArrayOfOneBooleansValue5 implements java.io.Serializable {
    public OneArrayOfOneBooleansValue5(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 2015824281;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfOneBooleansValue5)) return false;
        final OneArrayOfOneBooleansValue5 other = (OneArrayOfOneBooleansValue5) obj;
    ...
    public String toString() {
        return "OneArrayOfOneBooleansValue5(" + oneArrayOfOneBooleans + ')';
    }
    ...
    public OneArrayOfOneBooleansValue5 setOneArrayOfOneBooleans(
            final boolean[] value) {
        if (value == null)
