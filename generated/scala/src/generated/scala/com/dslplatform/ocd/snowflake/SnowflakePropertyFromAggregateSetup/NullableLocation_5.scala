...
class NullableLocation_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableLocation_5 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableLocation_5("+ URI +")"

   def copy(nullableLocation: Option[java.awt.geom.Point2D] = this._nullableLocation): NullableLocation_5 = {
  ...
  if(nullableLocation.isDefined) require(nullableLocation.get ne null, "Null value was provided for property \"nullableLocation\"")
    new NullableLocation_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableLocation = nullableLocation)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableLocation_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableLocation_5](URI), duration)
  }
...
object NullableLocation_5 extends AggregateRootCompanion[NullableLocation_5]{
