...
public final class OneSetOfNullableImagesValue5 implements java.io.Serializable {
    public OneSetOfNullableImagesValue5(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1169936692;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneSetOfNullableImagesValue5)) return false;
        final OneSetOfNullableImagesValue5 other = (OneSetOfNullableImagesValue5) obj;
    ...
    public String toString() {
        return "OneSetOfNullableImagesValue5(" + oneSetOfNullableImages + ')';
    }
    ...
    public OneSetOfNullableImagesValue5 setOneSetOfNullableImages(
