...
public final class OneArrayOfOneStringsWithMaxLengthOf9Value6 implements
        java.io.Serializable {
    public OneArrayOfOneStringsWithMaxLengthOf9Value6(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1563547431;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfOneStringsWithMaxLengthOf9Value6))
            return false;
        final OneArrayOfOneStringsWithMaxLengthOf9Value6 other = (OneArrayOfOneStringsWithMaxLengthOf9Value6) obj;
    ...
    public String toString() {
        return "OneArrayOfOneStringsWithMaxLengthOf9Value6("
    ...
    public OneArrayOfOneStringsWithMaxLengthOf9Value6 setOneArrayOfOneStringsWithMaxLengthOf9(
            final String[] value) {
        if (value == null)
