...
class NullableListOfNullableMonies_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableListOfNullableMonies_5 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableListOfNullableMonies_5("+ URI +")"

   def copy(nullableListOfNullableMonies: Option[IndexedSeq[Option[BigDecimal]]] = this._nullableListOfNullableMonies): NullableListOfNullableMonies_5 = {
  ...
  com.dslplatform.api.Guards.checkCollectionOptionRefNulls(nullableListOfNullableMonies)
    new NullableListOfNullableMonies_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableListOfNullableMonies = nullableListOfNullableMonies)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableListOfNullableMonies_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableListOfNullableMonies_5](URI), duration)
  }
...
object NullableListOfNullableMonies_5 extends AggregateRootCompanion[NullableListOfNullableMonies_5]{
  ...
  def apply(
    ...
    require(nullableListOfNullableMonies ne null, "Null value was provided for property \"nullableListOfNullableMonies\"")
    if (nullableListOfNullableMonies.isDefined) require(nullableListOfNullableMonies.get ne null, "Null value was provided for property \"nullableListOfNullableMonies\"")
    new NullableListOfNullableMonies_5(
      __locator = None
