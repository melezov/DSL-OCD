...
public final class OneListOfNullableGuidsValue6 implements java.io.Serializable {
    public OneListOfNullableGuidsValue6(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1974485669;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneListOfNullableGuidsValue6)) return false;
        final OneListOfNullableGuidsValue6 other = (OneListOfNullableGuidsValue6) obj;
    ...
    public String toString() {
        return "OneListOfNullableGuidsValue6(" + oneListOfNullableGuids + ')';
    }
    ...
    public OneListOfNullableGuidsValue6 setOneListOfNullableGuids(
