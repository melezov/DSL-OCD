...
public final class OneSetOfOneTimestampsValue1 implements java.io.Serializable {
    public OneSetOfOneTimestampsValue1(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1629542836;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneSetOfOneTimestampsValue1)) return false;
        final OneSetOfOneTimestampsValue1 other = (OneSetOfOneTimestampsValue1) obj;
    ...
    public String toString() {
        return "OneSetOfOneTimestampsValue1(" + oneSetOfOneTimestamps + ')';
    }
    ...
    public OneSetOfOneTimestampsValue1 setOneSetOfOneTimestamps(
