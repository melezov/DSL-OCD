...
public final class OneArrayOfNullableDatesValue3 implements
        java.io.Serializable {
    public OneArrayOfNullableDatesValue3(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1685906622;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfNullableDatesValue3)) return false;
        final OneArrayOfNullableDatesValue3 other = (OneArrayOfNullableDatesValue3) obj;
    ...
    public String toString() {
        return "OneArrayOfNullableDatesValue3(" + oneArrayOfNullableDates + ')';
    }
    ...
    public OneArrayOfNullableDatesValue3 setOneArrayOfNullableDates(
