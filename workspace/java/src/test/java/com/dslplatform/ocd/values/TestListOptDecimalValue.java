...
public class TestListOptDecimalValue {
    ...
    public void testSetterNullGuard() {
        try {
            new ListOptDecimalValue().setListOptDecimal(null);
        }
    ...
    public void testValueEquality() {
      final ListOptDecimalValue v1 = new ListOptDecimalValue();
      final ListOptDecimalValue v2 = new ListOptDecimalValue();
