...
class NullableArrayOfNullableMaps_2 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableArrayOfNullableMaps_2 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableArrayOfNullableMaps_2("+ URI +")"

   def copy(nullableArrayOfNullableMaps: Option[Array[Option[Map[String, String]]]] = this._nullableArrayOfNullableMaps): NullableArrayOfNullableMaps_2 = {
  ...
  com.dslplatform.api.Guards.checkArrayOptionRefNulls(nullableArrayOfNullableMaps)
    new NullableArrayOfNullableMaps_2(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableArrayOfNullableMaps = nullableArrayOfNullableMaps)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.aggregates.SurrogatePrimaryKeyWithOnePropertyInAggregate.NullableArrayOfNullableMaps_2): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.aggregates.SurrogatePrimaryKeyWithOnePropertyInAggregate.NullableArrayOfNullableMaps_2](URI), duration)
  }

  @com.fasterxml.jackson.annotation.JsonGetter("nullableArrayOfNullableMaps")
...
object NullableArrayOfNullableMaps_2 extends AggregateRootCompanion[NullableArrayOfNullableMaps_2]{
  ...
  def apply(
    ...
    require(nullableArrayOfNullableMaps ne null, "Null value was provided for property \"nullableArrayOfNullableMaps\"")
    if (nullableArrayOfNullableMaps.isDefined) require(nullableArrayOfNullableMaps.get ne null, "Null value was provided for property \"nullableArrayOfNullableMaps\"")
    new NullableArrayOfNullableMaps_2(
      __locator = None
