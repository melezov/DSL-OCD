...
public final class OneArrayOfOneDecimalsWithScaleOf9Value4 implements
        java.io.Serializable {
    public OneArrayOfOneDecimalsWithScaleOf9Value4(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1321286569;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfOneDecimalsWithScaleOf9Value4))
            return false;
        final OneArrayOfOneDecimalsWithScaleOf9Value4 other = (OneArrayOfOneDecimalsWithScaleOf9Value4) obj;
    ...
    public String toString() {
        return "OneArrayOfOneDecimalsWithScaleOf9Value4("
    ...
    public OneArrayOfOneDecimalsWithScaleOf9Value4 setOneArrayOfOneDecimalsWithScaleOf9(
