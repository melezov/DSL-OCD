...
class NullableListOfOneFloats_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableListOfOneFloats_5 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableListOfOneFloats_5("+ URI +")"

   def copy(nullableListOfOneFloats: Option[IndexedSeq[Float]] = this._nullableListOfOneFloats): NullableListOfOneFloats_5 = {
  ...
  if(nullableListOfOneFloats.isDefined) require(nullableListOfOneFloats.get ne null, "Null value was provided for property \"nullableListOfOneFloats\"")
    new NullableListOfOneFloats_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableListOfOneFloats = nullableListOfOneFloats)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableListOfOneFloats_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableListOfOneFloats_5](URI), duration)
  }
...
object NullableListOfOneFloats_5 extends AggregateRootCompanion[NullableListOfOneFloats_5]{
