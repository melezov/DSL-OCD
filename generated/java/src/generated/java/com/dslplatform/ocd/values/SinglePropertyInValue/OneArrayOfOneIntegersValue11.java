...
public final class OneArrayOfOneIntegersValue11 implements java.io.Serializable {
    public OneArrayOfOneIntegersValue11(
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfOneIntegersValue11)) return false;
        final OneArrayOfOneIntegersValue11 other = (OneArrayOfOneIntegersValue11) obj;
    ...
    public String toString() {
        return "OneArrayOfOneIntegersValue11(" + oneArrayOfOneIntegers + ')';
    }
    ...
    public OneArrayOfOneIntegersValue11 setOneArrayOfOneIntegers(
            final int[] value) {
        if (value == null)
