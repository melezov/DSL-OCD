...
public final class NullableArrayOfNullableImagesValue9 implements
        java.io.Serializable {
    public NullableArrayOfNullableImagesValue9(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 2023801870;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof NullableArrayOfNullableImagesValue9))
            return false;
        final NullableArrayOfNullableImagesValue9 other = (NullableArrayOfNullableImagesValue9) obj;
    ...
    public String toString() {
        return "NullableArrayOfNullableImagesValue9("
    ...
    public NullableArrayOfNullableImagesValue9 setNullableArrayOfNullableImages(
