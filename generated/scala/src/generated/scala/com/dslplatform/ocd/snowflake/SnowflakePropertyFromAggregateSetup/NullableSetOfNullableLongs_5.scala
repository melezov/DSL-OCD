...
class NullableSetOfNullableLongs_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableSetOfNullableLongs_5 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableSetOfNullableLongs_5("+ URI +")"

   def copy(nullableSetOfNullableLongs: Option[Set[Option[Long]]] = this._nullableSetOfNullableLongs): NullableSetOfNullableLongs_5 = {
  ...
  com.dslplatform.api.Guards.checkCollectionOptionValNulls(nullableSetOfNullableLongs)
    new NullableSetOfNullableLongs_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableSetOfNullableLongs = nullableSetOfNullableLongs)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableSetOfNullableLongs_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableSetOfNullableLongs_5](URI), duration)
  }
...
object NullableSetOfNullableLongs_5 extends AggregateRootCompanion[NullableSetOfNullableLongs_5]{
  ...
  def apply(
    ...
    require(nullableSetOfNullableLongs ne null, "Null value was provided for property \"nullableSetOfNullableLongs\"")
    if (nullableSetOfNullableLongs.isDefined) require(nullableSetOfNullableLongs.get ne null, "Null value was provided for property \"nullableSetOfNullableLongs\"")
    new NullableSetOfNullableLongs_5(
      __locator = None
