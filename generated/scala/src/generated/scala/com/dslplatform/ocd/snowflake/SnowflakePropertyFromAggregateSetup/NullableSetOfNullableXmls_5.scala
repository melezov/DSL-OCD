...
class NullableSetOfNullableXmls_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableSetOfNullableXmls_5 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableSetOfNullableXmls_5("+ URI +")"

   def copy(nullableSetOfNullableXmls: Option[Set[Option[scala.xml.Elem]]] = this._nullableSetOfNullableXmls): NullableSetOfNullableXmls_5 = {
  ...
  com.dslplatform.api.Guards.checkCollectionOptionRefNulls(nullableSetOfNullableXmls)
    new NullableSetOfNullableXmls_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableSetOfNullableXmls = nullableSetOfNullableXmls)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableSetOfNullableXmls_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableSetOfNullableXmls_5](URI), duration)
  }
...
object NullableSetOfNullableXmls_5 extends AggregateRootCompanion[NullableSetOfNullableXmls_5]{
  ...
  def apply(
    ...
    require(nullableSetOfNullableXmls ne null, "Null value was provided for property \"nullableSetOfNullableXmls\"")
    if (nullableSetOfNullableXmls.isDefined) require(nullableSetOfNullableXmls.get ne null, "Null value was provided for property \"nullableSetOfNullableXmls\"")
    new NullableSetOfNullableXmls_5(
      __locator = None
