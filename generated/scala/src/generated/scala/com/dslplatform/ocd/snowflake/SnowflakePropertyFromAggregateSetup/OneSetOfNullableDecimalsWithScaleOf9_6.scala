...
class OneSetOfNullableDecimalsWithScaleOf9_6 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: OneSetOfNullableDecimalsWithScaleOf9_6 => c.URI == URI
    case _ => false
  }

  override def toString = "OneSetOfNullableDecimalsWithScaleOf9_6("+ URI +")"

   def copy(oneSetOfNullableDecimalsWithScaleOf9: Set[Option[BigDecimal]] = this._oneSetOfNullableDecimalsWithScaleOf9): OneSetOfNullableDecimalsWithScaleOf9_6 = {
  ...
  com.dslplatform.api.Guards.checkCollectionOptionRefNulls(oneSetOfNullableDecimalsWithScaleOf9)
    new OneSetOfNullableDecimalsWithScaleOf9_6(_URI = this.URI, __locator = this.__locator, _ID = _ID, _oneSetOfNullableDecimalsWithScaleOf9 = oneSetOfNullableDecimalsWithScaleOf9)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneSetOfNullableDecimalsWithScaleOf9_6): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneSetOfNullableDecimalsWithScaleOf9_6](URI), duration)
  }
...
object OneSetOfNullableDecimalsWithScaleOf9_6 extends AggregateRootCompanion[OneSetOfNullableDecimalsWithScaleOf9_6]{
