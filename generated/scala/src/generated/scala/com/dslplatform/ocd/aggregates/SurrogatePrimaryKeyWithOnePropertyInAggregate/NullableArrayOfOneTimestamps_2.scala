...
class NullableArrayOfOneTimestamps_2 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableArrayOfOneTimestamps_2 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableArrayOfOneTimestamps_2("+ URI +")"

   def copy(nullableArrayOfOneTimestamps: Option[Array[org.joda.time.DateTime]] = this._nullableArrayOfOneTimestamps): NullableArrayOfOneTimestamps_2 = {
  ...
  com.dslplatform.api.Guards.checkArrayNulls(nullableArrayOfOneTimestamps)
    new NullableArrayOfOneTimestamps_2(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableArrayOfOneTimestamps = nullableArrayOfOneTimestamps)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.aggregates.SurrogatePrimaryKeyWithOnePropertyInAggregate.NullableArrayOfOneTimestamps_2): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.aggregates.SurrogatePrimaryKeyWithOnePropertyInAggregate.NullableArrayOfOneTimestamps_2](URI), duration)
  }

  @com.fasterxml.jackson.annotation.JsonGetter("nullableArrayOfOneTimestamps")
...
object NullableArrayOfOneTimestamps_2 extends AggregateRootCompanion[NullableArrayOfOneTimestamps_2]{
  ...
  def apply(
    ...
    require(nullableArrayOfOneTimestamps ne null, "Null value was provided for property \"nullableArrayOfOneTimestamps\"")
    if (nullableArrayOfOneTimestamps.isDefined) require(nullableArrayOfOneTimestamps.get ne null, "Null value was provided for property \"nullableArrayOfOneTimestamps\"")
    new NullableArrayOfOneTimestamps_2(
      __locator = None
