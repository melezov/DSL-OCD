...
class NullableArrayOfOneLocations_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableArrayOfOneLocations_5 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableArrayOfOneLocations_5("+ URI +")"

   def copy(nullableArrayOfOneLocations: Option[Array[java.awt.geom.Point2D]] = this._nullableArrayOfOneLocations): NullableArrayOfOneLocations_5 = {
  ...
  com.dslplatform.api.Guards.checkArrayNulls(nullableArrayOfOneLocations)
    new NullableArrayOfOneLocations_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableArrayOfOneLocations = nullableArrayOfOneLocations)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableArrayOfOneLocations_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableArrayOfOneLocations_5](URI), duration)
  }
...
object NullableArrayOfOneLocations_5 extends AggregateRootCompanion[NullableArrayOfOneLocations_5]{
  ...
  def apply(
    ...
    require(nullableArrayOfOneLocations ne null, "Null value was provided for property \"nullableArrayOfOneLocations\"")
    if (nullableArrayOfOneLocations.isDefined) require(nullableArrayOfOneLocations.get ne null, "Null value was provided for property \"nullableArrayOfOneLocations\"")
    new NullableArrayOfOneLocations_5(
      __locator = None
