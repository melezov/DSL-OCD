...
public final class OneSetOfOneMapsValue1 implements java.io.Serializable {
    public OneSetOfOneMapsValue1(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1780008022;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneSetOfOneMapsValue1)) return false;
        final OneSetOfOneMapsValue1 other = (OneSetOfOneMapsValue1) obj;
    ...
    public String toString() {
        return "OneSetOfOneMapsValue1(" + oneSetOfOneMaps + ')';
    }
    ...
    public OneSetOfOneMapsValue1 setOneSetOfOneMaps(
