...
public final class NullableArrayOfNullableTimestampsValue3 implements
        java.io.Serializable {
    public NullableArrayOfNullableTimestampsValue3(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1572030197;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof NullableArrayOfNullableTimestampsValue3))
            return false;
        final NullableArrayOfNullableTimestampsValue3 other = (NullableArrayOfNullableTimestampsValue3) obj;
    ...
    public String toString() {
        return "NullableArrayOfNullableTimestampsValue3("
    ...
    public NullableArrayOfNullableTimestampsValue3 setNullableArrayOfNullableTimestamps(
