...
public final class OneSetOfOneIntegersValue2 implements java.io.Serializable {
    public OneSetOfOneIntegersValue2(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1053006637;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneSetOfOneIntegersValue2)) return false;
        final OneSetOfOneIntegersValue2 other = (OneSetOfOneIntegersValue2) obj;
    ...
    public String toString() {
        return "OneSetOfOneIntegersValue2(" + oneSetOfOneIntegers + ')';
    }
    ...
    public OneSetOfOneIntegersValue2 setOneSetOfOneIntegers(
