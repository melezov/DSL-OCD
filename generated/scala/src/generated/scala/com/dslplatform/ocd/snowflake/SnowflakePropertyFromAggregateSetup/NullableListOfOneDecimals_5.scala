...
class NullableListOfOneDecimals_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableListOfOneDecimals_5 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableListOfOneDecimals_5("+ URI +")"

   def copy(nullableListOfOneDecimals: Option[IndexedSeq[BigDecimal]] = this._nullableListOfOneDecimals): NullableListOfOneDecimals_5 = {
  ...
  com.dslplatform.api.Guards.checkCollectionNulls(nullableListOfOneDecimals)
    new NullableListOfOneDecimals_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableListOfOneDecimals = nullableListOfOneDecimals)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableListOfOneDecimals_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableListOfOneDecimals_5](URI), duration)
  }
...
object NullableListOfOneDecimals_5 extends AggregateRootCompanion[NullableListOfOneDecimals_5]{
  ...
  def apply(
    ...
    require(nullableListOfOneDecimals ne null, "Null value was provided for property \"nullableListOfOneDecimals\"")
    if (nullableListOfOneDecimals.isDefined) require(nullableListOfOneDecimals.get ne null, "Null value was provided for property \"nullableListOfOneDecimals\"")
    new NullableListOfOneDecimals_5(
      __locator = None
