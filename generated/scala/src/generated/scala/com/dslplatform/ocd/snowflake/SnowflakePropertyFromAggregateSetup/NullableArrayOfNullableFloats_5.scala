...
class NullableArrayOfNullableFloats_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableArrayOfNullableFloats_5 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableArrayOfNullableFloats_5("+ URI +")"

   def copy(nullableArrayOfNullableFloats: Option[Array[Option[Float]]] = this._nullableArrayOfNullableFloats): NullableArrayOfNullableFloats_5 = {
  ...
  com.dslplatform.api.Guards.checkArrayOptionValNulls(nullableArrayOfNullableFloats)
    new NullableArrayOfNullableFloats_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableArrayOfNullableFloats = nullableArrayOfNullableFloats)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableArrayOfNullableFloats_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableArrayOfNullableFloats_5](URI), duration)
  }
...
object NullableArrayOfNullableFloats_5 extends AggregateRootCompanion[NullableArrayOfNullableFloats_5]{
  ...
  def apply(
    ...
    require(nullableArrayOfNullableFloats ne null, "Null value was provided for property \"nullableArrayOfNullableFloats\"")
    if (nullableArrayOfNullableFloats.isDefined) require(nullableArrayOfNullableFloats.get ne null, "Null value was provided for property \"nullableArrayOfNullableFloats\"")
    new NullableArrayOfNullableFloats_5(
      __locator = None
