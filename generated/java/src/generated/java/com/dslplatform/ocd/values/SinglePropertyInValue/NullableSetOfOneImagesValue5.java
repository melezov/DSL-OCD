...
public final class NullableSetOfOneImagesValue5 implements java.io.Serializable {
    public NullableSetOfOneImagesValue5(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1179549574;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof NullableSetOfOneImagesValue5)) return false;
        final NullableSetOfOneImagesValue5 other = (NullableSetOfOneImagesValue5) obj;
    ...
    public String toString() {
        return "NullableSetOfOneImagesValue5(" + nullableSetOfOneImages + ')';
    }
    ...
    public NullableSetOfOneImagesValue5 setNullableSetOfOneImages(
