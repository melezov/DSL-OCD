...
class NullableSetOfNullableMonies_2 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableSetOfNullableMonies_2 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableSetOfNullableMonies_2("+ URI +")"

   def copy(nullableSetOfNullableMonies: Option[Set[Option[BigDecimal]]] = this._nullableSetOfNullableMonies): NullableSetOfNullableMonies_2 = {
  ...
  com.dslplatform.api.Guards.checkCollectionOptionRefNulls(nullableSetOfNullableMonies)
    new NullableSetOfNullableMonies_2(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableSetOfNullableMonies = nullableSetOfNullableMonies)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.aggregates.SurrogatePrimaryKeyWithOnePropertyInAggregate.NullableSetOfNullableMonies_2): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.aggregates.SurrogatePrimaryKeyWithOnePropertyInAggregate.NullableSetOfNullableMonies_2](URI), duration)
  }

  @com.fasterxml.jackson.annotation.JsonGetter("nullableSetOfNullableMonies")
...
object NullableSetOfNullableMonies_2 extends AggregateRootCompanion[NullableSetOfNullableMonies_2]{
  ...
  def apply(
    ...
    require(nullableSetOfNullableMonies ne null, "Null value was provided for property \"nullableSetOfNullableMonies\"")
    if (nullableSetOfNullableMonies.isDefined) require(nullableSetOfNullableMonies.get ne null, "Null value was provided for property \"nullableSetOfNullableMonies\"")
    new NullableSetOfNullableMonies_2(
      __locator = None
