...
class OneListOfNullableStrings_6 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: OneListOfNullableStrings_6 => c.URI == URI
    case _ => false
  }

  override def toString = "OneListOfNullableStrings_6("+ URI +")"

   def copy(oneListOfNullableStrings: IndexedSeq[Option[String]] = this._oneListOfNullableStrings): OneListOfNullableStrings_6 = {
  ...
  com.dslplatform.api.Guards.checkCollectionOptionRefNulls(oneListOfNullableStrings)
    new OneListOfNullableStrings_6(_URI = this.URI, __locator = this.__locator, _ID = _ID, _oneListOfNullableStrings = oneListOfNullableStrings)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneListOfNullableStrings_6): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneListOfNullableStrings_6](URI), duration)
  }
...
object OneListOfNullableStrings_6 extends AggregateRootCompanion[OneListOfNullableStrings_6]{
  ...
  def apply(
    ...
    com.dslplatform.api.Guards.checkCollectionOptionRefNulls(oneListOfNullableStrings)
    require(oneListOfNullableStrings ne null, "Null value was provided for property \"oneListOfNullableStrings\"")
    new OneListOfNullableStrings_6(
      __locator = None
