...
public final class OneArrayOfOneIntegersValue7 implements java.io.Serializable {
    public OneArrayOfOneIntegersValue7(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1196467555;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfOneIntegersValue7)) return false;
        final OneArrayOfOneIntegersValue7 other = (OneArrayOfOneIntegersValue7) obj;
    ...
    public String toString() {
        return "OneArrayOfOneIntegersValue7(" + oneArrayOfOneIntegers + ')';
    }
    ...
    public OneArrayOfOneIntegersValue7 setOneArrayOfOneIntegers(
            final int[] value) {
        if (value == null)
