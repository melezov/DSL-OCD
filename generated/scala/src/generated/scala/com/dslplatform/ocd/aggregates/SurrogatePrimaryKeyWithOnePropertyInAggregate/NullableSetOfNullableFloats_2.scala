...
class NullableSetOfNullableFloats_2 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableSetOfNullableFloats_2 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableSetOfNullableFloats_2("+ URI +")"

   def copy(nullableSetOfNullableFloats: Option[Set[Option[Float]]] = this._nullableSetOfNullableFloats): NullableSetOfNullableFloats_2 = {
  ...
  com.dslplatform.api.Guards.checkCollectionOptionValNulls(nullableSetOfNullableFloats)
    new NullableSetOfNullableFloats_2(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableSetOfNullableFloats = nullableSetOfNullableFloats)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.aggregates.SurrogatePrimaryKeyWithOnePropertyInAggregate.NullableSetOfNullableFloats_2): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.aggregates.SurrogatePrimaryKeyWithOnePropertyInAggregate.NullableSetOfNullableFloats_2](URI), duration)
  }

  @com.fasterxml.jackson.annotation.JsonGetter("nullableSetOfNullableFloats")
...
object NullableSetOfNullableFloats_2 extends AggregateRootCompanion[NullableSetOfNullableFloats_2]{
  ...
  def apply(
    ...
    require(nullableSetOfNullableFloats ne null, "Null value was provided for property \"nullableSetOfNullableFloats\"")
    if (nullableSetOfNullableFloats.isDefined) require(nullableSetOfNullableFloats.get ne null, "Null value was provided for property \"nullableSetOfNullableFloats\"")
    new NullableSetOfNullableFloats_2(
      __locator = None
