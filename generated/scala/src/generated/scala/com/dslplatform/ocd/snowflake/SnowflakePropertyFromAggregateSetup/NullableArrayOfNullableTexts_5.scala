...
class NullableArrayOfNullableTexts_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableArrayOfNullableTexts_5 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableArrayOfNullableTexts_5("+ URI +")"

   def copy(nullableArrayOfNullableTexts: Option[Array[Option[String]]] = this._nullableArrayOfNullableTexts): NullableArrayOfNullableTexts_5 = {
  ...
  com.dslplatform.api.Guards.checkArrayOptionRefNulls(nullableArrayOfNullableTexts)
    new NullableArrayOfNullableTexts_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableArrayOfNullableTexts = nullableArrayOfNullableTexts)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableArrayOfNullableTexts_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableArrayOfNullableTexts_5](URI), duration)
  }
...
object NullableArrayOfNullableTexts_5 extends AggregateRootCompanion[NullableArrayOfNullableTexts_5]{
  ...
  def apply(
    ...
    require(nullableArrayOfNullableTexts ne null, "Null value was provided for property \"nullableArrayOfNullableTexts\"")
    if (nullableArrayOfNullableTexts.isDefined) require(nullableArrayOfNullableTexts.get ne null, "Null value was provided for property \"nullableArrayOfNullableTexts\"")
    new NullableArrayOfNullableTexts_5(
      __locator = None
