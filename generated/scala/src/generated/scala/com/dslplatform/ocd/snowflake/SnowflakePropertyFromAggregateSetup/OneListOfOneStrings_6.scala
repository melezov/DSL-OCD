...
class OneListOfOneStrings_6 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: OneListOfOneStrings_6 => c.URI == URI
    case _ => false
  }

  override def toString = "OneListOfOneStrings_6("+ URI +")"

   def copy(oneListOfOneStrings: IndexedSeq[String] = this._oneListOfOneStrings): OneListOfOneStrings_6 = {
  ...
  com.dslplatform.api.Guards.checkCollectionNulls(oneListOfOneStrings)
    new OneListOfOneStrings_6(_URI = this.URI, __locator = this.__locator, _ID = _ID, _oneListOfOneStrings = oneListOfOneStrings)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneListOfOneStrings_6): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneListOfOneStrings_6](URI), duration)
  }
...
object OneListOfOneStrings_6 extends AggregateRootCompanion[OneListOfOneStrings_6]{
