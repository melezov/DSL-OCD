...
class NullableSetOfNullableTimestamps_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableSetOfNullableTimestamps_5 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableSetOfNullableTimestamps_5("+ URI +")"

   def copy(nullableSetOfNullableTimestamps: Option[Set[Option[org.joda.time.DateTime]]] = this._nullableSetOfNullableTimestamps): NullableSetOfNullableTimestamps_5 = {
  ...
  com.dslplatform.api.Guards.checkCollectionOptionRefNulls(nullableSetOfNullableTimestamps)
    new NullableSetOfNullableTimestamps_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableSetOfNullableTimestamps = nullableSetOfNullableTimestamps)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableSetOfNullableTimestamps_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableSetOfNullableTimestamps_5](URI), duration)
  }
...
object NullableSetOfNullableTimestamps_5 extends AggregateRootCompanion[NullableSetOfNullableTimestamps_5]{
  ...
  def apply(
    ...
    require(nullableSetOfNullableTimestamps ne null, "Null value was provided for property \"nullableSetOfNullableTimestamps\"")
    if (nullableSetOfNullableTimestamps.isDefined) require(nullableSetOfNullableTimestamps.get ne null, "Null value was provided for property \"nullableSetOfNullableTimestamps\"")
    new NullableSetOfNullableTimestamps_5(
      __locator = None
