...
public final class NullableArrayOfOneMoniesValue2 implements
        java.io.Serializable {
    public NullableArrayOfOneMoniesValue2(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1533743783;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof NullableArrayOfOneMoniesValue2)) return false;
        final NullableArrayOfOneMoniesValue2 other = (NullableArrayOfOneMoniesValue2) obj;
    ...
    public String toString() {
        return "NullableArrayOfOneMoniesValue2(" + nullableArrayOfOneMonies
                + ')';
    }
    ...
    public NullableArrayOfOneMoniesValue2 setNullableArrayOfOneMonies(
