...
public final class OneListOfNullableTimestampsValue5 implements
        java.io.Serializable {
    public OneListOfNullableTimestampsValue5(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1614442461;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneListOfNullableTimestampsValue5)) return false;
        final OneListOfNullableTimestampsValue5 other = (OneListOfNullableTimestampsValue5) obj;
    ...
    public String toString() {
        return "OneListOfNullableTimestampsValue5("
    ...
    public OneListOfNullableTimestampsValue5 setOneListOfNullableTimestamps(
