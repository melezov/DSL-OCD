...
class NullableSetOfOneBooleans_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableSetOfOneBooleans_5 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableSetOfOneBooleans_5("+ URI +")"

   def copy(nullableSetOfOneBooleans: Option[Set[Boolean]] = this._nullableSetOfOneBooleans): NullableSetOfOneBooleans_5 = {
  ...
  if(nullableSetOfOneBooleans.isDefined) require(nullableSetOfOneBooleans.get ne null, "Null value was provided for property \"nullableSetOfOneBooleans\"")
    new NullableSetOfOneBooleans_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableSetOfOneBooleans = nullableSetOfOneBooleans)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableSetOfOneBooleans_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableSetOfOneBooleans_5](URI), duration)
  }
...
object NullableSetOfOneBooleans_5 extends AggregateRootCompanion[NullableSetOfOneBooleans_5]{
  ...
  def apply(
    ...
    require(nullableSetOfOneBooleans ne null, "Null value was provided for property \"nullableSetOfOneBooleans\"")
    if (nullableSetOfOneBooleans.isDefined) require(nullableSetOfOneBooleans.get ne null, "Null value was provided for property \"nullableSetOfOneBooleans\"")
    new NullableSetOfOneBooleans_5(
      __locator = None
