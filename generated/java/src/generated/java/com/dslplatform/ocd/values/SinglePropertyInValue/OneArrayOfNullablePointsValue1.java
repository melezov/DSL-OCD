...
public final class OneArrayOfNullablePointsValue1 implements
        java.io.Serializable {
    public OneArrayOfNullablePointsValue1(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1723891636;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfNullablePointsValue1)) return false;
        final OneArrayOfNullablePointsValue1 other = (OneArrayOfNullablePointsValue1) obj;
    ...
    public String toString() {
        return "OneArrayOfNullablePointsValue1(" + oneArrayOfNullablePoints
                + ')';
    }
    ...
    public OneArrayOfNullablePointsValue1 setOneArrayOfNullablePoints(
