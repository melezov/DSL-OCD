...
class OneListOfOneGuids_6 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: OneListOfOneGuids_6 => c.URI == URI
    case _ => false
  }

  override def toString = "OneListOfOneGuids_6("+ URI +")"

   def copy(oneListOfOneGuids: IndexedSeq[java.util.UUID] = this._oneListOfOneGuids): OneListOfOneGuids_6 = {
  ...
  com.dslplatform.api.Guards.checkCollectionNulls(oneListOfOneGuids)
    new OneListOfOneGuids_6(_URI = this.URI, __locator = this.__locator, _ID = _ID, _oneListOfOneGuids = oneListOfOneGuids)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneListOfOneGuids_6): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneListOfOneGuids_6](URI), duration)
  }
...
object OneListOfOneGuids_6 extends AggregateRootCompanion[OneListOfOneGuids_6]{
