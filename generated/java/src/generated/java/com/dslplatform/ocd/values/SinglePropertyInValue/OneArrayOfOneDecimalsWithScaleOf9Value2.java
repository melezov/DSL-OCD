...
public final class OneArrayOfOneDecimalsWithScaleOf9Value2 implements
        java.io.Serializable {
    public OneArrayOfOneDecimalsWithScaleOf9Value2(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1321286563;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfOneDecimalsWithScaleOf9Value2))
            return false;
        final OneArrayOfOneDecimalsWithScaleOf9Value2 other = (OneArrayOfOneDecimalsWithScaleOf9Value2) obj;
    ...
    public String toString() {
        return "OneArrayOfOneDecimalsWithScaleOf9Value2("
    ...
    public OneArrayOfOneDecimalsWithScaleOf9Value2 setOneArrayOfOneDecimalsWithScaleOf9(
