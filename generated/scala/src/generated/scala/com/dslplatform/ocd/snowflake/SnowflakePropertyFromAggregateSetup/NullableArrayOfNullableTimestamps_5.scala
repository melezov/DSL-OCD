...
class NullableArrayOfNullableTimestamps_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableArrayOfNullableTimestamps_5 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableArrayOfNullableTimestamps_5("+ URI +")"

   def copy(nullableArrayOfNullableTimestamps: Option[Array[Option[org.joda.time.DateTime]]] = this._nullableArrayOfNullableTimestamps): NullableArrayOfNullableTimestamps_5 = {
  ...
  com.dslplatform.api.Guards.checkArrayOptionRefNulls(nullableArrayOfNullableTimestamps)
    new NullableArrayOfNullableTimestamps_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableArrayOfNullableTimestamps = nullableArrayOfNullableTimestamps)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableArrayOfNullableTimestamps_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableArrayOfNullableTimestamps_5](URI), duration)
  }
...
object NullableArrayOfNullableTimestamps_5 extends AggregateRootCompanion[NullableArrayOfNullableTimestamps_5]{
  ...
  def apply(
    ...
    require(nullableArrayOfNullableTimestamps ne null, "Null value was provided for property \"nullableArrayOfNullableTimestamps\"")
    if (nullableArrayOfNullableTimestamps.isDefined) require(nullableArrayOfNullableTimestamps.get ne null, "Null value was provided for property \"nullableArrayOfNullableTimestamps\"")
    new NullableArrayOfNullableTimestamps_5(
      __locator = None
