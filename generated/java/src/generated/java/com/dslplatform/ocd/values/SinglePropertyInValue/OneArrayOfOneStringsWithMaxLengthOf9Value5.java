...
public final class OneArrayOfOneStringsWithMaxLengthOf9Value5 implements
        java.io.Serializable {
    public OneArrayOfOneStringsWithMaxLengthOf9Value5(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1966831958;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfOneStringsWithMaxLengthOf9Value5))
            return false;
        final OneArrayOfOneStringsWithMaxLengthOf9Value5 other = (OneArrayOfOneStringsWithMaxLengthOf9Value5) obj;
    ...
    public String toString() {
        return "OneArrayOfOneStringsWithMaxLengthOf9Value5("
    ...
    public OneArrayOfOneStringsWithMaxLengthOf9Value5 setOneArrayOfOneStringsWithMaxLengthOf9(
            final String[] value) {
        if (value == null)
