...
class OneListOfNullableUrls_6 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: OneListOfNullableUrls_6 => c.URI == URI
    case _ => false
  }

  override def toString = "OneListOfNullableUrls_6("+ URI +")"

   def copy(oneListOfNullableUrls: IndexedSeq[Option[java.net.URI]] = this._oneListOfNullableUrls): OneListOfNullableUrls_6 = {
  ...
  com.dslplatform.api.Guards.checkCollectionOptionRefNulls(oneListOfNullableUrls)
    new OneListOfNullableUrls_6(_URI = this.URI, __locator = this.__locator, _ID = _ID, _oneListOfNullableUrls = oneListOfNullableUrls)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneListOfNullableUrls_6): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneListOfNullableUrls_6](URI), duration)
  }
...
object OneListOfNullableUrls_6 extends AggregateRootCompanion[OneListOfNullableUrls_6]{
