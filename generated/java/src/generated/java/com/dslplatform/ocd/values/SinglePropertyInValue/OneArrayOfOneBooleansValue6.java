...
public final class OneArrayOfOneBooleansValue6 implements java.io.Serializable {
    public OneArrayOfOneBooleansValue6(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 2015824282;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfOneBooleansValue6)) return false;
        final OneArrayOfOneBooleansValue6 other = (OneArrayOfOneBooleansValue6) obj;
    ...
    public String toString() {
        return "OneArrayOfOneBooleansValue6(" + oneArrayOfOneBooleans + ')';
    }
    ...
    public OneArrayOfOneBooleansValue6 setOneArrayOfOneBooleans(
            final boolean[] value) {
        if (value == null)
