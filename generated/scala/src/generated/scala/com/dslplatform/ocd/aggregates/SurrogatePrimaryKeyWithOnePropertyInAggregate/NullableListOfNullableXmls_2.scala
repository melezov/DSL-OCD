...
class NullableListOfNullableXmls_2 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableListOfNullableXmls_2 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableListOfNullableXmls_2("+ URI +")"

   def copy(nullableListOfNullableXmls: Option[IndexedSeq[Option[scala.xml.Elem]]] = this._nullableListOfNullableXmls): NullableListOfNullableXmls_2 = {
  ...
  com.dslplatform.api.Guards.checkCollectionOptionRefNulls(nullableListOfNullableXmls)
    new NullableListOfNullableXmls_2(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableListOfNullableXmls = nullableListOfNullableXmls)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.aggregates.SurrogatePrimaryKeyWithOnePropertyInAggregate.NullableListOfNullableXmls_2): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.aggregates.SurrogatePrimaryKeyWithOnePropertyInAggregate.NullableListOfNullableXmls_2](URI), duration)
  }

  @com.fasterxml.jackson.annotation.JsonGetter("nullableListOfNullableXmls")
...
object NullableListOfNullableXmls_2 extends AggregateRootCompanion[NullableListOfNullableXmls_2]{
  ...
  def apply(
    ...
    require(nullableListOfNullableXmls ne null, "Null value was provided for property \"nullableListOfNullableXmls\"")
    if (nullableListOfNullableXmls.isDefined) require(nullableListOfNullableXmls.get ne null, "Null value was provided for property \"nullableListOfNullableXmls\"")
    new NullableListOfNullableXmls_2(
      __locator = None
