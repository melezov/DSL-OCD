...
class NullableSetOfOneMonies_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableSetOfOneMonies_5 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableSetOfOneMonies_5("+ URI +")"

   def copy(nullableSetOfOneMonies: Option[Set[BigDecimal]] = this._nullableSetOfOneMonies): NullableSetOfOneMonies_5 = {
  ...
  com.dslplatform.api.Guards.checkCollectionNulls(nullableSetOfOneMonies)
    new NullableSetOfOneMonies_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableSetOfOneMonies = nullableSetOfOneMonies)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableSetOfOneMonies_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableSetOfOneMonies_5](URI), duration)
  }
...
object NullableSetOfOneMonies_5 extends AggregateRootCompanion[NullableSetOfOneMonies_5]{
