...
class OneListOfNullableMaps_6 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: OneListOfNullableMaps_6 => c.URI == URI
    case _ => false
  }

  override def toString = "OneListOfNullableMaps_6("+ URI +")"

   def copy(oneListOfNullableMaps: IndexedSeq[Option[Map[String, String]]] = this._oneListOfNullableMaps): OneListOfNullableMaps_6 = {
  ...
  com.dslplatform.api.Guards.checkCollectionOptionRefNulls(oneListOfNullableMaps)
    new OneListOfNullableMaps_6(_URI = this.URI, __locator = this.__locator, _ID = _ID, _oneListOfNullableMaps = oneListOfNullableMaps)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneListOfNullableMaps_6): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneListOfNullableMaps_6](URI), duration)
  }
...
object OneListOfNullableMaps_6 extends AggregateRootCompanion[OneListOfNullableMaps_6]{
