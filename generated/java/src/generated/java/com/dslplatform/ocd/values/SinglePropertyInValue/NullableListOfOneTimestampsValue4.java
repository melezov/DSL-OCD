...
public final class NullableListOfOneTimestampsValue4 implements
        java.io.Serializable {
    public NullableListOfOneTimestampsValue4(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1032046712;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof NullableListOfOneTimestampsValue4)) return false;
        final NullableListOfOneTimestampsValue4 other = (NullableListOfOneTimestampsValue4) obj;
    ...
    public String toString() {
        return "NullableListOfOneTimestampsValue4("
    ...
    public NullableListOfOneTimestampsValue4 setNullableListOfOneTimestamps(
