...
class OneListOfNullableIps_6 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: OneListOfNullableIps_6 => c.URI == URI
    case _ => false
  }

  override def toString = "OneListOfNullableIps_6("+ URI +")"

   def copy(oneListOfNullableIps: IndexedSeq[Option[java.net.InetAddress]] = this._oneListOfNullableIps): OneListOfNullableIps_6 = {
  ...
  com.dslplatform.api.Guards.checkCollectionOptionRefNulls(oneListOfNullableIps)
    new OneListOfNullableIps_6(_URI = this.URI, __locator = this.__locator, _ID = _ID, _oneListOfNullableIps = oneListOfNullableIps)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneListOfNullableIps_6): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneListOfNullableIps_6](URI), duration)
  }
...
object OneListOfNullableIps_6 extends AggregateRootCompanion[OneListOfNullableIps_6]{
