...
public final class NullableArrayOfNullableIntegersValue5 implements
        java.io.Serializable {
    public NullableArrayOfNullableIntegersValue5(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 2038773505;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof NullableArrayOfNullableIntegersValue5))
            return false;
        final NullableArrayOfNullableIntegersValue5 other = (NullableArrayOfNullableIntegersValue5) obj;
    ...
    public String toString() {
        return "NullableArrayOfNullableIntegersValue5("
    ...
    public NullableArrayOfNullableIntegersValue5 setNullableArrayOfNullableIntegers(
            final Integer[] value) {
