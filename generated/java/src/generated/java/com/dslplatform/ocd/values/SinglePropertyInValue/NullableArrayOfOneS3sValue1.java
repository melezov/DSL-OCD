...
public final class NullableArrayOfOneS3sValue1 implements java.io.Serializable {
    public NullableArrayOfOneS3sValue1(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 2085385682;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof NullableArrayOfOneS3sValue1)) return false;
        final NullableArrayOfOneS3sValue1 other = (NullableArrayOfOneS3sValue1) obj;
    ...
    public String toString() {
        return "NullableArrayOfOneS3sValue1(" + nullableArrayOfOneS3s + ')';
    }
    ...
    public NullableArrayOfOneS3sValue1 setNullableArrayOfOneS3s(
