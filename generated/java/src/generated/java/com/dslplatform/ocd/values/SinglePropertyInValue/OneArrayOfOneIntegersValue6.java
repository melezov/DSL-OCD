...
public final class OneArrayOfOneIntegersValue6 implements java.io.Serializable {
    public OneArrayOfOneIntegersValue6(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1196467556;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfOneIntegersValue6)) return false;
        final OneArrayOfOneIntegersValue6 other = (OneArrayOfOneIntegersValue6) obj;
    ...
    public String toString() {
        return "OneArrayOfOneIntegersValue6(" + oneArrayOfOneIntegers + ')';
    }
    ...
    public OneArrayOfOneIntegersValue6 setOneArrayOfOneIntegers(
            final int[] value) {
        if (value == null)
