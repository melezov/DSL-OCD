...
class NullableSetOfOneDates_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableSetOfOneDates_5 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableSetOfOneDates_5("+ URI +")"

   def copy(nullableSetOfOneDates: Option[Set[org.joda.time.LocalDate]] = this._nullableSetOfOneDates): NullableSetOfOneDates_5 = {
  ...
  com.dslplatform.api.Guards.checkCollectionNulls(nullableSetOfOneDates)
    new NullableSetOfOneDates_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableSetOfOneDates = nullableSetOfOneDates)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableSetOfOneDates_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableSetOfOneDates_5](URI), duration)
  }
...
object NullableSetOfOneDates_5 extends AggregateRootCompanion[NullableSetOfOneDates_5]{
