...
public final class NullableArrayOfOneStringsWithMaxLengthOf9Value4 implements
        java.io.Serializable {
    public NullableArrayOfOneStringsWithMaxLengthOf9Value4(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1378079538;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof NullableArrayOfOneStringsWithMaxLengthOf9Value4))
            return false;
        final NullableArrayOfOneStringsWithMaxLengthOf9Value4 other = (NullableArrayOfOneStringsWithMaxLengthOf9Value4) obj;
    ...
    public String toString() {
        return "NullableArrayOfOneStringsWithMaxLengthOf9Value4("
    ...
    public NullableArrayOfOneStringsWithMaxLengthOf9Value4 setNullableArrayOfOneStringsWithMaxLengthOf9(
            final String[] value) {
