...
public final class OneArrayOfOneTextsValue4 implements java.io.Serializable {
    public OneArrayOfOneTextsValue4(
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfOneTextsValue4)) return false;
        final OneArrayOfOneTextsValue4 other = (OneArrayOfOneTextsValue4) obj;
    ...
    public String toString() {
        return "OneArrayOfOneTextsValue4(" + oneArrayOfOneTexts + ')';
    }
    ...
    public OneArrayOfOneTextsValue4 setOneArrayOfOneTexts(final String[] value) {
        if (value == null)
