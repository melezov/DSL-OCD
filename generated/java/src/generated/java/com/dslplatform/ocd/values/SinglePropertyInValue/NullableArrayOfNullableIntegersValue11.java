...
public final class NullableArrayOfNullableIntegersValue11 implements
        java.io.Serializable {
    public NullableArrayOfNullableIntegersValue11(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1941346822;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof NullableArrayOfNullableIntegersValue11))
            return false;
        final NullableArrayOfNullableIntegersValue11 other = (NullableArrayOfNullableIntegersValue11) obj;
    ...
    public String toString() {
        return "NullableArrayOfNullableIntegersValue11("
    ...
    public NullableArrayOfNullableIntegersValue11 setNullableArrayOfNullableIntegers(
            final Integer[] value) {
