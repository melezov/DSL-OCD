...
class OneSetOfNullableStringsWithMaxLengthOf9_6 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: OneSetOfNullableStringsWithMaxLengthOf9_6 => c.URI == URI
    case _ => false
  }

  override def toString = "OneSetOfNullableStringsWithMaxLengthOf9_6("+ URI +")"

   def copy(oneSetOfNullableStringsWithMaxLengthOf9: Set[Option[String]] = this._oneSetOfNullableStringsWithMaxLengthOf9): OneSetOfNullableStringsWithMaxLengthOf9_6 = {
  ...
  com.dslplatform.api.Guards.checkCollectionOptionRefNulls(oneSetOfNullableStringsWithMaxLengthOf9)
    new OneSetOfNullableStringsWithMaxLengthOf9_6(_URI = this.URI, __locator = this.__locator, _ID = _ID, _oneSetOfNullableStringsWithMaxLengthOf9 = oneSetOfNullableStringsWithMaxLengthOf9)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneSetOfNullableStringsWithMaxLengthOf9_6): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneSetOfNullableStringsWithMaxLengthOf9_6](URI), duration)
  }
...
object OneSetOfNullableStringsWithMaxLengthOf9_6 extends AggregateRootCompanion[OneSetOfNullableStringsWithMaxLengthOf9_6]{
