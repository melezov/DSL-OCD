...
class NullableListOfNullableRectangles_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableListOfNullableRectangles_5 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableListOfNullableRectangles_5("+ URI +")"

   def copy(nullableListOfNullableRectangles: Option[IndexedSeq[Option[java.awt.geom.Rectangle2D]]] = this._nullableListOfNullableRectangles): NullableListOfNullableRectangles_5 = {
  ...
  com.dslplatform.api.Guards.checkCollectionOptionRefNulls(nullableListOfNullableRectangles)
    new NullableListOfNullableRectangles_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableListOfNullableRectangles = nullableListOfNullableRectangles)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableListOfNullableRectangles_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableListOfNullableRectangles_5](URI), duration)
  }
...
object NullableListOfNullableRectangles_5 extends AggregateRootCompanion[NullableListOfNullableRectangles_5]{
  ...
  def apply(
    ...
    require(nullableListOfNullableRectangles ne null, "Null value was provided for property \"nullableListOfNullableRectangles\"")
    if (nullableListOfNullableRectangles.isDefined) require(nullableListOfNullableRectangles.get ne null, "Null value was provided for property \"nullableListOfNullableRectangles\"")
    new NullableListOfNullableRectangles_5(
      __locator = None
