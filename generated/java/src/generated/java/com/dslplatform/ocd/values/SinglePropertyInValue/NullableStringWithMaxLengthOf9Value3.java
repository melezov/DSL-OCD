...
public final class NullableStringWithMaxLengthOf9Value3 implements
        java.io.Serializable {
    public NullableStringWithMaxLengthOf9Value3(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1600964446;
        result = prime
                * result
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof NullableStringWithMaxLengthOf9Value3))
            return false;
        final NullableStringWithMaxLengthOf9Value3 other = (NullableStringWithMaxLengthOf9Value3) obj;
    ...
    public String toString() {
        return "NullableStringWithMaxLengthOf9Value3("
    ...
    public NullableStringWithMaxLengthOf9Value3 setNullableStringWithMaxLengthOf9(
            final String value) {
        if (value != null)
