...
public final class OneArrayOfNullableLocationsValue4 implements
        java.io.Serializable {
    public OneArrayOfNullableLocationsValue4(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1955477542;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfNullableLocationsValue4)) return false;
        final OneArrayOfNullableLocationsValue4 other = (OneArrayOfNullableLocationsValue4) obj;
    ...
    public String toString() {
        return "OneArrayOfNullableLocationsValue4("
    ...
    public OneArrayOfNullableLocationsValue4 setOneArrayOfNullableLocations(
