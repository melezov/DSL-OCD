...
class NullableSetOfOneRectangles_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableSetOfOneRectangles_5 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableSetOfOneRectangles_5("+ URI +")"

   def copy(nullableSetOfOneRectangles: Option[Set[java.awt.geom.Rectangle2D]] = this._nullableSetOfOneRectangles): NullableSetOfOneRectangles_5 = {
  ...
  com.dslplatform.api.Guards.checkCollectionNulls(nullableSetOfOneRectangles)
    new NullableSetOfOneRectangles_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableSetOfOneRectangles = nullableSetOfOneRectangles)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableSetOfOneRectangles_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableSetOfOneRectangles_5](URI), duration)
  }
...
object NullableSetOfOneRectangles_5 extends AggregateRootCompanion[NullableSetOfOneRectangles_5]{
  ...
  def apply(
    ...
    require(nullableSetOfOneRectangles ne null, "Null value was provided for property \"nullableSetOfOneRectangles\"")
    if (nullableSetOfOneRectangles.isDefined) require(nullableSetOfOneRectangles.get ne null, "Null value was provided for property \"nullableSetOfOneRectangles\"")
    new NullableSetOfOneRectangles_5(
      __locator = None
