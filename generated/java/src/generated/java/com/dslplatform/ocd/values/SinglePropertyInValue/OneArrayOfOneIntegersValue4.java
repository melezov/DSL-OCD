...
public final class OneArrayOfOneIntegersValue4 implements java.io.Serializable {
    public OneArrayOfOneIntegersValue4(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1196467558;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfOneIntegersValue4)) return false;
        final OneArrayOfOneIntegersValue4 other = (OneArrayOfOneIntegersValue4) obj;
    ...
    public String toString() {
        return "OneArrayOfOneIntegersValue4(" + oneArrayOfOneIntegers + ')';
    }
    ...
    public OneArrayOfOneIntegersValue4 setOneArrayOfOneIntegers(
            final int[] value) {
        if (value == null)
