...
case class NullableArrayOfOneLocations_4 @com.fasterxml.jackson.annotation.JsonIgnore() (
     nullableArrayOfOneLocations: Option[Array[java.awt.geom.Point2D]] = None,
     calculatedNullableArrayOfOneLocations: Option[Array[java.awt.geom.Point2D]] = None,
     persistedNullableArrayOfOneLocations: Option[Array[java.awt.geom.Point2D]] = None
  ) {
  ...
  , @com.fasterxml.jackson.annotation.JsonProperty("persistedNullableArrayOfOneLocations") persistedNullableArrayOfOneLocations: Option[Array[java.awt.geom.Point2D]]
    ...
    this( nullableArrayOfOneLocations = nullableArrayOfOneLocations, calculatedNullableArrayOfOneLocations = calculatedNullableArrayOfOneLocations, persistedNullableArrayOfOneLocations = persistedNullableArrayOfOneLocations)
