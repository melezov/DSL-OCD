...
class NullableListOfNullableDoubles_2 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableListOfNullableDoubles_2 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableListOfNullableDoubles_2("+ URI +")"

   def copy(nullableListOfNullableDoubles: Option[IndexedSeq[Option[Double]]] = this._nullableListOfNullableDoubles): NullableListOfNullableDoubles_2 = {
  ...
  com.dslplatform.api.Guards.checkCollectionOptionValNulls(nullableListOfNullableDoubles)
    new NullableListOfNullableDoubles_2(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableListOfNullableDoubles = nullableListOfNullableDoubles)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.aggregates.SurrogatePrimaryKeyWithOnePropertyInAggregate.NullableListOfNullableDoubles_2): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.aggregates.SurrogatePrimaryKeyWithOnePropertyInAggregate.NullableListOfNullableDoubles_2](URI), duration)
  }

  @com.fasterxml.jackson.annotation.JsonGetter("nullableListOfNullableDoubles")
...
object NullableListOfNullableDoubles_2 extends AggregateRootCompanion[NullableListOfNullableDoubles_2]{
  ...
  def apply(
    ...
    require(nullableListOfNullableDoubles ne null, "Null value was provided for property \"nullableListOfNullableDoubles\"")
    if (nullableListOfNullableDoubles.isDefined) require(nullableListOfNullableDoubles.get ne null, "Null value was provided for property \"nullableListOfNullableDoubles\"")
    new NullableListOfNullableDoubles_2(
      __locator = None
