...
public final class NullableArrayOfNullableImagesValue2 implements
        java.io.Serializable {
    public NullableArrayOfNullableImagesValue2(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 2023801865;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof NullableArrayOfNullableImagesValue2))
            return false;
        final NullableArrayOfNullableImagesValue2 other = (NullableArrayOfNullableImagesValue2) obj;
    ...
    public String toString() {
        return "NullableArrayOfNullableImagesValue2("
    ...
    public NullableArrayOfNullableImagesValue2 setNullableArrayOfNullableImages(
