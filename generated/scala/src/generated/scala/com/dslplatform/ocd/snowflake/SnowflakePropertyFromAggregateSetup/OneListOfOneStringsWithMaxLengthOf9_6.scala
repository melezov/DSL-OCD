...
class OneListOfOneStringsWithMaxLengthOf9_6 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: OneListOfOneStringsWithMaxLengthOf9_6 => c.URI == URI
    case _ => false
  }

  override def toString = "OneListOfOneStringsWithMaxLengthOf9_6("+ URI +")"

   def copy(oneListOfOneStringsWithMaxLengthOf9: IndexedSeq[String] = this._oneListOfOneStringsWithMaxLengthOf9): OneListOfOneStringsWithMaxLengthOf9_6 = {
  ...
  com.dslplatform.api.Guards.checkCollectionNulls(oneListOfOneStringsWithMaxLengthOf9)
    new OneListOfOneStringsWithMaxLengthOf9_6(_URI = this.URI, __locator = this.__locator, _ID = _ID, _oneListOfOneStringsWithMaxLengthOf9 = oneListOfOneStringsWithMaxLengthOf9)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneListOfOneStringsWithMaxLengthOf9_6): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneListOfOneStringsWithMaxLengthOf9_6](URI), duration)
  }
...
object OneListOfOneStringsWithMaxLengthOf9_6 extends AggregateRootCompanion[OneListOfOneStringsWithMaxLengthOf9_6]{
