...
public final class NullableArrayOfNullableTimestampsValue7 implements
        java.io.Serializable {
    public NullableArrayOfNullableTimestampsValue7(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1572030201;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof NullableArrayOfNullableTimestampsValue7))
            return false;
        final NullableArrayOfNullableTimestampsValue7 other = (NullableArrayOfNullableTimestampsValue7) obj;
    ...
    public String toString() {
        return "NullableArrayOfNullableTimestampsValue7("
    ...
    public NullableArrayOfNullableTimestampsValue7 setNullableArrayOfNullableTimestamps(
