...
public final class NullableArrayOfOneS3sValue4 implements java.io.Serializable {
    public NullableArrayOfOneS3sValue4(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 2085385677;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof NullableArrayOfOneS3sValue4)) return false;
        final NullableArrayOfOneS3sValue4 other = (NullableArrayOfOneS3sValue4) obj;
    ...
    public String toString() {
        return "NullableArrayOfOneS3sValue4(" + nullableArrayOfOneS3s + ')';
    }
    ...
    public NullableArrayOfOneS3sValue4 setNullableArrayOfOneS3s(
