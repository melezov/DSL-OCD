...
public final class OneArrayOfNullableRectanglesValue10 implements
        java.io.Serializable {
    public OneArrayOfNullableRectanglesValue10(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 2125647917;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfNullableRectanglesValue10))
            return false;
        final OneArrayOfNullableRectanglesValue10 other = (OneArrayOfNullableRectanglesValue10) obj;
    ...
    public String toString() {
        return "OneArrayOfNullableRectanglesValue10("
    ...
    public OneArrayOfNullableRectanglesValue10 setOneArrayOfNullableRectangles(
