...
public final class OneSetOfOneBooleansValue4 implements java.io.Serializable {
    public OneSetOfOneBooleansValue4(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1897938447;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneSetOfOneBooleansValue4)) return false;
        final OneSetOfOneBooleansValue4 other = (OneSetOfOneBooleansValue4) obj;
    ...
    public String toString() {
        return "OneSetOfOneBooleansValue4(" + oneSetOfOneBooleans + ')';
    }
    ...
    public OneSetOfOneBooleansValue4 setOneSetOfOneBooleans(
