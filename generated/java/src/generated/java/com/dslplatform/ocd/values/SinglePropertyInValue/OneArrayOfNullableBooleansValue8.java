...
public final class OneArrayOfNullableBooleansValue8 implements
        java.io.Serializable {
    public OneArrayOfNullableBooleansValue8(
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfNullableBooleansValue8)) return false;
        final OneArrayOfNullableBooleansValue8 other = (OneArrayOfNullableBooleansValue8) obj;
    ...
    public String toString() {
        return "OneArrayOfNullableBooleansValue8(" + oneArrayOfNullableBooleans
                + ')';
    }
    ...
    public OneArrayOfNullableBooleansValue8 setOneArrayOfNullableBooleans(
            final Boolean[] value) {
        if (value == null)
