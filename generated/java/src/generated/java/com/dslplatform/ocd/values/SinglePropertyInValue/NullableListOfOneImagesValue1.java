...
public final class NullableListOfOneImagesValue1 implements
        java.io.Serializable {
    public NullableListOfOneImagesValue1(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1894389304;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof NullableListOfOneImagesValue1)) return false;
        final NullableListOfOneImagesValue1 other = (NullableListOfOneImagesValue1) obj;
    ...
    public String toString() {
        return "NullableListOfOneImagesValue1(" + nullableListOfOneImages + ')';
    }
    ...
    public NullableListOfOneImagesValue1 setNullableListOfOneImages(
