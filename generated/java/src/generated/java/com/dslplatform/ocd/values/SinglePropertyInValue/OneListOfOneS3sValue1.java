...
public final class OneListOfOneS3sValue1 implements java.io.Serializable {
    public OneListOfOneS3sValue1(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1550739312;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneListOfOneS3sValue1)) return false;
        final OneListOfOneS3sValue1 other = (OneListOfOneS3sValue1) obj;
    ...
    public String toString() {
        return "OneListOfOneS3sValue1(" + oneListOfOneS3s + ')';
    }
    ...
    public OneListOfOneS3sValue1 setOneListOfOneS3s(
