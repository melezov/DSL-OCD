...
public final class OneArrayOfNullableMoniesValue6 implements
        java.io.Serializable {
    public OneArrayOfNullableMoniesValue6(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 2040735019;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfNullableMoniesValue6)) return false;
        final OneArrayOfNullableMoniesValue6 other = (OneArrayOfNullableMoniesValue6) obj;
    ...
    public String toString() {
        return "OneArrayOfNullableMoniesValue6(" + oneArrayOfNullableMonies
                + ')';
    }
    ...
    public OneArrayOfNullableMoniesValue6 setOneArrayOfNullableMonies(
