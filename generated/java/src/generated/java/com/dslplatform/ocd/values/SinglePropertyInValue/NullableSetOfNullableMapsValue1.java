...
public final class NullableSetOfNullableMapsValue1 implements
        java.io.Serializable {
    public NullableSetOfNullableMapsValue1(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1947013998;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof NullableSetOfNullableMapsValue1)) return false;
        final NullableSetOfNullableMapsValue1 other = (NullableSetOfNullableMapsValue1) obj;
    ...
    public String toString() {
        return "NullableSetOfNullableMapsValue1(" + nullableSetOfNullableMaps
                + ')';
    }
    ...
    public NullableSetOfNullableMapsValue1 setNullableSetOfNullableMaps(
