...
public final class NullableArrayOfNullableStringsWithMaxLengthOf9Value2
        implements java.io.Serializable {
    public NullableArrayOfNullableStringsWithMaxLengthOf9Value2(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1539302849;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof NullableArrayOfNullableStringsWithMaxLengthOf9Value2))
            return false;
        final NullableArrayOfNullableStringsWithMaxLengthOf9Value2 other = (NullableArrayOfNullableStringsWithMaxLengthOf9Value2) obj;
    ...
    public String toString() {
        return "NullableArrayOfNullableStringsWithMaxLengthOf9Value2("
    ...
    public NullableArrayOfNullableStringsWithMaxLengthOf9Value2 setNullableArrayOfNullableStringsWithMaxLengthOf9(
            final String[] value) {
        if (value != null)
