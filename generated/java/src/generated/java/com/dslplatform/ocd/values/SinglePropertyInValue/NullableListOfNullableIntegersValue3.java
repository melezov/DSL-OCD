...
public final class NullableListOfNullableIntegersValue3 implements
        java.io.Serializable {
    public NullableListOfNullableIntegersValue3(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1406025578;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof NullableListOfNullableIntegersValue3))
            return false;
        final NullableListOfNullableIntegersValue3 other = (NullableListOfNullableIntegersValue3) obj;
    ...
    public String toString() {
        return "NullableListOfNullableIntegersValue3("
    ...
    public NullableListOfNullableIntegersValue3 setNullableListOfNullableIntegers(
