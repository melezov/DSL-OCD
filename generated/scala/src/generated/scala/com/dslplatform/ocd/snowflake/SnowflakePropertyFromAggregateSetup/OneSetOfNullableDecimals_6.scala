...
class OneSetOfNullableDecimals_6 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: OneSetOfNullableDecimals_6 => c.URI == URI
    case _ => false
  }

  override def toString = "OneSetOfNullableDecimals_6("+ URI +")"

   def copy(oneSetOfNullableDecimals: Set[Option[BigDecimal]] = this._oneSetOfNullableDecimals): OneSetOfNullableDecimals_6 = {
  ...
  com.dslplatform.api.Guards.checkCollectionOptionRefNulls(oneSetOfNullableDecimals)
    new OneSetOfNullableDecimals_6(_URI = this.URI, __locator = this.__locator, _ID = _ID, _oneSetOfNullableDecimals = oneSetOfNullableDecimals)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneSetOfNullableDecimals_6): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneSetOfNullableDecimals_6](URI), duration)
  }
...
object OneSetOfNullableDecimals_6 extends AggregateRootCompanion[OneSetOfNullableDecimals_6]{
  ...
  def apply(
    ...
    com.dslplatform.api.Guards.checkCollectionOptionRefNulls(oneSetOfNullableDecimals)
    require(oneSetOfNullableDecimals ne null, "Null value was provided for property \"oneSetOfNullableDecimals\"")
    new OneSetOfNullableDecimals_6(
      __locator = None
