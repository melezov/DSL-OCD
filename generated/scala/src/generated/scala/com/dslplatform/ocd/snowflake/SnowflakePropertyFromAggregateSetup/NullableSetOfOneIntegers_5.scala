...
class NullableSetOfOneIntegers_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableSetOfOneIntegers_5 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableSetOfOneIntegers_5("+ URI +")"

   def copy(nullableSetOfOneIntegers: Option[Set[Int]] = this._nullableSetOfOneIntegers): NullableSetOfOneIntegers_5 = {
  ...
  if(nullableSetOfOneIntegers.isDefined) require(nullableSetOfOneIntegers.get ne null, "Null value was provided for property \"nullableSetOfOneIntegers\"")
    new NullableSetOfOneIntegers_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableSetOfOneIntegers = nullableSetOfOneIntegers)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableSetOfOneIntegers_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableSetOfOneIntegers_5](URI), duration)
  }
...
object NullableSetOfOneIntegers_5 extends AggregateRootCompanion[NullableSetOfOneIntegers_5]{
  ...
  def apply(
    ...
    require(nullableSetOfOneIntegers ne null, "Null value was provided for property \"nullableSetOfOneIntegers\"")
    if (nullableSetOfOneIntegers.isDefined) require(nullableSetOfOneIntegers.get ne null, "Null value was provided for property \"nullableSetOfOneIntegers\"")
    new NullableSetOfOneIntegers_5(
      __locator = None
