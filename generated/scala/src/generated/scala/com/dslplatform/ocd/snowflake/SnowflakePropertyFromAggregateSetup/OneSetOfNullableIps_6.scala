...
class OneSetOfNullableIps_6 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: OneSetOfNullableIps_6 => c.URI == URI
    case _ => false
  }

  override def toString = "OneSetOfNullableIps_6("+ URI +")"

   def copy(oneSetOfNullableIps: Set[Option[java.net.InetAddress]] = this._oneSetOfNullableIps): OneSetOfNullableIps_6 = {
  ...
  com.dslplatform.api.Guards.checkCollectionOptionRefNulls(oneSetOfNullableIps)
    new OneSetOfNullableIps_6(_URI = this.URI, __locator = this.__locator, _ID = _ID, _oneSetOfNullableIps = oneSetOfNullableIps)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneSetOfNullableIps_6): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneSetOfNullableIps_6](URI), duration)
  }
...
object OneSetOfNullableIps_6 extends AggregateRootCompanion[OneSetOfNullableIps_6]{
