...
public final class NullableListOfNullableIntegersValue1 implements
        java.io.Serializable {
    public NullableListOfNullableIntegersValue1(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1726142304;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof NullableListOfNullableIntegersValue1))
            return false;
        final NullableListOfNullableIntegersValue1 other = (NullableListOfNullableIntegersValue1) obj;
    ...
    public String toString() {
        return "NullableListOfNullableIntegersValue1("
    ...
    public NullableListOfNullableIntegersValue1 setNullableListOfNullableIntegers(
