...
public final class OneArrayOfNullableMapsValue6 implements java.io.Serializable {
    public OneArrayOfNullableMapsValue6(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1049465739;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfNullableMapsValue6)) return false;
        final OneArrayOfNullableMapsValue6 other = (OneArrayOfNullableMapsValue6) obj;
    ...
    public String toString() {
        return "OneArrayOfNullableMapsValue6(" + oneArrayOfNullableMaps + ')';
    }
    ...
    public OneArrayOfNullableMapsValue6 setOneArrayOfNullableMaps(
