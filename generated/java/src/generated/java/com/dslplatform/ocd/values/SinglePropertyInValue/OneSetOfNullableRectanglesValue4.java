...
public final class OneSetOfNullableRectanglesValue4 implements
        java.io.Serializable {
    public OneSetOfNullableRectanglesValue4(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1705931083;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneSetOfNullableRectanglesValue4)) return false;
        final OneSetOfNullableRectanglesValue4 other = (OneSetOfNullableRectanglesValue4) obj;
    ...
    public String toString() {
        return "OneSetOfNullableRectanglesValue4(" + oneSetOfNullableRectangles
                + ')';
    }
    ...
    public OneSetOfNullableRectanglesValue4 setOneSetOfNullableRectangles(
