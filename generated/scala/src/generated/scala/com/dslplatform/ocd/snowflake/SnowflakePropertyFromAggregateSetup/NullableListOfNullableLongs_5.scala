...
class NullableListOfNullableLongs_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableListOfNullableLongs_5 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableListOfNullableLongs_5("+ URI +")"

   def copy(nullableListOfNullableLongs: Option[IndexedSeq[Option[Long]]] = this._nullableListOfNullableLongs): NullableListOfNullableLongs_5 = {
  ...
  com.dslplatform.api.Guards.checkCollectionOptionValNulls(nullableListOfNullableLongs)
    new NullableListOfNullableLongs_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableListOfNullableLongs = nullableListOfNullableLongs)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableListOfNullableLongs_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableListOfNullableLongs_5](URI), duration)
  }
...
object NullableListOfNullableLongs_5 extends AggregateRootCompanion[NullableListOfNullableLongs_5]{
  ...
  def apply(
    ...
    require(nullableListOfNullableLongs ne null, "Null value was provided for property \"nullableListOfNullableLongs\"")
    if (nullableListOfNullableLongs.isDefined) require(nullableListOfNullableLongs.get ne null, "Null value was provided for property \"nullableListOfNullableLongs\"")
    new NullableListOfNullableLongs_5(
      __locator = None
