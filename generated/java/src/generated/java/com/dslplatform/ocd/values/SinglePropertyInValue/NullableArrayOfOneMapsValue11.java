...
public final class NullableArrayOfOneMapsValue11 implements
        java.io.Serializable {
    public NullableArrayOfOneMapsValue11(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1981078845;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof NullableArrayOfOneMapsValue11)) return false;
        final NullableArrayOfOneMapsValue11 other = (NullableArrayOfOneMapsValue11) obj;
    ...
    public String toString() {
        return "NullableArrayOfOneMapsValue11(" + nullableArrayOfOneMaps + ')';
    }
    ...
    public NullableArrayOfOneMapsValue11 setNullableArrayOfOneMaps(
