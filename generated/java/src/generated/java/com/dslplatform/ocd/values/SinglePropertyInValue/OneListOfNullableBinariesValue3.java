...
public final class OneListOfNullableBinariesValue3 implements
        java.io.Serializable {
    public OneListOfNullableBinariesValue3(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1577956113;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneListOfNullableBinariesValue3)) return false;
        final OneListOfNullableBinariesValue3 other = (OneListOfNullableBinariesValue3) obj;
    ...
    public String toString() {
        return "OneListOfNullableBinariesValue3(" + oneListOfNullableBinaries
                + ')';
    }
    ...
    public OneListOfNullableBinariesValue3 setOneListOfNullableBinaries(
