...
public final class OneArrayOfNullableBooleansValue5 implements
        java.io.Serializable {
    public OneArrayOfNullableBooleansValue5(
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfNullableBooleansValue5)) return false;
        final OneArrayOfNullableBooleansValue5 other = (OneArrayOfNullableBooleansValue5) obj;
    ...
    public String toString() {
        return "OneArrayOfNullableBooleansValue5(" + oneArrayOfNullableBooleans
                + ')';
    }
    ...
    public OneArrayOfNullableBooleansValue5 setOneArrayOfNullableBooleans(
            final Boolean[] value) {
        if (value == null)
