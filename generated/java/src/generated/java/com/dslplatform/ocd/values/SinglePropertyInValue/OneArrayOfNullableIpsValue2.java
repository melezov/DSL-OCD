...
public final class OneArrayOfNullableIpsValue2 implements java.io.Serializable {
    public OneArrayOfNullableIpsValue2(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1328980658;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfNullableIpsValue2)) return false;
        final OneArrayOfNullableIpsValue2 other = (OneArrayOfNullableIpsValue2) obj;
    ...
    public String toString() {
        return "OneArrayOfNullableIpsValue2(" + oneArrayOfNullableIps + ')';
    }
    ...
    public OneArrayOfNullableIpsValue2 setOneArrayOfNullableIps(
