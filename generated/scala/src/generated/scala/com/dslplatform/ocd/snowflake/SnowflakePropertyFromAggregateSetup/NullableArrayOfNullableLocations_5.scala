...
class NullableArrayOfNullableLocations_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableArrayOfNullableLocations_5 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableArrayOfNullableLocations_5("+ URI +")"

   def copy(nullableArrayOfNullableLocations: Option[Array[Option[java.awt.geom.Point2D]]] = this._nullableArrayOfNullableLocations): NullableArrayOfNullableLocations_5 = {
  ...
  com.dslplatform.api.Guards.checkArrayOptionRefNulls(nullableArrayOfNullableLocations)
    new NullableArrayOfNullableLocations_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableArrayOfNullableLocations = nullableArrayOfNullableLocations)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableArrayOfNullableLocations_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableArrayOfNullableLocations_5](URI), duration)
  }
...
object NullableArrayOfNullableLocations_5 extends AggregateRootCompanion[NullableArrayOfNullableLocations_5]{
  ...
  def apply(
    ...
    require(nullableArrayOfNullableLocations ne null, "Null value was provided for property \"nullableArrayOfNullableLocations\"")
    if (nullableArrayOfNullableLocations.isDefined) require(nullableArrayOfNullableLocations.get ne null, "Null value was provided for property \"nullableArrayOfNullableLocations\"")
    new NullableArrayOfNullableLocations_5(
      __locator = None
