...
class OneString_3 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: OneString_3 => c.URI == URI
    case _ => false
  }

  override def toString = "OneString_3("+ URI +")"

   def copy(oneString: String = this._oneString): OneString_3 = {
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.aggregates.SurrogatePrimaryKeyWithOnePropertyInAggregate.OneString_3): this.type = {
...
object OneString_3 extends AggregateRootCompanion[OneString_3]{
