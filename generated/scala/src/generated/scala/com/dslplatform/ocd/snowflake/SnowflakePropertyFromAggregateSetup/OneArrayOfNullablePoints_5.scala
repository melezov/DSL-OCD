...
class OneArrayOfNullablePoints_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: OneArrayOfNullablePoints_5 => c.URI == URI
    case _ => false
  }

  override def toString = "OneArrayOfNullablePoints_5("+ URI +")"

   def copy(oneArrayOfNullablePoints: Array[Option[java.awt.geom.Point2D]] = this._oneArrayOfNullablePoints): OneArrayOfNullablePoints_5 = {
  ...
  com.dslplatform.api.Guards.checkArrayOptionRefNulls(oneArrayOfNullablePoints)
    new OneArrayOfNullablePoints_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _oneArrayOfNullablePoints = oneArrayOfNullablePoints)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneArrayOfNullablePoints_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneArrayOfNullablePoints_5](URI), duration)
  }
...
object OneArrayOfNullablePoints_5 extends AggregateRootCompanion[OneArrayOfNullablePoints_5]{
  ...
  def apply(
    ...
    com.dslplatform.api.Guards.checkArrayOptionRefNulls(oneArrayOfNullablePoints)
    require(oneArrayOfNullablePoints ne null, "Null value was provided for property \"oneArrayOfNullablePoints\"")
    new OneArrayOfNullablePoints_5(
      __locator = None
