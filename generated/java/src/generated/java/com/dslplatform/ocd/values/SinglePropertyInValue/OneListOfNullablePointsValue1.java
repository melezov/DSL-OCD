...
public final class OneListOfNullablePointsValue1 implements
        java.io.Serializable {
    public OneListOfNullablePointsValue1(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1964542309;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneListOfNullablePointsValue1)) return false;
        final OneListOfNullablePointsValue1 other = (OneListOfNullablePointsValue1) obj;
    ...
    public String toString() {
        return "OneListOfNullablePointsValue1(" + oneListOfNullablePoints + ')';
    }
    ...
    public OneListOfNullablePointsValue1 setOneListOfNullablePoints(
