...
public final class OneSetOfNullablePointsValue3 implements java.io.Serializable {
    public OneSetOfNullablePointsValue3(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 2074047139;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneSetOfNullablePointsValue3)) return false;
        final OneSetOfNullablePointsValue3 other = (OneSetOfNullablePointsValue3) obj;
    ...
    public String toString() {
        return "OneSetOfNullablePointsValue3(" + oneSetOfNullablePoints + ')';
    }
    ...
    public OneSetOfNullablePointsValue3 setOneSetOfNullablePoints(
