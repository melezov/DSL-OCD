...
class NullableArrayOfNullableXmls_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableArrayOfNullableXmls_5 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableArrayOfNullableXmls_5("+ URI +")"

   def copy(nullableArrayOfNullableXmls: Option[Array[Option[scala.xml.Elem]]] = this._nullableArrayOfNullableXmls): NullableArrayOfNullableXmls_5 = {
  ...
  com.dslplatform.api.Guards.checkArrayOptionRefNulls(nullableArrayOfNullableXmls)
    new NullableArrayOfNullableXmls_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableArrayOfNullableXmls = nullableArrayOfNullableXmls)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableArrayOfNullableXmls_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableArrayOfNullableXmls_5](URI), duration)
  }
...
object NullableArrayOfNullableXmls_5 extends AggregateRootCompanion[NullableArrayOfNullableXmls_5]{
  ...
  def apply(
    ...
    require(nullableArrayOfNullableXmls ne null, "Null value was provided for property \"nullableArrayOfNullableXmls\"")
    if (nullableArrayOfNullableXmls.isDefined) require(nullableArrayOfNullableXmls.get ne null, "Null value was provided for property \"nullableArrayOfNullableXmls\"")
    new NullableArrayOfNullableXmls_5(
      __locator = None
