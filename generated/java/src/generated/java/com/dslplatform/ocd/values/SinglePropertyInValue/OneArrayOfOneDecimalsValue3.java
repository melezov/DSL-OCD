...
public final class OneArrayOfOneDecimalsValue3 implements java.io.Serializable {
    public OneArrayOfOneDecimalsValue3(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1131161008;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfOneDecimalsValue3)) return false;
        final OneArrayOfOneDecimalsValue3 other = (OneArrayOfOneDecimalsValue3) obj;
    ...
    public String toString() {
        return "OneArrayOfOneDecimalsValue3(" + oneArrayOfOneDecimals + ')';
    }
    ...
    public OneArrayOfOneDecimalsValue3 setOneArrayOfOneDecimals(
