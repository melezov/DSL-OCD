...
class OneListOfNullableIntegers_2 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: OneListOfNullableIntegers_2 => c.URI == URI
    case _ => false
  }

  override def toString = "OneListOfNullableIntegers_2("+ URI +")"

   def copy(oneListOfNullableIntegers: IndexedSeq[Option[Int]] = this._oneListOfNullableIntegers): OneListOfNullableIntegers_2 = {
  ...
  com.dslplatform.api.Guards.checkCollectionOptionValNulls(oneListOfNullableIntegers)
    new OneListOfNullableIntegers_2(_URI = this.URI, __locator = this.__locator, _oneListOfNullableIntegers = oneListOfNullableIntegers)
  }

  @com.fasterxml.jackson.annotation.JsonIgnore
  def isNewAggregate() = __locator == None

  private def updateWithAnother(result: com.dslplatform.ocd.aggregates.PrimaryKeyPropertyInAggregateSetup.OneListOfNullableIntegers_2): this.type = {
  ...
  , @com.fasterxml.jackson.annotation.JsonProperty("oneListOfNullableIntegers") oneListOfNullableIntegers: IndexedSeq[Option[Int]]
    ...
    this(__locator = Some(__locator), _URI = URI, _oneListOfNullableIntegers = if (oneListOfNullableIntegers == null) IndexedSeq.empty else oneListOfNullableIntegers)

}

object OneListOfNullableIntegers_2 extends AggregateRootCompanion[OneListOfNullableIntegers_2]{
  ...
  def apply(
    ...
    com.dslplatform.api.Guards.checkCollectionOptionValNulls(oneListOfNullableIntegers)
    require(oneListOfNullableIntegers ne null, "Null value was provided for property \"oneListOfNullableIntegers\"")
    new OneListOfNullableIntegers_2(
      __locator = None
