...
public final class OneArrayOfNullableTextsValue5 implements
        java.io.Serializable {
    public OneArrayOfNullableTextsValue5(
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfNullableTextsValue5)) return false;
        final OneArrayOfNullableTextsValue5 other = (OneArrayOfNullableTextsValue5) obj;
    ...
    public String toString() {
        return "OneArrayOfNullableTextsValue5(" + oneArrayOfNullableTexts + ')';
    }
    ...
    public OneArrayOfNullableTextsValue5 setOneArrayOfNullableTexts(
            final String[] value) {
        if (value == null)
