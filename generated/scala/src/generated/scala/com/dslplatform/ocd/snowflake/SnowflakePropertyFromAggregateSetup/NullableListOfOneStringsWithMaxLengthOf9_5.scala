...
class NullableListOfOneStringsWithMaxLengthOf9_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableListOfOneStringsWithMaxLengthOf9_5 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableListOfOneStringsWithMaxLengthOf9_5("+ URI +")"

   def copy(nullableListOfOneStringsWithMaxLengthOf9: Option[IndexedSeq[String]] = this._nullableListOfOneStringsWithMaxLengthOf9): NullableListOfOneStringsWithMaxLengthOf9_5 = {
  ...
  com.dslplatform.api.Guards.checkCollectionNulls(nullableListOfOneStringsWithMaxLengthOf9)
    new NullableListOfOneStringsWithMaxLengthOf9_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableListOfOneStringsWithMaxLengthOf9 = nullableListOfOneStringsWithMaxLengthOf9)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableListOfOneStringsWithMaxLengthOf9_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableListOfOneStringsWithMaxLengthOf9_5](URI), duration)
  }
...
object NullableListOfOneStringsWithMaxLengthOf9_5 extends AggregateRootCompanion[NullableListOfOneStringsWithMaxLengthOf9_5]{
  ...
  def apply(
    ...
    require(nullableListOfOneStringsWithMaxLengthOf9 ne null, "Null value was provided for property \"nullableListOfOneStringsWithMaxLengthOf9\"")
    if (nullableListOfOneStringsWithMaxLengthOf9.isDefined) require(nullableListOfOneStringsWithMaxLengthOf9.get ne null, "Null value was provided for property \"nullableListOfOneStringsWithMaxLengthOf9\"")
    new NullableListOfOneStringsWithMaxLengthOf9_5(
      __locator = None
