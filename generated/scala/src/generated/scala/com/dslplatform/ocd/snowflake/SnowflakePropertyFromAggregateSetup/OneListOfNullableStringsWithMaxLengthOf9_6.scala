...
class OneListOfNullableStringsWithMaxLengthOf9_6 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: OneListOfNullableStringsWithMaxLengthOf9_6 => c.URI == URI
    case _ => false
  }

  override def toString = "OneListOfNullableStringsWithMaxLengthOf9_6("+ URI +")"

   def copy(oneListOfNullableStringsWithMaxLengthOf9: IndexedSeq[Option[String]] = this._oneListOfNullableStringsWithMaxLengthOf9): OneListOfNullableStringsWithMaxLengthOf9_6 = {
  ...
  com.dslplatform.api.Guards.checkCollectionOptionRefNulls(oneListOfNullableStringsWithMaxLengthOf9)
    new OneListOfNullableStringsWithMaxLengthOf9_6(_URI = this.URI, __locator = this.__locator, _ID = _ID, _oneListOfNullableStringsWithMaxLengthOf9 = oneListOfNullableStringsWithMaxLengthOf9)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneListOfNullableStringsWithMaxLengthOf9_6): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneListOfNullableStringsWithMaxLengthOf9_6](URI), duration)
  }
...
object OneListOfNullableStringsWithMaxLengthOf9_6 extends AggregateRootCompanion[OneListOfNullableStringsWithMaxLengthOf9_6]{
  ...
  def apply(
    ...
    com.dslplatform.api.Guards.checkCollectionOptionRefNulls(oneListOfNullableStringsWithMaxLengthOf9)
    require(oneListOfNullableStringsWithMaxLengthOf9 ne null, "Null value was provided for property \"oneListOfNullableStringsWithMaxLengthOf9\"")
    new OneListOfNullableStringsWithMaxLengthOf9_6(
      __locator = None
