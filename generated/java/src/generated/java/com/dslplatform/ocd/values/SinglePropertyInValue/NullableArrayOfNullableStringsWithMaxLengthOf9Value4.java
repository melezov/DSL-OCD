...
public final class NullableArrayOfNullableStringsWithMaxLengthOf9Value4
        implements java.io.Serializable {
    public NullableArrayOfNullableStringsWithMaxLengthOf9Value4(
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof NullableArrayOfNullableStringsWithMaxLengthOf9Value4))
            return false;
        final NullableArrayOfNullableStringsWithMaxLengthOf9Value4 other = (NullableArrayOfNullableStringsWithMaxLengthOf9Value4) obj;
    ...
    public String toString() {
        return "NullableArrayOfNullableStringsWithMaxLengthOf9Value4("
    ...
    public NullableArrayOfNullableStringsWithMaxLengthOf9Value4 setNullableArrayOfNullableStringsWithMaxLengthOf9(
            final String[] value) {
        if (value != null)
