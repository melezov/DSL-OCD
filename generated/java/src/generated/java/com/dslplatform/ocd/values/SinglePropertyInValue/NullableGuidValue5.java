...
public final class NullableGuidValue5 implements java.io.Serializable {
    public NullableGuidValue5(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1874753842;
        result = prime
                * result
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof NullableGuidValue5)) return false;
        final NullableGuidValue5 other = (NullableGuidValue5) obj;
    ...
    public String toString() {
        return "NullableGuidValue5(" + nullableGuid + ')';
    }
    ...
    public NullableGuidValue5 setNullableGuid(final java.util.UUID value) {
