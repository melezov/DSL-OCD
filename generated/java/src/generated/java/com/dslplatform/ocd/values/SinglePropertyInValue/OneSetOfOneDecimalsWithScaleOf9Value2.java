...
public final class OneSetOfOneDecimalsWithScaleOf9Value2 implements
        java.io.Serializable {
    public OneSetOfOneDecimalsWithScaleOf9Value2(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1336709702;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneSetOfOneDecimalsWithScaleOf9Value2))
            return false;
        final OneSetOfOneDecimalsWithScaleOf9Value2 other = (OneSetOfOneDecimalsWithScaleOf9Value2) obj;
    ...
    public String toString() {
        return "OneSetOfOneDecimalsWithScaleOf9Value2("
    ...
    public OneSetOfOneDecimalsWithScaleOf9Value2 setOneSetOfOneDecimalsWithScaleOf9(
