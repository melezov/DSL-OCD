...
class NullableListOfOneXmls_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableListOfOneXmls_5 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableListOfOneXmls_5("+ URI +")"

   def copy(nullableListOfOneXmls: Option[IndexedSeq[scala.xml.Elem]] = this._nullableListOfOneXmls): NullableListOfOneXmls_5 = {
  ...
  com.dslplatform.api.Guards.checkCollectionNulls(nullableListOfOneXmls)
    new NullableListOfOneXmls_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableListOfOneXmls = nullableListOfOneXmls)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableListOfOneXmls_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableListOfOneXmls_5](URI), duration)
  }
...
object NullableListOfOneXmls_5 extends AggregateRootCompanion[NullableListOfOneXmls_5]{
