...
public final class OneListOfNullableBinariesValue1 implements
        java.io.Serializable {
    public OneListOfNullableBinariesValue1(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1577956115;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneListOfNullableBinariesValue1)) return false;
        final OneListOfNullableBinariesValue1 other = (OneListOfNullableBinariesValue1) obj;
    ...
    public String toString() {
        return "OneListOfNullableBinariesValue1(" + oneListOfNullableBinaries
                + ')';
    }
    ...
    public OneListOfNullableBinariesValue1 setOneListOfNullableBinaries(
