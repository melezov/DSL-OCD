...
public final class OneDecimalWithScaleOf9Value2 implements java.io.Serializable {
    public OneDecimalWithScaleOf9Value2(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1609826514;
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneDecimalWithScaleOf9Value2)) return false;
        final OneDecimalWithScaleOf9Value2 other = (OneDecimalWithScaleOf9Value2) obj;
    ...
    public String toString() {
        return "OneDecimalWithScaleOf9Value2(" + oneDecimalWithScaleOf9 + ')';
    }
    ...
    public OneDecimalWithScaleOf9Value2 setOneDecimalWithScaleOf9(
