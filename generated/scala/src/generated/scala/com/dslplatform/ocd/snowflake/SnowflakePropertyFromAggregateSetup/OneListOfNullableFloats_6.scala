...
class OneListOfNullableFloats_6 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: OneListOfNullableFloats_6 => c.URI == URI
    case _ => false
  }

  override def toString = "OneListOfNullableFloats_6("+ URI +")"

   def copy(oneListOfNullableFloats: IndexedSeq[Option[Float]] = this._oneListOfNullableFloats): OneListOfNullableFloats_6 = {
  ...
  com.dslplatform.api.Guards.checkCollectionOptionValNulls(oneListOfNullableFloats)
    new OneListOfNullableFloats_6(_URI = this.URI, __locator = this.__locator, _ID = _ID, _oneListOfNullableFloats = oneListOfNullableFloats)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneListOfNullableFloats_6): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneListOfNullableFloats_6](URI), duration)
  }
...
object OneListOfNullableFloats_6 extends AggregateRootCompanion[OneListOfNullableFloats_6]{
