...
class NullableListOfNullablePoints_2 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableListOfNullablePoints_2 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableListOfNullablePoints_2("+ URI +")"

   def copy(nullableListOfNullablePoints: Option[IndexedSeq[Option[java.awt.geom.Point2D]]] = this._nullableListOfNullablePoints): NullableListOfNullablePoints_2 = {
  ...
  com.dslplatform.api.Guards.checkCollectionOptionRefNulls(nullableListOfNullablePoints)
    new NullableListOfNullablePoints_2(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableListOfNullablePoints = nullableListOfNullablePoints)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.aggregates.SurrogatePrimaryKeyWithOnePropertyInAggregate.NullableListOfNullablePoints_2): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.aggregates.SurrogatePrimaryKeyWithOnePropertyInAggregate.NullableListOfNullablePoints_2](URI), duration)
  }

  @com.fasterxml.jackson.annotation.JsonGetter("nullableListOfNullablePoints")
...
object NullableListOfNullablePoints_2 extends AggregateRootCompanion[NullableListOfNullablePoints_2]{
  ...
  def apply(
    ...
    require(nullableListOfNullablePoints ne null, "Null value was provided for property \"nullableListOfNullablePoints\"")
    if (nullableListOfNullablePoints.isDefined) require(nullableListOfNullablePoints.get ne null, "Null value was provided for property \"nullableListOfNullablePoints\"")
    new NullableListOfNullablePoints_2(
      __locator = None
