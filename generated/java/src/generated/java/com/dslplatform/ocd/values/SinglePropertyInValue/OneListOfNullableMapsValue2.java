...
public final class OneListOfNullableMapsValue2 implements java.io.Serializable {
    public OneListOfNullableMapsValue2(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1552057420;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneListOfNullableMapsValue2)) return false;
        final OneListOfNullableMapsValue2 other = (OneListOfNullableMapsValue2) obj;
    ...
    public String toString() {
        return "OneListOfNullableMapsValue2(" + oneListOfNullableMaps + ')';
    }
    ...
    public OneListOfNullableMapsValue2 setOneListOfNullableMaps(
