...
public final class NullableSetOfNullableImagesValue3 implements
        java.io.Serializable {
    public NullableSetOfNullableImagesValue3(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1775195865;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof NullableSetOfNullableImagesValue3)) return false;
        final NullableSetOfNullableImagesValue3 other = (NullableSetOfNullableImagesValue3) obj;
    ...
    public String toString() {
        return "NullableSetOfNullableImagesValue3("
    ...
    public NullableSetOfNullableImagesValue3 setNullableSetOfNullableImages(
