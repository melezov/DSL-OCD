...
class NullableSetOfOneUrls_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableSetOfOneUrls_5 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableSetOfOneUrls_5("+ URI +")"

   def copy(nullableSetOfOneUrls: Option[Set[java.net.URI]] = this._nullableSetOfOneUrls): NullableSetOfOneUrls_5 = {
  ...
  com.dslplatform.api.Guards.checkCollectionNulls(nullableSetOfOneUrls)
    new NullableSetOfOneUrls_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableSetOfOneUrls = nullableSetOfOneUrls)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableSetOfOneUrls_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableSetOfOneUrls_5](URI), duration)
  }
...
object NullableSetOfOneUrls_5 extends AggregateRootCompanion[NullableSetOfOneUrls_5]{
