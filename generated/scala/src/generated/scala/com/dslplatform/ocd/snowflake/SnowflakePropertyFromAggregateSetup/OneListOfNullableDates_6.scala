...
class OneListOfNullableDates_6 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: OneListOfNullableDates_6 => c.URI == URI
    case _ => false
  }

  override def toString = "OneListOfNullableDates_6("+ URI +")"

   def copy(oneListOfNullableDates: IndexedSeq[Option[org.joda.time.LocalDate]] = this._oneListOfNullableDates): OneListOfNullableDates_6 = {
  ...
  com.dslplatform.api.Guards.checkCollectionOptionRefNulls(oneListOfNullableDates)
    new OneListOfNullableDates_6(_URI = this.URI, __locator = this.__locator, _ID = _ID, _oneListOfNullableDates = oneListOfNullableDates)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneListOfNullableDates_6): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneListOfNullableDates_6](URI), duration)
  }
...
object OneListOfNullableDates_6 extends AggregateRootCompanion[OneListOfNullableDates_6]{
