...
public final class OneArrayOfOneBooleansValue12 implements java.io.Serializable {
    public OneArrayOfOneBooleansValue12(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1664055479;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfOneBooleansValue12)) return false;
        final OneArrayOfOneBooleansValue12 other = (OneArrayOfOneBooleansValue12) obj;
    ...
    public String toString() {
        return "OneArrayOfOneBooleansValue12(" + oneArrayOfOneBooleans + ')';
    }
    ...
    public OneArrayOfOneBooleansValue12 setOneArrayOfOneBooleans(
            final boolean[] value) {
        if (value == null)
