...
public final class OneArrayOfOneImagesValue4 implements java.io.Serializable {
    public OneArrayOfOneImagesValue4(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1231038617;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfOneImagesValue4)) return false;
        final OneArrayOfOneImagesValue4 other = (OneArrayOfOneImagesValue4) obj;
    ...
    public String toString() {
        return "OneArrayOfOneImagesValue4(" + oneArrayOfOneImages + ')';
    }
    ...
    public OneArrayOfOneImagesValue4 setOneArrayOfOneImages(
