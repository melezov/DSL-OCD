...
class OneArrayOfNullableFloats_6 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: OneArrayOfNullableFloats_6 => c.URI == URI
    case _ => false
  }

  override def toString = "OneArrayOfNullableFloats_6("+ URI +")"

   def copy(oneArrayOfNullableFloats: Array[Option[Float]] = this._oneArrayOfNullableFloats): OneArrayOfNullableFloats_6 = {
  ...
  com.dslplatform.api.Guards.checkArrayOptionValNulls(oneArrayOfNullableFloats)
    new OneArrayOfNullableFloats_6(_URI = this.URI, __locator = this.__locator, _ID = _ID, _oneArrayOfNullableFloats = oneArrayOfNullableFloats)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneArrayOfNullableFloats_6): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneArrayOfNullableFloats_6](URI), duration)
  }
...
object OneArrayOfNullableFloats_6 extends AggregateRootCompanion[OneArrayOfNullableFloats_6]{
  ...
  def apply(
    ...
    com.dslplatform.api.Guards.checkArrayOptionValNulls(oneArrayOfNullableFloats)
    require(oneArrayOfNullableFloats ne null, "Null value was provided for property \"oneArrayOfNullableFloats\"")
    new OneArrayOfNullableFloats_6(
      __locator = None
