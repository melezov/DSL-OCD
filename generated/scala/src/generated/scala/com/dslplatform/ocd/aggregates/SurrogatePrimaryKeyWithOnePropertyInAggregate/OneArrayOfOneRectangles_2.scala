...
class OneArrayOfOneRectangles_2 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: OneArrayOfOneRectangles_2 => c.URI == URI
    case _ => false
  }

  override def toString = "OneArrayOfOneRectangles_2("+ URI +")"

   def copy(oneArrayOfOneRectangles: Array[java.awt.geom.Rectangle2D] = this._oneArrayOfOneRectangles): OneArrayOfOneRectangles_2 = {
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.aggregates.SurrogatePrimaryKeyWithOnePropertyInAggregate.OneArrayOfOneRectangles_2): this.type = {
...
object OneArrayOfOneRectangles_2 extends AggregateRootCompanion[OneArrayOfOneRectangles_2]{
