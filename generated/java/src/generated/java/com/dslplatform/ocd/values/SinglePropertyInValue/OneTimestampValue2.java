...
public final class OneTimestampValue2 implements java.io.Serializable {
    public OneTimestampValue2(
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneTimestampValue2)) return false;
        final OneTimestampValue2 other = (OneTimestampValue2) obj;
    ...
    public String toString() {
        return "OneTimestampValue2(" + oneTimestamp + ')';
    }
    ...
    public OneTimestampValue2 setOneTimestamp(final org.joda.time.DateTime value) {
        if (value == null)
