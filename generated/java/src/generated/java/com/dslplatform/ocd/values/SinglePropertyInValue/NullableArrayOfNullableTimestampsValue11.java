...
public final class NullableArrayOfNullableTimestampsValue11 implements
        java.io.Serializable {
    public NullableArrayOfNullableTimestampsValue11(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1177165004;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof NullableArrayOfNullableTimestampsValue11))
            return false;
        final NullableArrayOfNullableTimestampsValue11 other = (NullableArrayOfNullableTimestampsValue11) obj;
    ...
    public String toString() {
        return "NullableArrayOfNullableTimestampsValue11("
    ...
    public NullableArrayOfNullableTimestampsValue11 setNullableArrayOfNullableTimestamps(
