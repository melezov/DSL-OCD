...
case object `dsl.TEXT` extends `DslString` with `box.One`
case object `dsl.ARRAY<TEXT>` extends `DslString` with `box.OneArrayOfOne`
case object `dsl.TEXT[]` extends `DslString` with `box.OneBracketsOfOne`
case object `dsl.ARRAY<TEXT?>` extends `DslString` with `box.OneArrayOfNullable`
case object `dsl.TEXT?[]` extends `DslString` with `box.OneBracketsOfNullable`
case object `dsl.LIST<TEXT>` extends `DslString` with `box.OneListOfOne`
case object `dsl.LIST<TEXT?>` extends `DslString` with `box.OneListOfNullable`
case object `dsl.SET<TEXT>` extends `DslString` with `box.OneSetOfOne`
case object `dsl.SET<TEXT?>` extends `DslString` with `box.OneSetOfNullable`
case object `dsl.TEXT?` extends `DslString` with `box.Nullable`
case object `dsl.ARRAY<TEXT>?` extends `DslString` with `box.NullableArrayOfOne`
case object `dsl.TEXT[]?` extends `DslString` with `box.NullableBracketsOfOne`
case object `dsl.ARRAY<TEXT?>?` extends `DslString` with `box.NullableArrayOfNullable`
case object `dsl.TEXT?[]?` extends `DslString` with `box.NullableBracketsOfNullable`
case object `dsl.LIST<TEXT>?` extends `DslString` with `box.NullableListOfOne`
case object `dsl.LIST<TEXT?>?` extends `DslString` with `box.NullableListOfNullable`
case object `dsl.SET<TEXT>?` extends `DslString` with `box.NullableSetOfOne`
case object `dsl.SET<TEXT?>?` extends `DslString` with `box.NullableSetOfNullable`
