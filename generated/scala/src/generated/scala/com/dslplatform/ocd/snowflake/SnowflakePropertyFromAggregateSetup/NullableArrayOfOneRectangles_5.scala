...
class NullableArrayOfOneRectangles_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableArrayOfOneRectangles_5 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableArrayOfOneRectangles_5("+ URI +")"

   def copy(nullableArrayOfOneRectangles: Option[Array[java.awt.geom.Rectangle2D]] = this._nullableArrayOfOneRectangles): NullableArrayOfOneRectangles_5 = {
  ...
  com.dslplatform.api.Guards.checkArrayNulls(nullableArrayOfOneRectangles)
    new NullableArrayOfOneRectangles_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableArrayOfOneRectangles = nullableArrayOfOneRectangles)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableArrayOfOneRectangles_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableArrayOfOneRectangles_5](URI), duration)
  }
...
object NullableArrayOfOneRectangles_5 extends AggregateRootCompanion[NullableArrayOfOneRectangles_5]{
  ...
  def apply(
    ...
    require(nullableArrayOfOneRectangles ne null, "Null value was provided for property \"nullableArrayOfOneRectangles\"")
    if (nullableArrayOfOneRectangles.isDefined) require(nullableArrayOfOneRectangles.get ne null, "Null value was provided for property \"nullableArrayOfOneRectangles\"")
    new NullableArrayOfOneRectangles_5(
      __locator = None
