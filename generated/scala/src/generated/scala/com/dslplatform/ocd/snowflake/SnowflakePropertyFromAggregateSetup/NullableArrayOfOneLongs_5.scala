...
class NullableArrayOfOneLongs_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableArrayOfOneLongs_5 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableArrayOfOneLongs_5("+ URI +")"

   def copy(nullableArrayOfOneLongs: Option[Array[Long]] = this._nullableArrayOfOneLongs): NullableArrayOfOneLongs_5 = {
  ...
  if(nullableArrayOfOneLongs.isDefined) require(nullableArrayOfOneLongs.get ne null, "Null value was provided for property \"nullableArrayOfOneLongs\"")
    new NullableArrayOfOneLongs_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableArrayOfOneLongs = nullableArrayOfOneLongs)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableArrayOfOneLongs_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableArrayOfOneLongs_5](URI), duration)
  }
...
object NullableArrayOfOneLongs_5 extends AggregateRootCompanion[NullableArrayOfOneLongs_5]{
