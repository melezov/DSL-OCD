...
public final class OneArrayOfNullableDatesValue4 implements
        java.io.Serializable {
    public OneArrayOfNullableDatesValue4(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1685906615;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfNullableDatesValue4)) return false;
        final OneArrayOfNullableDatesValue4 other = (OneArrayOfNullableDatesValue4) obj;
    ...
    public String toString() {
        return "OneArrayOfNullableDatesValue4(" + oneArrayOfNullableDates + ')';
    }
    ...
    public OneArrayOfNullableDatesValue4 setOneArrayOfNullableDates(
