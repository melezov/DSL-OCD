...
public final class OneArrayOfOnePointsValue5 implements java.io.Serializable {
    public OneArrayOfOnePointsValue5(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1921838479;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfOnePointsValue5)) return false;
        final OneArrayOfOnePointsValue5 other = (OneArrayOfOnePointsValue5) obj;
    ...
    public String toString() {
        return "OneArrayOfOnePointsValue5(" + oneArrayOfOnePoints + ')';
    }
    ...
    public OneArrayOfOnePointsValue5 setOneArrayOfOnePoints(
