...
class OneSetOfNullableTimestamps_6 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: OneSetOfNullableTimestamps_6 => c.URI == URI
    case _ => false
  }

  override def toString = "OneSetOfNullableTimestamps_6("+ URI +")"

   def copy(oneSetOfNullableTimestamps: Set[Option[org.joda.time.DateTime]] = this._oneSetOfNullableTimestamps): OneSetOfNullableTimestamps_6 = {
  ...
  com.dslplatform.api.Guards.checkCollectionOptionRefNulls(oneSetOfNullableTimestamps)
    new OneSetOfNullableTimestamps_6(_URI = this.URI, __locator = this.__locator, _ID = _ID, _oneSetOfNullableTimestamps = oneSetOfNullableTimestamps)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneSetOfNullableTimestamps_6): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneSetOfNullableTimestamps_6](URI), duration)
  }
...
object OneSetOfNullableTimestamps_6 extends AggregateRootCompanion[OneSetOfNullableTimestamps_6]{
  ...
  def apply(
    ...
    com.dslplatform.api.Guards.checkCollectionOptionRefNulls(oneSetOfNullableTimestamps)
    require(oneSetOfNullableTimestamps ne null, "Null value was provided for property \"oneSetOfNullableTimestamps\"")
    new OneSetOfNullableTimestamps_6(
      __locator = None
