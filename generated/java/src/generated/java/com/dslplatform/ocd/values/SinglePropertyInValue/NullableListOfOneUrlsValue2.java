...
public final class NullableListOfOneUrlsValue2 implements java.io.Serializable {
    public NullableListOfOneUrlsValue2(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1382417089;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof NullableListOfOneUrlsValue2)) return false;
        final NullableListOfOneUrlsValue2 other = (NullableListOfOneUrlsValue2) obj;
    ...
    public String toString() {
        return "NullableListOfOneUrlsValue2(" + nullableListOfOneUrls + ')';
    }
    ...
    public NullableListOfOneUrlsValue2 setNullableListOfOneUrls(
