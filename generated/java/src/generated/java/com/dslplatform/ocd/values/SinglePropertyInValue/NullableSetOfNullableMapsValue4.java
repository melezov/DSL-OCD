...
public final class NullableSetOfNullableMapsValue4 implements
        java.io.Serializable {
    public NullableSetOfNullableMapsValue4(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1947014003;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof NullableSetOfNullableMapsValue4)) return false;
        final NullableSetOfNullableMapsValue4 other = (NullableSetOfNullableMapsValue4) obj;
    ...
    public String toString() {
        return "NullableSetOfNullableMapsValue4(" + nullableSetOfNullableMaps
                + ')';
    }
    ...
    public NullableSetOfNullableMapsValue4 setNullableSetOfNullableMaps(
