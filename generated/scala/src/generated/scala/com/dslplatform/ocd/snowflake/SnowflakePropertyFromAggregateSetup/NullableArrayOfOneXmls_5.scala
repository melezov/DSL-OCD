...
class NullableArrayOfOneXmls_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableArrayOfOneXmls_5 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableArrayOfOneXmls_5("+ URI +")"

   def copy(nullableArrayOfOneXmls: Option[Array[scala.xml.Elem]] = this._nullableArrayOfOneXmls): NullableArrayOfOneXmls_5 = {
  ...
  com.dslplatform.api.Guards.checkArrayNulls(nullableArrayOfOneXmls)
    new NullableArrayOfOneXmls_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableArrayOfOneXmls = nullableArrayOfOneXmls)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableArrayOfOneXmls_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableArrayOfOneXmls_5](URI), duration)
  }
...
object NullableArrayOfOneXmls_5 extends AggregateRootCompanion[NullableArrayOfOneXmls_5]{
