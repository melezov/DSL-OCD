...
public final class OneArrayOfNullableIntegersValue1 implements
        java.io.Serializable {
    public OneArrayOfNullableIntegersValue1(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1682676528;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfNullableIntegersValue1)) return false;
        final OneArrayOfNullableIntegersValue1 other = (OneArrayOfNullableIntegersValue1) obj;
    ...
    public String toString() {
        return "OneArrayOfNullableIntegersValue1(" + oneArrayOfNullableIntegers
                + ')';
    }
    ...
    public OneArrayOfNullableIntegersValue1 setOneArrayOfNullableIntegers(
            final Integer[] value) {
        if (value == null)
