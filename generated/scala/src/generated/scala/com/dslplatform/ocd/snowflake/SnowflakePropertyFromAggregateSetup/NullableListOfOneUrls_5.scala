...
class NullableListOfOneUrls_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableListOfOneUrls_5 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableListOfOneUrls_5("+ URI +")"

   def copy(nullableListOfOneUrls: Option[IndexedSeq[java.net.URI]] = this._nullableListOfOneUrls): NullableListOfOneUrls_5 = {
  ...
  com.dslplatform.api.Guards.checkCollectionNulls(nullableListOfOneUrls)
    new NullableListOfOneUrls_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableListOfOneUrls = nullableListOfOneUrls)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableListOfOneUrls_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableListOfOneUrls_5](URI), duration)
  }
...
object NullableListOfOneUrls_5 extends AggregateRootCompanion[NullableListOfOneUrls_5]{
