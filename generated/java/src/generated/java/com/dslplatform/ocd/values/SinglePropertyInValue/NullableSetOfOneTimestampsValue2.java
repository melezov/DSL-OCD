...
public final class NullableSetOfOneTimestampsValue2 implements
        java.io.Serializable {
    public NullableSetOfOneTimestampsValue2(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 2083773048;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof NullableSetOfOneTimestampsValue2)) return false;
        final NullableSetOfOneTimestampsValue2 other = (NullableSetOfOneTimestampsValue2) obj;
    ...
    public String toString() {
        return "NullableSetOfOneTimestampsValue2(" + nullableSetOfOneTimestamps
                + ')';
    }
    ...
    public NullableSetOfOneTimestampsValue2 setNullableSetOfOneTimestamps(
