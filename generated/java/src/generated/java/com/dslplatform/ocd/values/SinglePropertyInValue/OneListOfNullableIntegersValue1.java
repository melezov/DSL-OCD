...
public final class OneListOfNullableIntegersValue1 implements
        java.io.Serializable {
    public OneListOfNullableIntegersValue1(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1062354017;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneListOfNullableIntegersValue1)) return false;
        final OneListOfNullableIntegersValue1 other = (OneListOfNullableIntegersValue1) obj;
    ...
    public String toString() {
        return "OneListOfNullableIntegersValue1(" + oneListOfNullableIntegers
                + ')';
    }
    ...
    public OneListOfNullableIntegersValue1 setOneListOfNullableIntegers(
