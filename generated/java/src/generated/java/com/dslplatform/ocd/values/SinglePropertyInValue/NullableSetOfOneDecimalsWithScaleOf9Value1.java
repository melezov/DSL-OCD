...
public final class NullableSetOfOneDecimalsWithScaleOf9Value1 implements
        java.io.Serializable {
    public NullableSetOfOneDecimalsWithScaleOf9Value1(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 2030696378;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof NullableSetOfOneDecimalsWithScaleOf9Value1))
            return false;
        final NullableSetOfOneDecimalsWithScaleOf9Value1 other = (NullableSetOfOneDecimalsWithScaleOf9Value1) obj;
    ...
    public String toString() {
        return "NullableSetOfOneDecimalsWithScaleOf9Value1("
    ...
    public NullableSetOfOneDecimalsWithScaleOf9Value1 setNullableSetOfOneDecimalsWithScaleOf9(
