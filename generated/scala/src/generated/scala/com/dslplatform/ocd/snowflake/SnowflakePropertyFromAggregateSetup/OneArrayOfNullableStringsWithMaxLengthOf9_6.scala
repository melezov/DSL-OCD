...
class OneArrayOfNullableStringsWithMaxLengthOf9_6 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: OneArrayOfNullableStringsWithMaxLengthOf9_6 => c.URI == URI
    case _ => false
  }

  override def toString = "OneArrayOfNullableStringsWithMaxLengthOf9_6("+ URI +")"

   def copy(oneArrayOfNullableStringsWithMaxLengthOf9: Array[Option[String]] = this._oneArrayOfNullableStringsWithMaxLengthOf9): OneArrayOfNullableStringsWithMaxLengthOf9_6 = {
  ...
  com.dslplatform.api.Guards.checkArrayOptionRefNulls(oneArrayOfNullableStringsWithMaxLengthOf9)
    new OneArrayOfNullableStringsWithMaxLengthOf9_6(_URI = this.URI, __locator = this.__locator, _ID = _ID, _oneArrayOfNullableStringsWithMaxLengthOf9 = oneArrayOfNullableStringsWithMaxLengthOf9)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneArrayOfNullableStringsWithMaxLengthOf9_6): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneArrayOfNullableStringsWithMaxLengthOf9_6](URI), duration)
  }
...
object OneArrayOfNullableStringsWithMaxLengthOf9_6 extends AggregateRootCompanion[OneArrayOfNullableStringsWithMaxLengthOf9_6]{
