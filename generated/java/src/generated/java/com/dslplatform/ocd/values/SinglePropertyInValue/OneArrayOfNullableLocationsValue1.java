...
public final class OneArrayOfNullableLocationsValue1 implements
        java.io.Serializable {
    public OneArrayOfNullableLocationsValue1(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1955477545;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfNullableLocationsValue1)) return false;
        final OneArrayOfNullableLocationsValue1 other = (OneArrayOfNullableLocationsValue1) obj;
    ...
    public String toString() {
        return "OneArrayOfNullableLocationsValue1("
    ...
    public OneArrayOfNullableLocationsValue1 setOneArrayOfNullableLocations(
