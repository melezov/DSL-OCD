...
public final class OneSetOfOneTimestampsValue5 implements java.io.Serializable {
    public OneSetOfOneTimestampsValue5(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1629542840;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneSetOfOneTimestampsValue5)) return false;
        final OneSetOfOneTimestampsValue5 other = (OneSetOfOneTimestampsValue5) obj;
    ...
    public String toString() {
        return "OneSetOfOneTimestampsValue5(" + oneSetOfOneTimestamps + ')';
    }
    ...
    public OneSetOfOneTimestampsValue5 setOneSetOfOneTimestamps(
