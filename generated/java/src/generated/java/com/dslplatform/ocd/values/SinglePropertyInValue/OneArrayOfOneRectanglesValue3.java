...
public final class OneArrayOfOneRectanglesValue3 implements
        java.io.Serializable {
    public OneArrayOfOneRectanglesValue3(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1355822066;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfOneRectanglesValue3)) return false;
        final OneArrayOfOneRectanglesValue3 other = (OneArrayOfOneRectanglesValue3) obj;
    ...
    public String toString() {
        return "OneArrayOfOneRectanglesValue3(" + oneArrayOfOneRectangles + ')';
    }
    ...
    public OneArrayOfOneRectanglesValue3 setOneArrayOfOneRectangles(
