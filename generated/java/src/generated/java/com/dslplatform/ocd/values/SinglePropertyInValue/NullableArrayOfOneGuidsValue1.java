...
public final class NullableArrayOfOneGuidsValue1 implements
        java.io.Serializable {
    public NullableArrayOfOneGuidsValue1(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1966111937;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof NullableArrayOfOneGuidsValue1)) return false;
        final NullableArrayOfOneGuidsValue1 other = (NullableArrayOfOneGuidsValue1) obj;
    ...
    public String toString() {
        return "NullableArrayOfOneGuidsValue1(" + nullableArrayOfOneGuids + ')';
    }
    ...
    public NullableArrayOfOneGuidsValue1 setNullableArrayOfOneGuids(
