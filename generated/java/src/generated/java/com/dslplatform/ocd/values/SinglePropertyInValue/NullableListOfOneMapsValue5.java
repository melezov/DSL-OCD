...
public final class NullableListOfOneMapsValue5 implements java.io.Serializable {
    public NullableListOfOneMapsValue5(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 2144169409;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof NullableListOfOneMapsValue5)) return false;
        final NullableListOfOneMapsValue5 other = (NullableListOfOneMapsValue5) obj;
    ...
    public String toString() {
        return "NullableListOfOneMapsValue5(" + nullableListOfOneMaps + ')';
    }
    ...
    public NullableListOfOneMapsValue5 setNullableListOfOneMaps(
