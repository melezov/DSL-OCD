...
public final class OneArrayOfNullableStringsWithMaxLengthOf9Value2 implements
        java.io.Serializable {
    public OneArrayOfNullableStringsWithMaxLengthOf9Value2(
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfNullableStringsWithMaxLengthOf9Value2))
            return false;
        final OneArrayOfNullableStringsWithMaxLengthOf9Value2 other = (OneArrayOfNullableStringsWithMaxLengthOf9Value2) obj;
    ...
    public String toString() {
        return "OneArrayOfNullableStringsWithMaxLengthOf9Value2("
    ...
    public OneArrayOfNullableStringsWithMaxLengthOf9Value2 setOneArrayOfNullableStringsWithMaxLengthOf9(
            final String[] value) {
        if (value == null)
