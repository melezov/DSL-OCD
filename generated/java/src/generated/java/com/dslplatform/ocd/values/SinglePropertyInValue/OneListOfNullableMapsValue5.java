...
public final class OneListOfNullableMapsValue5 implements java.io.Serializable {
    public OneListOfNullableMapsValue5(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1552057415;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneListOfNullableMapsValue5)) return false;
        final OneListOfNullableMapsValue5 other = (OneListOfNullableMapsValue5) obj;
    ...
    public String toString() {
        return "OneListOfNullableMapsValue5(" + oneListOfNullableMaps + ')';
    }
    ...
    public OneListOfNullableMapsValue5 setOneListOfNullableMaps(
