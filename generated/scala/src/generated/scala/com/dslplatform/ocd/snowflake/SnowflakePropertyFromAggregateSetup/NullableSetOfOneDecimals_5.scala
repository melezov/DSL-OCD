...
class NullableSetOfOneDecimals_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableSetOfOneDecimals_5 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableSetOfOneDecimals_5("+ URI +")"

   def copy(nullableSetOfOneDecimals: Option[Set[BigDecimal]] = this._nullableSetOfOneDecimals): NullableSetOfOneDecimals_5 = {
  ...
  com.dslplatform.api.Guards.checkCollectionNulls(nullableSetOfOneDecimals)
    new NullableSetOfOneDecimals_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableSetOfOneDecimals = nullableSetOfOneDecimals)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableSetOfOneDecimals_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableSetOfOneDecimals_5](URI), duration)
  }
...
object NullableSetOfOneDecimals_5 extends AggregateRootCompanion[NullableSetOfOneDecimals_5]{
  ...
  def apply(
    ...
    require(nullableSetOfOneDecimals ne null, "Null value was provided for property \"nullableSetOfOneDecimals\"")
    if (nullableSetOfOneDecimals.isDefined) require(nullableSetOfOneDecimals.get ne null, "Null value was provided for property \"nullableSetOfOneDecimals\"")
    new NullableSetOfOneDecimals_5(
      __locator = None
