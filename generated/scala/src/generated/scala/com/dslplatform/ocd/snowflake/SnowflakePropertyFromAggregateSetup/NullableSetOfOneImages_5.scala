...
class NullableSetOfOneImages_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableSetOfOneImages_5 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableSetOfOneImages_5("+ URI +")"

   def copy(nullableSetOfOneImages: Option[Set[java.awt.image.BufferedImage]] = this._nullableSetOfOneImages): NullableSetOfOneImages_5 = {
  ...
  com.dslplatform.api.Guards.checkCollectionNulls(nullableSetOfOneImages)
    new NullableSetOfOneImages_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableSetOfOneImages = nullableSetOfOneImages)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableSetOfOneImages_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableSetOfOneImages_5](URI), duration)
  }
...
object NullableSetOfOneImages_5 extends AggregateRootCompanion[NullableSetOfOneImages_5]{
