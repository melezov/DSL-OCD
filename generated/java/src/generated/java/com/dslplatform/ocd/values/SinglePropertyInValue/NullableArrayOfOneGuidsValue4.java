...
public final class NullableArrayOfOneGuidsValue4 implements
        java.io.Serializable {
    public NullableArrayOfOneGuidsValue4(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1966111932;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof NullableArrayOfOneGuidsValue4)) return false;
        final NullableArrayOfOneGuidsValue4 other = (NullableArrayOfOneGuidsValue4) obj;
    ...
    public String toString() {
        return "NullableArrayOfOneGuidsValue4(" + nullableArrayOfOneGuids + ')';
    }
    ...
    public NullableArrayOfOneGuidsValue4 setNullableArrayOfOneGuids(
