...
class NullableArrayOfNullableMonies_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableArrayOfNullableMonies_5 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableArrayOfNullableMonies_5("+ URI +")"

   def copy(nullableArrayOfNullableMonies: Option[Array[Option[BigDecimal]]] = this._nullableArrayOfNullableMonies): NullableArrayOfNullableMonies_5 = {
  ...
  com.dslplatform.api.Guards.checkArrayOptionRefNulls(nullableArrayOfNullableMonies)
    new NullableArrayOfNullableMonies_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableArrayOfNullableMonies = nullableArrayOfNullableMonies)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableArrayOfNullableMonies_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableArrayOfNullableMonies_5](URI), duration)
  }
...
object NullableArrayOfNullableMonies_5 extends AggregateRootCompanion[NullableArrayOfNullableMonies_5]{
  ...
  def apply(
    ...
    require(nullableArrayOfNullableMonies ne null, "Null value was provided for property \"nullableArrayOfNullableMonies\"")
    if (nullableArrayOfNullableMonies.isDefined) require(nullableArrayOfNullableMonies.get ne null, "Null value was provided for property \"nullableArrayOfNullableMonies\"")
    new NullableArrayOfNullableMonies_5(
      __locator = None
