...
public final class OneArrayOfOneStringsWithMaxLengthOf9Value1 implements
        java.io.Serializable {
    public OneArrayOfOneStringsWithMaxLengthOf9Value1(
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfOneStringsWithMaxLengthOf9Value1))
            return false;
        final OneArrayOfOneStringsWithMaxLengthOf9Value1 other = (OneArrayOfOneStringsWithMaxLengthOf9Value1) obj;
    ...
    public String toString() {
        return "OneArrayOfOneStringsWithMaxLengthOf9Value1("
    ...
    public OneArrayOfOneStringsWithMaxLengthOf9Value1 setOneArrayOfOneStringsWithMaxLengthOf9(
            final String[] value) {
        if (value == null)
