...
public final class NullableListOfNullableGuidsValue4 implements
        java.io.Serializable {
    public NullableListOfNullableGuidsValue4(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1962143976;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof NullableListOfNullableGuidsValue4)) return false;
        final NullableListOfNullableGuidsValue4 other = (NullableListOfNullableGuidsValue4) obj;
    ...
    public String toString() {
        return "NullableListOfNullableGuidsValue4("
    ...
    public NullableListOfNullableGuidsValue4 setNullableListOfNullableGuids(
