...
public final class OneArrayOfOneIntegersValue5 implements java.io.Serializable {
    public OneArrayOfOneIntegersValue5(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1196467557;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfOneIntegersValue5)) return false;
        final OneArrayOfOneIntegersValue5 other = (OneArrayOfOneIntegersValue5) obj;
    ...
    public String toString() {
        return "OneArrayOfOneIntegersValue5(" + oneArrayOfOneIntegers + ')';
    }
    ...
    public OneArrayOfOneIntegersValue5 setOneArrayOfOneIntegers(
            final int[] value) {
        if (value == null)
