...
public final class OneSetOfNullableMoniesValue3 implements java.io.Serializable {
    public OneSetOfNullableMoniesValue3(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1939671505;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneSetOfNullableMoniesValue3)) return false;
        final OneSetOfNullableMoniesValue3 other = (OneSetOfNullableMoniesValue3) obj;
    ...
    public String toString() {
        return "OneSetOfNullableMoniesValue3(" + oneSetOfNullableMonies + ')';
    }
    ...
    public OneSetOfNullableMoniesValue3 setOneSetOfNullableMonies(
