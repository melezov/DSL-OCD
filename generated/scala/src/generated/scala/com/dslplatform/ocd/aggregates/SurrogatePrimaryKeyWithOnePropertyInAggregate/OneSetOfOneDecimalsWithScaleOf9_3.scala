...
class OneSetOfOneDecimalsWithScaleOf9_3 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: OneSetOfOneDecimalsWithScaleOf9_3 => c.URI == URI
    case _ => false
  }

  override def toString = "OneSetOfOneDecimalsWithScaleOf9_3("+ URI +")"

   def copy(oneSetOfOneDecimalsWithScaleOf9: Set[BigDecimal] = this._oneSetOfOneDecimalsWithScaleOf9): OneSetOfOneDecimalsWithScaleOf9_3 = {
  ...
  com.dslplatform.api.Guards.checkCollectionNulls(oneSetOfOneDecimalsWithScaleOf9)
    new OneSetOfOneDecimalsWithScaleOf9_3(_URI = this.URI, __locator = this.__locator, _ID = _ID, _oneSetOfOneDecimalsWithScaleOf9 = oneSetOfOneDecimalsWithScaleOf9)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.aggregates.SurrogatePrimaryKeyWithOnePropertyInAggregate.OneSetOfOneDecimalsWithScaleOf9_3): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.aggregates.SurrogatePrimaryKeyWithOnePropertyInAggregate.OneSetOfOneDecimalsWithScaleOf9_3](URI), duration)
  }
...
object OneSetOfOneDecimalsWithScaleOf9_3 extends AggregateRootCompanion[OneSetOfOneDecimalsWithScaleOf9_3]{
  ...
  def apply(
    ...
    com.dslplatform.api.Guards.checkCollectionNulls(oneSetOfOneDecimalsWithScaleOf9)
    require(oneSetOfOneDecimalsWithScaleOf9 ne null, "Null value was provided for property \"oneSetOfOneDecimalsWithScaleOf9\"")
    new OneSetOfOneDecimalsWithScaleOf9_3(
      __locator = None
