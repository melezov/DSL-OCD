...
public final class NullableSetOfOneIntegersValue1 implements
        java.io.Serializable {
    public NullableSetOfOneIntegersValue1(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1455195713;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof NullableSetOfOneIntegersValue1)) return false;
        final NullableSetOfOneIntegersValue1 other = (NullableSetOfOneIntegersValue1) obj;
    ...
    public String toString() {
        return "NullableSetOfOneIntegersValue1(" + nullableSetOfOneIntegers
                + ')';
    }
    ...
    public NullableSetOfOneIntegersValue1 setNullableSetOfOneIntegers(
