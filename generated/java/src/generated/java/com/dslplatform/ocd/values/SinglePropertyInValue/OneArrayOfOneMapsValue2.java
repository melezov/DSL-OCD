...
public final class OneArrayOfOneMapsValue2 implements java.io.Serializable {
    public OneArrayOfOneMapsValue2(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1240123332;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfOneMapsValue2)) return false;
        final OneArrayOfOneMapsValue2 other = (OneArrayOfOneMapsValue2) obj;
    ...
    public String toString() {
        return "OneArrayOfOneMapsValue2(" + oneArrayOfOneMaps + ')';
    }
    ...
    public OneArrayOfOneMapsValue2 setOneArrayOfOneMaps(
