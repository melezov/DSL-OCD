...
public final class OneArrayOfNullableXmlsValue6 implements java.io.Serializable {
    public OneArrayOfNullableXmlsValue6(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1444818544;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfNullableXmlsValue6)) return false;
        final OneArrayOfNullableXmlsValue6 other = (OneArrayOfNullableXmlsValue6) obj;
    ...
    public String toString() {
        return "OneArrayOfNullableXmlsValue6(" + oneArrayOfNullableXmls + ')';
    }
    ...
    public OneArrayOfNullableXmlsValue6 setOneArrayOfNullableXmls(
