...
public final class OneArrayOfNullableMoniesValue1 implements
        java.io.Serializable {
    public OneArrayOfNullableMoniesValue1(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1494717390;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfNullableMoniesValue1)) return false;
        final OneArrayOfNullableMoniesValue1 other = (OneArrayOfNullableMoniesValue1) obj;
    ...
    public String toString() {
        return "OneArrayOfNullableMoniesValue1(" + oneArrayOfNullableMonies
                + ')';
    }
    ...
    public OneArrayOfNullableMoniesValue1 setOneArrayOfNullableMonies(
