...
class NullableArrayOfNullableRectangles_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableArrayOfNullableRectangles_5 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableArrayOfNullableRectangles_5("+ URI +")"

   def copy(nullableArrayOfNullableRectangles: Option[Array[Option[java.awt.geom.Rectangle2D]]] = this._nullableArrayOfNullableRectangles): NullableArrayOfNullableRectangles_5 = {
  ...
  com.dslplatform.api.Guards.checkArrayOptionRefNulls(nullableArrayOfNullableRectangles)
    new NullableArrayOfNullableRectangles_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableArrayOfNullableRectangles = nullableArrayOfNullableRectangles)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableArrayOfNullableRectangles_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableArrayOfNullableRectangles_5](URI), duration)
  }
...
object NullableArrayOfNullableRectangles_5 extends AggregateRootCompanion[NullableArrayOfNullableRectangles_5]{
  ...
  def apply(
    ...
    require(nullableArrayOfNullableRectangles ne null, "Null value was provided for property \"nullableArrayOfNullableRectangles\"")
    if (nullableArrayOfNullableRectangles.isDefined) require(nullableArrayOfNullableRectangles.get ne null, "Null value was provided for property \"nullableArrayOfNullableRectangles\"")
    new NullableArrayOfNullableRectangles_5(
      __locator = None
