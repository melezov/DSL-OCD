...
class NullableSetOfNullableIntegers_2 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableSetOfNullableIntegers_2 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableSetOfNullableIntegers_2("+ URI +")"

   def copy(nullableSetOfNullableIntegers: Option[Set[Option[Int]]] = this._nullableSetOfNullableIntegers): NullableSetOfNullableIntegers_2 = {
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.aggregates.SurrogatePrimaryKeyWithOnePropertyInAggregate.NullableSetOfNullableIntegers_2): this.type = {
...
object NullableSetOfNullableIntegers_2 extends AggregateRootCompanion[NullableSetOfNullableIntegers_2]{
  ...
  def apply(
    ...
    require(nullableSetOfNullableIntegers ne null, "Null value was provided for property \"nullableSetOfNullableIntegers\"")
    if (nullableSetOfNullableIntegers.isDefined) require(nullableSetOfNullableIntegers.get ne null, "Null value was provided for property \"nullableSetOfNullableIntegers\"")
    new NullableSetOfNullableIntegers_2(
      __locator = None
