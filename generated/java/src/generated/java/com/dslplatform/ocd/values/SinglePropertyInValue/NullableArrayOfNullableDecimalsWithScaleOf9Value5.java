...
public final class NullableArrayOfNullableDecimalsWithScaleOf9Value5 implements
        java.io.Serializable {
    public NullableArrayOfNullableDecimalsWithScaleOf9Value5(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1782710798;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof NullableArrayOfNullableDecimalsWithScaleOf9Value5))
            return false;
        final NullableArrayOfNullableDecimalsWithScaleOf9Value5 other = (NullableArrayOfNullableDecimalsWithScaleOf9Value5) obj;
    ...
    public String toString() {
        return "NullableArrayOfNullableDecimalsWithScaleOf9Value5("
    ...
    public NullableArrayOfNullableDecimalsWithScaleOf9Value5 setNullableArrayOfNullableDecimalsWithScaleOf9(
