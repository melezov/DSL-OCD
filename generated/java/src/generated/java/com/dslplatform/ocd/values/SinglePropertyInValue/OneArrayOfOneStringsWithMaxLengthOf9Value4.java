...
public final class OneArrayOfOneStringsWithMaxLengthOf9Value4 implements
        java.io.Serializable {
    public OneArrayOfOneStringsWithMaxLengthOf9Value4(
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfOneStringsWithMaxLengthOf9Value4))
            return false;
        final OneArrayOfOneStringsWithMaxLengthOf9Value4 other = (OneArrayOfOneStringsWithMaxLengthOf9Value4) obj;
    ...
    public String toString() {
        return "OneArrayOfOneStringsWithMaxLengthOf9Value4("
    ...
    public OneArrayOfOneStringsWithMaxLengthOf9Value4 setOneArrayOfOneStringsWithMaxLengthOf9(
            final String[] value) {
        if (value == null)
