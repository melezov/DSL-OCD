...
class OneArrayOfNullableDecimalsWithScaleOf9_6 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: OneArrayOfNullableDecimalsWithScaleOf9_6 => c.URI == URI
    case _ => false
  }

  override def toString = "OneArrayOfNullableDecimalsWithScaleOf9_6("+ URI +")"

   def copy(oneArrayOfNullableDecimalsWithScaleOf9: Array[Option[BigDecimal]] = this._oneArrayOfNullableDecimalsWithScaleOf9): OneArrayOfNullableDecimalsWithScaleOf9_6 = {
  ...
  com.dslplatform.api.Guards.checkArrayOptionRefNulls(oneArrayOfNullableDecimalsWithScaleOf9)
    new OneArrayOfNullableDecimalsWithScaleOf9_6(_URI = this.URI, __locator = this.__locator, _ID = _ID, _oneArrayOfNullableDecimalsWithScaleOf9 = oneArrayOfNullableDecimalsWithScaleOf9)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneArrayOfNullableDecimalsWithScaleOf9_6): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneArrayOfNullableDecimalsWithScaleOf9_6](URI), duration)
  }
...
object OneArrayOfNullableDecimalsWithScaleOf9_6 extends AggregateRootCompanion[OneArrayOfNullableDecimalsWithScaleOf9_6]{
