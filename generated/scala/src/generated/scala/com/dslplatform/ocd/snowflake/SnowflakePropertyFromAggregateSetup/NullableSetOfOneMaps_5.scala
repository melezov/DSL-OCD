...
class NullableSetOfOneMaps_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableSetOfOneMaps_5 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableSetOfOneMaps_5("+ URI +")"

   def copy(nullableSetOfOneMaps: Option[Set[Map[String, String]]] = this._nullableSetOfOneMaps): NullableSetOfOneMaps_5 = {
  ...
  com.dslplatform.api.Guards.checkCollectionNulls(nullableSetOfOneMaps)
    new NullableSetOfOneMaps_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableSetOfOneMaps = nullableSetOfOneMaps)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableSetOfOneMaps_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableSetOfOneMaps_5](URI), duration)
  }
...
object NullableSetOfOneMaps_5 extends AggregateRootCompanion[NullableSetOfOneMaps_5]{
