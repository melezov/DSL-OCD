...
public final class NullableArrayOfOneStringsWithMaxLengthOf9Value6 implements
        java.io.Serializable {
    public NullableArrayOfOneStringsWithMaxLengthOf9Value6(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1378079536;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof NullableArrayOfOneStringsWithMaxLengthOf9Value6))
            return false;
        final NullableArrayOfOneStringsWithMaxLengthOf9Value6 other = (NullableArrayOfOneStringsWithMaxLengthOf9Value6) obj;
    ...
    public String toString() {
        return "NullableArrayOfOneStringsWithMaxLengthOf9Value6("
    ...
    public NullableArrayOfOneStringsWithMaxLengthOf9Value6 setNullableArrayOfOneStringsWithMaxLengthOf9(
            final String[] value) {
