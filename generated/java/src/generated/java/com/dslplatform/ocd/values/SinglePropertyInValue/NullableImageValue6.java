...
public final class NullableImageValue6 implements java.io.Serializable {
    public NullableImageValue6(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1826675755;
        result = prime
                * result
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof NullableImageValue6)) return false;
        final NullableImageValue6 other = (NullableImageValue6) obj;
    ...
    public String toString() {
        return "NullableImageValue6(" + nullableImage + ')';
    }
    ...
    public NullableImageValue6 setNullableImage(
