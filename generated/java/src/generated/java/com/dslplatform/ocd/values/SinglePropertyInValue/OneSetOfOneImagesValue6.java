...
public final class OneSetOfOneImagesValue6 implements java.io.Serializable {
    public OneSetOfOneImagesValue6(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1567651106;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneSetOfOneImagesValue6)) return false;
        final OneSetOfOneImagesValue6 other = (OneSetOfOneImagesValue6) obj;
    ...
    public String toString() {
        return "OneSetOfOneImagesValue6(" + oneSetOfOneImages + ')';
    }
    ...
    public OneSetOfOneImagesValue6 setOneSetOfOneImages(
