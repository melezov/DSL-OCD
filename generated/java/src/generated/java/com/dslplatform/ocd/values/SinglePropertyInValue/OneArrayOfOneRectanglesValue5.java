...
public final class OneArrayOfOneRectanglesValue5 implements
        java.io.Serializable {
    public OneArrayOfOneRectanglesValue5(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1355822060;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfOneRectanglesValue5)) return false;
        final OneArrayOfOneRectanglesValue5 other = (OneArrayOfOneRectanglesValue5) obj;
    ...
    public String toString() {
        return "OneArrayOfOneRectanglesValue5(" + oneArrayOfOneRectangles + ')';
    }
    ...
    public OneArrayOfOneRectanglesValue5 setOneArrayOfOneRectangles(
