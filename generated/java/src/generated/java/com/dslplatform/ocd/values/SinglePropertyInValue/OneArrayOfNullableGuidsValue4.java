...
public final class OneArrayOfNullableGuidsValue4 implements
        java.io.Serializable {
    public OneArrayOfNullableGuidsValue4(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1455438860;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfNullableGuidsValue4)) return false;
        final OneArrayOfNullableGuidsValue4 other = (OneArrayOfNullableGuidsValue4) obj;
    ...
    public String toString() {
        return "OneArrayOfNullableGuidsValue4(" + oneArrayOfNullableGuids + ')';
    }
    ...
    public OneArrayOfNullableGuidsValue4 setOneArrayOfNullableGuids(
