...
public final class NullableArrayOfNullableRectanglesValue3 implements
        java.io.Serializable {
    public NullableArrayOfNullableRectanglesValue3(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1536912296;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof NullableArrayOfNullableRectanglesValue3))
            return false;
        final NullableArrayOfNullableRectanglesValue3 other = (NullableArrayOfNullableRectanglesValue3) obj;
    ...
    public String toString() {
        return "NullableArrayOfNullableRectanglesValue3("
    ...
    public NullableArrayOfNullableRectanglesValue3 setNullableArrayOfNullableRectangles(
