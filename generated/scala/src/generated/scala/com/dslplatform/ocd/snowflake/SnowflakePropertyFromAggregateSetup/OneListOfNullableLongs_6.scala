...
class OneListOfNullableLongs_6 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: OneListOfNullableLongs_6 => c.URI == URI
    case _ => false
  }

  override def toString = "OneListOfNullableLongs_6("+ URI +")"

   def copy(oneListOfNullableLongs: IndexedSeq[Option[Long]] = this._oneListOfNullableLongs): OneListOfNullableLongs_6 = {
  ...
  com.dslplatform.api.Guards.checkCollectionOptionValNulls(oneListOfNullableLongs)
    new OneListOfNullableLongs_6(_URI = this.URI, __locator = this.__locator, _ID = _ID, _oneListOfNullableLongs = oneListOfNullableLongs)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneListOfNullableLongs_6): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneListOfNullableLongs_6](URI), duration)
  }
...
object OneListOfNullableLongs_6 extends AggregateRootCompanion[OneListOfNullableLongs_6]{
