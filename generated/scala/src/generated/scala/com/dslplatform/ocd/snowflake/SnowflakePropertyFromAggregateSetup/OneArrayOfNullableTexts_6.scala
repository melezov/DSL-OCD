...
class OneArrayOfNullableTexts_6 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: OneArrayOfNullableTexts_6 => c.URI == URI
    case _ => false
  }

  override def toString = "OneArrayOfNullableTexts_6("+ URI +")"

   def copy(oneArrayOfNullableTexts: Array[Option[String]] = this._oneArrayOfNullableTexts): OneArrayOfNullableTexts_6 = {
  ...
  com.dslplatform.api.Guards.checkArrayOptionRefNulls(oneArrayOfNullableTexts)
    new OneArrayOfNullableTexts_6(_URI = this.URI, __locator = this.__locator, _ID = _ID, _oneArrayOfNullableTexts = oneArrayOfNullableTexts)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneArrayOfNullableTexts_6): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneArrayOfNullableTexts_6](URI), duration)
  }
...
object OneArrayOfNullableTexts_6 extends AggregateRootCompanion[OneArrayOfNullableTexts_6]{
