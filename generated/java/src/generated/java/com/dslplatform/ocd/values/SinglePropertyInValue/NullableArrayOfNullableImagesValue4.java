...
public final class NullableArrayOfNullableImagesValue4 implements
        java.io.Serializable {
    public NullableArrayOfNullableImagesValue4(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 2023801859;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof NullableArrayOfNullableImagesValue4))
            return false;
        final NullableArrayOfNullableImagesValue4 other = (NullableArrayOfNullableImagesValue4) obj;
    ...
    public String toString() {
        return "NullableArrayOfNullableImagesValue4("
    ...
    public NullableArrayOfNullableImagesValue4 setNullableArrayOfNullableImages(
