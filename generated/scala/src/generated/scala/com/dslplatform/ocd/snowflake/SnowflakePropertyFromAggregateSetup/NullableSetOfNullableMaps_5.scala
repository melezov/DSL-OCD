...
class NullableSetOfNullableMaps_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableSetOfNullableMaps_5 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableSetOfNullableMaps_5("+ URI +")"

   def copy(nullableSetOfNullableMaps: Option[Set[Option[Map[String, String]]]] = this._nullableSetOfNullableMaps): NullableSetOfNullableMaps_5 = {
  ...
  com.dslplatform.api.Guards.checkCollectionOptionRefNulls(nullableSetOfNullableMaps)
    new NullableSetOfNullableMaps_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableSetOfNullableMaps = nullableSetOfNullableMaps)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableSetOfNullableMaps_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableSetOfNullableMaps_5](URI), duration)
  }
...
object NullableSetOfNullableMaps_5 extends AggregateRootCompanion[NullableSetOfNullableMaps_5]{
  ...
  def apply(
    ...
    require(nullableSetOfNullableMaps ne null, "Null value was provided for property \"nullableSetOfNullableMaps\"")
    if (nullableSetOfNullableMaps.isDefined) require(nullableSetOfNullableMaps.get ne null, "Null value was provided for property \"nullableSetOfNullableMaps\"")
    new NullableSetOfNullableMaps_5(
      __locator = None
