...
class NullableListOfOneDates_2 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableListOfOneDates_2 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableListOfOneDates_2("+ URI +")"

   def copy(nullableListOfOneDates: Option[IndexedSeq[org.joda.time.LocalDate]] = this._nullableListOfOneDates): NullableListOfOneDates_2 = {
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.aggregates.SurrogatePrimaryKeyWithOnePropertyInAggregate.NullableListOfOneDates_2): this.type = {
...
object NullableListOfOneDates_2 extends AggregateRootCompanion[NullableListOfOneDates_2]{
