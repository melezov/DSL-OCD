...
class OneSetOfNullablePoints_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: OneSetOfNullablePoints_5 => c.URI == URI
    case _ => false
  }

  override def toString = "OneSetOfNullablePoints_5("+ URI +")"

   def copy(oneSetOfNullablePoints: Set[Option[java.awt.geom.Point2D]] = this._oneSetOfNullablePoints): OneSetOfNullablePoints_5 = {
  ...
  com.dslplatform.api.Guards.checkCollectionOptionRefNulls(oneSetOfNullablePoints)
    new OneSetOfNullablePoints_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _oneSetOfNullablePoints = oneSetOfNullablePoints)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneSetOfNullablePoints_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneSetOfNullablePoints_5](URI), duration)
  }
...
object OneSetOfNullablePoints_5 extends AggregateRootCompanion[OneSetOfNullablePoints_5]{
