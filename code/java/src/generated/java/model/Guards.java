...
public final class Guards {
    ...
    public static List<BigDecimal> setScale(final List<BigDecimal> values,
            final int scale) {
    ...
    public static Set<BigDecimal> setScale(final Set<BigDecimal> values,
            final int scale) {
        if (values == null) return null;
    ...
    public static BigDecimal[] setScale(final BigDecimal[] values,
            final int scale) {
        if (values == null) return null;
    ...
    public static void checkLength(final Iterable<String> values,
            final int length) {
        if (values == null) return;
    ...
    public static boolean compareBigDecimal(final Iterable<BigDecimal> left,
    ...
    public static boolean compareBigDecimal(final BigDecimal[] left,
    ...
    public static boolean compareBigDecimal(final Set<BigDecimal> left,
    ...
    public static boolean compareBinary(final Iterable<byte[]> left,
    ...
    public static boolean compareBinary(final byte[][] left,
            final byte[][] right) {
        if (left == null && right == null) return true;
        if (left == null || right == null) return false;
    ...
    public static boolean compareBinary(final Set<byte[]> left,
