...
public final class OneSetOfNullableDatesValue1 implements java.io.Serializable {
    public OneSetOfNullableDatesValue1(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1393765001;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneSetOfNullableDatesValue1)) return false;
        final OneSetOfNullableDatesValue1 other = (OneSetOfNullableDatesValue1) obj;
    ...
    public String toString() {
        return "OneSetOfNullableDatesValue1(" + oneSetOfNullableDates + ')';
    }
    ...
    public OneSetOfNullableDatesValue1 setOneSetOfNullableDates(
