...
class OneListOfNullableBinaries_3 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: OneListOfNullableBinaries_3 => c.URI == URI
    case _ => false
  }

  override def toString = "OneListOfNullableBinaries_3("+ URI +")"

   def copy(oneListOfNullableBinaries: IndexedSeq[Option[Array[Byte]]] = this._oneListOfNullableBinaries): OneListOfNullableBinaries_3 = {
  ...
  com.dslplatform.api.Guards.checkCollectionOptionRefNulls(oneListOfNullableBinaries)
    new OneListOfNullableBinaries_3(_URI = this.URI, __locator = this.__locator, _ID = _ID, _oneListOfNullableBinaries = oneListOfNullableBinaries)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.aggregates.SurrogatePrimaryKeyWithOnePropertyInAggregate.OneListOfNullableBinaries_3): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.aggregates.SurrogatePrimaryKeyWithOnePropertyInAggregate.OneListOfNullableBinaries_3](URI), duration)
  }
...
object OneListOfNullableBinaries_3 extends AggregateRootCompanion[OneListOfNullableBinaries_3]{
  ...
  def apply(
    ...
    com.dslplatform.api.Guards.checkCollectionOptionRefNulls(oneListOfNullableBinaries)
    require(oneListOfNullableBinaries ne null, "Null value was provided for property \"oneListOfNullableBinaries\"")
    new OneListOfNullableBinaries_3(
      __locator = None
