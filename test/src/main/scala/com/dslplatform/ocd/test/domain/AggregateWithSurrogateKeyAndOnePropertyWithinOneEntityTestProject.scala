...
object AggregateWithSurrogateKeyAndOnePropertyWithinOneEntityTestProject {
  private val setups = AggregateWithSurrogateKeyAndOnePropertyWithinOneEntitySetup.setups
