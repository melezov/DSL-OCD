...
class OneSetOfNullableBinaries_3 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: OneSetOfNullableBinaries_3 => c.URI == URI
    case _ => false
  }

  override def toString = "OneSetOfNullableBinaries_3("+ URI +")"

   def copy(oneSetOfNullableBinaries: Set[Option[Array[Byte]]] = this._oneSetOfNullableBinaries): OneSetOfNullableBinaries_3 = {
  ...
  com.dslplatform.api.Guards.checkCollectionOptionRefNulls(oneSetOfNullableBinaries)
    new OneSetOfNullableBinaries_3(_URI = this.URI, __locator = this.__locator, _ID = _ID, _oneSetOfNullableBinaries = oneSetOfNullableBinaries)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.aggregates.SurrogatePrimaryKeyWithOnePropertyInAggregate.OneSetOfNullableBinaries_3): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.aggregates.SurrogatePrimaryKeyWithOnePropertyInAggregate.OneSetOfNullableBinaries_3](URI), duration)
  }
...
object OneSetOfNullableBinaries_3 extends AggregateRootCompanion[OneSetOfNullableBinaries_3]{
  ...
  def apply(
    ...
    com.dslplatform.api.Guards.checkCollectionOptionRefNulls(oneSetOfNullableBinaries)
    require(oneSetOfNullableBinaries ne null, "Null value was provided for property \"oneSetOfNullableBinaries\"")
    new OneSetOfNullableBinaries_3(
      __locator = None
