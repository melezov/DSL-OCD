...
class NullableArrayOfNullablePoints_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableArrayOfNullablePoints_5 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableArrayOfNullablePoints_5("+ URI +")"

   def copy(nullableArrayOfNullablePoints: Option[Array[Option[java.awt.geom.Point2D]]] = this._nullableArrayOfNullablePoints): NullableArrayOfNullablePoints_5 = {
  ...
  com.dslplatform.api.Guards.checkArrayOptionRefNulls(nullableArrayOfNullablePoints)
    new NullableArrayOfNullablePoints_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableArrayOfNullablePoints = nullableArrayOfNullablePoints)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableArrayOfNullablePoints_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableArrayOfNullablePoints_5](URI), duration)
  }
...
object NullableArrayOfNullablePoints_5 extends AggregateRootCompanion[NullableArrayOfNullablePoints_5]{
  ...
  def apply(
    ...
    require(nullableArrayOfNullablePoints ne null, "Null value was provided for property \"nullableArrayOfNullablePoints\"")
    if (nullableArrayOfNullablePoints.isDefined) require(nullableArrayOfNullablePoints.get ne null, "Null value was provided for property \"nullableArrayOfNullablePoints\"")
    new NullableArrayOfNullablePoints_5(
      __locator = None
