...
class NullableListOfOneDoubles_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableListOfOneDoubles_5 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableListOfOneDoubles_5("+ URI +")"

   def copy(nullableListOfOneDoubles: Option[IndexedSeq[Double]] = this._nullableListOfOneDoubles): NullableListOfOneDoubles_5 = {
  ...
  if(nullableListOfOneDoubles.isDefined) require(nullableListOfOneDoubles.get ne null, "Null value was provided for property \"nullableListOfOneDoubles\"")
    new NullableListOfOneDoubles_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableListOfOneDoubles = nullableListOfOneDoubles)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableListOfOneDoubles_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableListOfOneDoubles_5](URI), duration)
  }
...
object NullableListOfOneDoubles_5 extends AggregateRootCompanion[NullableListOfOneDoubles_5]{
  ...
  def apply(
    ...
    require(nullableListOfOneDoubles ne null, "Null value was provided for property \"nullableListOfOneDoubles\"")
    if (nullableListOfOneDoubles.isDefined) require(nullableListOfOneDoubles.get ne null, "Null value was provided for property \"nullableListOfOneDoubles\"")
    new NullableListOfOneDoubles_5(
      __locator = None
