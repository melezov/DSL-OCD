...
public final class OneSetOfNullableBooleansValue4 implements
        java.io.Serializable {
    public OneSetOfNullableBooleansValue4(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1787857900;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneSetOfNullableBooleansValue4)) return false;
        final OneSetOfNullableBooleansValue4 other = (OneSetOfNullableBooleansValue4) obj;
    ...
    public String toString() {
        return "OneSetOfNullableBooleansValue4(" + oneSetOfNullableBooleans
                + ')';
    }
    ...
    public OneSetOfNullableBooleansValue4 setOneSetOfNullableBooleans(
