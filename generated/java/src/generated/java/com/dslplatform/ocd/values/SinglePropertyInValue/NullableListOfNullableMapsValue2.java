...
public final class NullableListOfNullableMapsValue2 implements
        java.io.Serializable {
    public NullableListOfNullableMapsValue2(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1585884777;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof NullableListOfNullableMapsValue2)) return false;
        final NullableListOfNullableMapsValue2 other = (NullableListOfNullableMapsValue2) obj;
    ...
    public String toString() {
        return "NullableListOfNullableMapsValue2(" + nullableListOfNullableMaps
                + ')';
    }
    ...
    public NullableListOfNullableMapsValue2 setNullableListOfNullableMaps(
