...
class OneListOfNullableDecimalsWithScaleOf9_6 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: OneListOfNullableDecimalsWithScaleOf9_6 => c.URI == URI
    case _ => false
  }

  override def toString = "OneListOfNullableDecimalsWithScaleOf9_6("+ URI +")"

   def copy(oneListOfNullableDecimalsWithScaleOf9: IndexedSeq[Option[BigDecimal]] = this._oneListOfNullableDecimalsWithScaleOf9): OneListOfNullableDecimalsWithScaleOf9_6 = {
  ...
  com.dslplatform.api.Guards.checkCollectionOptionRefNulls(oneListOfNullableDecimalsWithScaleOf9)
    new OneListOfNullableDecimalsWithScaleOf9_6(_URI = this.URI, __locator = this.__locator, _ID = _ID, _oneListOfNullableDecimalsWithScaleOf9 = oneListOfNullableDecimalsWithScaleOf9)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneListOfNullableDecimalsWithScaleOf9_6): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneListOfNullableDecimalsWithScaleOf9_6](URI), duration)
  }
...
object OneListOfNullableDecimalsWithScaleOf9_6 extends AggregateRootCompanion[OneListOfNullableDecimalsWithScaleOf9_6]{
