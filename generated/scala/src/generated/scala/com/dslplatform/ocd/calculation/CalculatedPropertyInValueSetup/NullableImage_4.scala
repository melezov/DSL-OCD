...
case class NullableImage_4 @com.fasterxml.jackson.annotation.JsonIgnore() (
     nullableImage: Option[java.awt.image.BufferedImage] = None,
     calculatedNullableImage: Option[java.awt.image.BufferedImage] = None,
     persistedNullableImage: Option[java.awt.image.BufferedImage] = None
  ) {
  ...
  , @com.fasterxml.jackson.annotation.JsonProperty("persistedNullableImage") persistedNullableImage: Option[java.awt.image.BufferedImage]
    ...
    this( nullableImage = nullableImage, calculatedNullableImage = calculatedNullableImage, persistedNullableImage = persistedNullableImage)
