...
public final class NullableArrayOfOneXmlsValue2 implements java.io.Serializable {
    public NullableArrayOfOneXmlsValue2(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1737920396;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof NullableArrayOfOneXmlsValue2)) return false;
        final NullableArrayOfOneXmlsValue2 other = (NullableArrayOfOneXmlsValue2) obj;
    ...
    public String toString() {
        return "NullableArrayOfOneXmlsValue2(" + nullableArrayOfOneXmls + ')';
    }
    ...
    public NullableArrayOfOneXmlsValue2 setNullableArrayOfOneXmls(
