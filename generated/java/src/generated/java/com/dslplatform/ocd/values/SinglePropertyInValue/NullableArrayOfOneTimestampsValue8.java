...
public final class NullableArrayOfOneTimestampsValue8 implements
        java.io.Serializable {
    public NullableArrayOfOneTimestampsValue8(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 2031998737;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof NullableArrayOfOneTimestampsValue8)) return false;
        final NullableArrayOfOneTimestampsValue8 other = (NullableArrayOfOneTimestampsValue8) obj;
    ...
    public String toString() {
        return "NullableArrayOfOneTimestampsValue8("
    ...
    public NullableArrayOfOneTimestampsValue8 setNullableArrayOfOneTimestamps(
