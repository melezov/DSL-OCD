...
class NullableArrayOfOneDoubles_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableArrayOfOneDoubles_5 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableArrayOfOneDoubles_5("+ URI +")"

   def copy(nullableArrayOfOneDoubles: Option[Array[Double]] = this._nullableArrayOfOneDoubles): NullableArrayOfOneDoubles_5 = {
  ...
  if(nullableArrayOfOneDoubles.isDefined) require(nullableArrayOfOneDoubles.get ne null, "Null value was provided for property \"nullableArrayOfOneDoubles\"")
    new NullableArrayOfOneDoubles_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableArrayOfOneDoubles = nullableArrayOfOneDoubles)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableArrayOfOneDoubles_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableArrayOfOneDoubles_5](URI), duration)
  }
...
object NullableArrayOfOneDoubles_5 extends AggregateRootCompanion[NullableArrayOfOneDoubles_5]{
  ...
  def apply(
    ...
    require(nullableArrayOfOneDoubles ne null, "Null value was provided for property \"nullableArrayOfOneDoubles\"")
    if (nullableArrayOfOneDoubles.isDefined) require(nullableArrayOfOneDoubles.get ne null, "Null value was provided for property \"nullableArrayOfOneDoubles\"")
    new NullableArrayOfOneDoubles_5(
      __locator = None
