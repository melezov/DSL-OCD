...
public final class OneArrayOfOneBooleansValue4 implements java.io.Serializable {
    public OneArrayOfOneBooleansValue4(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 2015824280;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfOneBooleansValue4)) return false;
        final OneArrayOfOneBooleansValue4 other = (OneArrayOfOneBooleansValue4) obj;
    ...
    public String toString() {
        return "OneArrayOfOneBooleansValue4(" + oneArrayOfOneBooleans + ')';
    }
    ...
    public OneArrayOfOneBooleansValue4 setOneArrayOfOneBooleans(
            final boolean[] value) {
        if (value == null)
