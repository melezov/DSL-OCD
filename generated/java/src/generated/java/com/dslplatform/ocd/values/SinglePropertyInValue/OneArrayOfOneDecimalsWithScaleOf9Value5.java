...
public final class OneArrayOfOneDecimalsWithScaleOf9Value5 implements
        java.io.Serializable {
    public OneArrayOfOneDecimalsWithScaleOf9Value5(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1321286568;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfOneDecimalsWithScaleOf9Value5))
            return false;
        final OneArrayOfOneDecimalsWithScaleOf9Value5 other = (OneArrayOfOneDecimalsWithScaleOf9Value5) obj;
    ...
    public String toString() {
        return "OneArrayOfOneDecimalsWithScaleOf9Value5("
    ...
    public OneArrayOfOneDecimalsWithScaleOf9Value5 setOneArrayOfOneDecimalsWithScaleOf9(
