...
public final class OneSetOfOneImagesValue1 implements java.io.Serializable {
    public OneSetOfOneImagesValue1(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1567651105;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneSetOfOneImagesValue1)) return false;
        final OneSetOfOneImagesValue1 other = (OneSetOfOneImagesValue1) obj;
    ...
    public String toString() {
        return "OneSetOfOneImagesValue1(" + oneSetOfOneImages + ')';
    }
    ...
    public OneSetOfOneImagesValue1 setOneSetOfOneImages(
