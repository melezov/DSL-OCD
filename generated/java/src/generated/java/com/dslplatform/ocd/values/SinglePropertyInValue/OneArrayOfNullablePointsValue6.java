...
public final class OneArrayOfNullablePointsValue6 implements
        java.io.Serializable {
    public OneArrayOfNullablePointsValue6(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1811560773;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfNullablePointsValue6)) return false;
        final OneArrayOfNullablePointsValue6 other = (OneArrayOfNullablePointsValue6) obj;
    ...
    public String toString() {
        return "OneArrayOfNullablePointsValue6(" + oneArrayOfNullablePoints
                + ')';
    }
    ...
    public OneArrayOfNullablePointsValue6 setOneArrayOfNullablePoints(
