...
class NullableSetOfNullableDecimalsWithScaleOf9_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableSetOfNullableDecimalsWithScaleOf9_5 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableSetOfNullableDecimalsWithScaleOf9_5("+ URI +")"

   def copy(nullableSetOfNullableDecimalsWithScaleOf9: Option[Set[Option[BigDecimal]]] = this._nullableSetOfNullableDecimalsWithScaleOf9): NullableSetOfNullableDecimalsWithScaleOf9_5 = {
  ...
  com.dslplatform.api.Guards.checkCollectionOptionRefNulls(nullableSetOfNullableDecimalsWithScaleOf9)
    new NullableSetOfNullableDecimalsWithScaleOf9_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableSetOfNullableDecimalsWithScaleOf9 = nullableSetOfNullableDecimalsWithScaleOf9)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableSetOfNullableDecimalsWithScaleOf9_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableSetOfNullableDecimalsWithScaleOf9_5](URI), duration)
  }
...
object NullableSetOfNullableDecimalsWithScaleOf9_5 extends AggregateRootCompanion[NullableSetOfNullableDecimalsWithScaleOf9_5]{
