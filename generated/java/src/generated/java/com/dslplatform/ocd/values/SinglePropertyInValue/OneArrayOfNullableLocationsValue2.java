...
public final class OneArrayOfNullableLocationsValue2 implements
        java.io.Serializable {
    public OneArrayOfNullableLocationsValue2(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1955477544;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfNullableLocationsValue2)) return false;
        final OneArrayOfNullableLocationsValue2 other = (OneArrayOfNullableLocationsValue2) obj;
    ...
    public String toString() {
        return "OneArrayOfNullableLocationsValue2("
    ...
    public OneArrayOfNullableLocationsValue2 setOneArrayOfNullableLocations(
