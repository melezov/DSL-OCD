...
class NullableArrayOfOnePoints_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableArrayOfOnePoints_5 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableArrayOfOnePoints_5("+ URI +")"

   def copy(nullableArrayOfOnePoints: Option[Array[java.awt.geom.Point2D]] = this._nullableArrayOfOnePoints): NullableArrayOfOnePoints_5 = {
  ...
  com.dslplatform.api.Guards.checkArrayNulls(nullableArrayOfOnePoints)
    new NullableArrayOfOnePoints_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableArrayOfOnePoints = nullableArrayOfOnePoints)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableArrayOfOnePoints_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableArrayOfOnePoints_5](URI), duration)
  }
...
object NullableArrayOfOnePoints_5 extends AggregateRootCompanion[NullableArrayOfOnePoints_5]{
  ...
  def apply(
    ...
    require(nullableArrayOfOnePoints ne null, "Null value was provided for property \"nullableArrayOfOnePoints\"")
    if (nullableArrayOfOnePoints.isDefined) require(nullableArrayOfOnePoints.get ne null, "Null value was provided for property \"nullableArrayOfOnePoints\"")
    new NullableArrayOfOnePoints_5(
      __locator = None
