...
class OneListOfNullableGuids_6 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: OneListOfNullableGuids_6 => c.URI == URI
    case _ => false
  }

  override def toString = "OneListOfNullableGuids_6("+ URI +")"

   def copy(oneListOfNullableGuids: IndexedSeq[Option[java.util.UUID]] = this._oneListOfNullableGuids): OneListOfNullableGuids_6 = {
  ...
  com.dslplatform.api.Guards.checkCollectionOptionRefNulls(oneListOfNullableGuids)
    new OneListOfNullableGuids_6(_URI = this.URI, __locator = this.__locator, _ID = _ID, _oneListOfNullableGuids = oneListOfNullableGuids)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneListOfNullableGuids_6): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneListOfNullableGuids_6](URI), duration)
  }
...
object OneListOfNullableGuids_6 extends AggregateRootCompanion[OneListOfNullableGuids_6]{
