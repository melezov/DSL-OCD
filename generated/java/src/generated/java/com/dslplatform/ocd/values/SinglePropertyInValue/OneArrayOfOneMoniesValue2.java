...
public final class OneArrayOfOneMoniesValue2 implements java.io.Serializable {
    public OneArrayOfOneMoniesValue2(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1676550758;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfOneMoniesValue2)) return false;
        final OneArrayOfOneMoniesValue2 other = (OneArrayOfOneMoniesValue2) obj;
    ...
    public String toString() {
        return "OneArrayOfOneMoniesValue2(" + oneArrayOfOneMonies + ')';
    }
    ...
    public OneArrayOfOneMoniesValue2 setOneArrayOfOneMonies(
