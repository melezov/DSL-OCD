...
class OneArrayOfNullableBooleans_6 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: OneArrayOfNullableBooleans_6 => c.URI == URI
    case _ => false
  }

  override def toString = "OneArrayOfNullableBooleans_6("+ URI +")"

   def copy(oneArrayOfNullableBooleans: Array[Option[Boolean]] = this._oneArrayOfNullableBooleans): OneArrayOfNullableBooleans_6 = {
  ...
  com.dslplatform.api.Guards.checkArrayOptionValNulls(oneArrayOfNullableBooleans)
    new OneArrayOfNullableBooleans_6(_URI = this.URI, __locator = this.__locator, _ID = _ID, _oneArrayOfNullableBooleans = oneArrayOfNullableBooleans)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneArrayOfNullableBooleans_6): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneArrayOfNullableBooleans_6](URI), duration)
  }
...
object OneArrayOfNullableBooleans_6 extends AggregateRootCompanion[OneArrayOfNullableBooleans_6]{
  ...
  def apply(
    ...
    com.dslplatform.api.Guards.checkArrayOptionValNulls(oneArrayOfNullableBooleans)
    require(oneArrayOfNullableBooleans ne null, "Null value was provided for property \"oneArrayOfNullableBooleans\"")
    new OneArrayOfNullableBooleans_6(
      __locator = None
