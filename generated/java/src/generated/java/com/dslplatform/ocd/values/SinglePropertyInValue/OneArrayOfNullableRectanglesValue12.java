...
public final class OneArrayOfNullableRectanglesValue12 implements
        java.io.Serializable {
    public OneArrayOfNullableRectanglesValue12(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 2125647919;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfNullableRectanglesValue12))
            return false;
        final OneArrayOfNullableRectanglesValue12 other = (OneArrayOfNullableRectanglesValue12) obj;
    ...
    public String toString() {
        return "OneArrayOfNullableRectanglesValue12("
    ...
    public OneArrayOfNullableRectanglesValue12 setOneArrayOfNullableRectangles(
