...
public final class OneArrayOfOneDecimalsWithScaleOf9Value6 implements
        java.io.Serializable {
    public OneArrayOfOneDecimalsWithScaleOf9Value6(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1321286567;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfOneDecimalsWithScaleOf9Value6))
            return false;
        final OneArrayOfOneDecimalsWithScaleOf9Value6 other = (OneArrayOfOneDecimalsWithScaleOf9Value6) obj;
    ...
    public String toString() {
        return "OneArrayOfOneDecimalsWithScaleOf9Value6("
    ...
    public OneArrayOfOneDecimalsWithScaleOf9Value6 setOneArrayOfOneDecimalsWithScaleOf9(
