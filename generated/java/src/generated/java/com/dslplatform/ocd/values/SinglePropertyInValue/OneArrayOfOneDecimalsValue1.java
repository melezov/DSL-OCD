...
public final class OneArrayOfOneDecimalsValue1 implements java.io.Serializable {
    public OneArrayOfOneDecimalsValue1(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1131161010;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfOneDecimalsValue1)) return false;
        final OneArrayOfOneDecimalsValue1 other = (OneArrayOfOneDecimalsValue1) obj;
    ...
    public String toString() {
        return "OneArrayOfOneDecimalsValue1(" + oneArrayOfOneDecimals + ')';
    }
    ...
    public OneArrayOfOneDecimalsValue1 setOneArrayOfOneDecimals(
