...
class NullableArrayOfOneGuids_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableArrayOfOneGuids_5 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableArrayOfOneGuids_5("+ URI +")"

   def copy(nullableArrayOfOneGuids: Option[Array[java.util.UUID]] = this._nullableArrayOfOneGuids): NullableArrayOfOneGuids_5 = {
  ...
  com.dslplatform.api.Guards.checkArrayNulls(nullableArrayOfOneGuids)
    new NullableArrayOfOneGuids_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableArrayOfOneGuids = nullableArrayOfOneGuids)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableArrayOfOneGuids_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableArrayOfOneGuids_5](URI), duration)
  }
...
object NullableArrayOfOneGuids_5 extends AggregateRootCompanion[NullableArrayOfOneGuids_5]{
