...
public final class OneSetOfNullableBooleansValue1 implements
        java.io.Serializable {
    public OneSetOfNullableBooleansValue1(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1747594509;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneSetOfNullableBooleansValue1)) return false;
        final OneSetOfNullableBooleansValue1 other = (OneSetOfNullableBooleansValue1) obj;
    ...
    public String toString() {
        return "OneSetOfNullableBooleansValue1(" + oneSetOfNullableBooleans
                + ')';
    }
    ...
    public OneSetOfNullableBooleansValue1 setOneSetOfNullableBooleans(
