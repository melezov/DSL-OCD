...
class NullableArrayOfNullableStrings_2 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableArrayOfNullableStrings_2 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableArrayOfNullableStrings_2("+ URI +")"

   def copy(nullableArrayOfNullableStrings: Option[Array[Option[String]]] = this._nullableArrayOfNullableStrings): NullableArrayOfNullableStrings_2 = {
  ...
  com.dslplatform.api.Guards.checkArrayOptionRefNulls(nullableArrayOfNullableStrings)
    new NullableArrayOfNullableStrings_2(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableArrayOfNullableStrings = nullableArrayOfNullableStrings)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.aggregates.SurrogatePrimaryKeyWithOnePropertyInAggregate.NullableArrayOfNullableStrings_2): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.aggregates.SurrogatePrimaryKeyWithOnePropertyInAggregate.NullableArrayOfNullableStrings_2](URI), duration)
  }

  @com.fasterxml.jackson.annotation.JsonGetter("nullableArrayOfNullableStrings")
...
object NullableArrayOfNullableStrings_2 extends AggregateRootCompanion[NullableArrayOfNullableStrings_2]{
  ...
  def apply(
    ...
    require(nullableArrayOfNullableStrings ne null, "Null value was provided for property \"nullableArrayOfNullableStrings\"")
    if (nullableArrayOfNullableStrings.isDefined) require(nullableArrayOfNullableStrings.get ne null, "Null value was provided for property \"nullableArrayOfNullableStrings\"")
    new NullableArrayOfNullableStrings_2(
      __locator = None
