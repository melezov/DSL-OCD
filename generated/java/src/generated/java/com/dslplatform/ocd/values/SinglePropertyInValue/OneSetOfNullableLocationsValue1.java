...
public final class OneSetOfNullableLocationsValue1 implements
        java.io.Serializable {
    public OneSetOfNullableLocationsValue1(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1738342674;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneSetOfNullableLocationsValue1)) return false;
        final OneSetOfNullableLocationsValue1 other = (OneSetOfNullableLocationsValue1) obj;
    ...
    public String toString() {
        return "OneSetOfNullableLocationsValue1(" + oneSetOfNullableLocations
                + ')';
    }
    ...
    public OneSetOfNullableLocationsValue1 setOneSetOfNullableLocations(
