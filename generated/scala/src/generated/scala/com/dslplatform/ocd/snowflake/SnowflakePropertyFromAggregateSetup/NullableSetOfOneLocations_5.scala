...
class NullableSetOfOneLocations_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableSetOfOneLocations_5 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableSetOfOneLocations_5("+ URI +")"

   def copy(nullableSetOfOneLocations: Option[Set[java.awt.geom.Point2D]] = this._nullableSetOfOneLocations): NullableSetOfOneLocations_5 = {
  ...
  com.dslplatform.api.Guards.checkCollectionNulls(nullableSetOfOneLocations)
    new NullableSetOfOneLocations_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableSetOfOneLocations = nullableSetOfOneLocations)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableSetOfOneLocations_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableSetOfOneLocations_5](URI), duration)
  }
...
object NullableSetOfOneLocations_5 extends AggregateRootCompanion[NullableSetOfOneLocations_5]{
  ...
  def apply(
    ...
    require(nullableSetOfOneLocations ne null, "Null value was provided for property \"nullableSetOfOneLocations\"")
    if (nullableSetOfOneLocations.isDefined) require(nullableSetOfOneLocations.get ne null, "Null value was provided for property \"nullableSetOfOneLocations\"")
    new NullableSetOfOneLocations_5(
      __locator = None
