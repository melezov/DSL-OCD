...
class NullableArrayOfNullableLongs_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableArrayOfNullableLongs_5 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableArrayOfNullableLongs_5("+ URI +")"

   def copy(nullableArrayOfNullableLongs: Option[Array[Option[Long]]] = this._nullableArrayOfNullableLongs): NullableArrayOfNullableLongs_5 = {
  ...
  com.dslplatform.api.Guards.checkArrayOptionValNulls(nullableArrayOfNullableLongs)
    new NullableArrayOfNullableLongs_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableArrayOfNullableLongs = nullableArrayOfNullableLongs)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableArrayOfNullableLongs_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableArrayOfNullableLongs_5](URI), duration)
  }
...
object NullableArrayOfNullableLongs_5 extends AggregateRootCompanion[NullableArrayOfNullableLongs_5]{
  ...
  def apply(
    ...
    require(nullableArrayOfNullableLongs ne null, "Null value was provided for property \"nullableArrayOfNullableLongs\"")
    if (nullableArrayOfNullableLongs.isDefined) require(nullableArrayOfNullableLongs.get ne null, "Null value was provided for property \"nullableArrayOfNullableLongs\"")
    new NullableArrayOfNullableLongs_5(
      __locator = None
