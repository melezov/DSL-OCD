...
public final class NullableArrayOfNullableTimestampsValue5 implements
        java.io.Serializable {
    public NullableArrayOfNullableTimestampsValue5(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1572030203;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof NullableArrayOfNullableTimestampsValue5))
            return false;
        final NullableArrayOfNullableTimestampsValue5 other = (NullableArrayOfNullableTimestampsValue5) obj;
    ...
    public String toString() {
        return "NullableArrayOfNullableTimestampsValue5("
    ...
    public NullableArrayOfNullableTimestampsValue5 setNullableArrayOfNullableTimestamps(
