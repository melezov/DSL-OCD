...
public final class OneArrayOfOneMoniesValue6 implements java.io.Serializable {
    public OneArrayOfOneMoniesValue6(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1676550754;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfOneMoniesValue6)) return false;
        final OneArrayOfOneMoniesValue6 other = (OneArrayOfOneMoniesValue6) obj;
    ...
    public String toString() {
        return "OneArrayOfOneMoniesValue6(" + oneArrayOfOneMonies + ')';
    }
    ...
    public OneArrayOfOneMoniesValue6 setOneArrayOfOneMonies(
