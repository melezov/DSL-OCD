...
public final class NullableArrayOfNullableRectanglesValue1 implements
        java.io.Serializable {
    public NullableArrayOfNullableRectanglesValue1(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1536912298;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof NullableArrayOfNullableRectanglesValue1))
            return false;
        final NullableArrayOfNullableRectanglesValue1 other = (NullableArrayOfNullableRectanglesValue1) obj;
    ...
    public String toString() {
        return "NullableArrayOfNullableRectanglesValue1("
    ...
    public NullableArrayOfNullableRectanglesValue1 setNullableArrayOfNullableRectangles(
