...
public final class NullableListOfNullableDecimalsWithScaleOf9Value3 implements
        java.io.Serializable {
    public NullableListOfNullableDecimalsWithScaleOf9Value3(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1707891545;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof NullableListOfNullableDecimalsWithScaleOf9Value3))
            return false;
        final NullableListOfNullableDecimalsWithScaleOf9Value3 other = (NullableListOfNullableDecimalsWithScaleOf9Value3) obj;
    ...
    public String toString() {
        return "NullableListOfNullableDecimalsWithScaleOf9Value3("
    ...
    public NullableListOfNullableDecimalsWithScaleOf9Value3 setNullableListOfNullableDecimalsWithScaleOf9(
