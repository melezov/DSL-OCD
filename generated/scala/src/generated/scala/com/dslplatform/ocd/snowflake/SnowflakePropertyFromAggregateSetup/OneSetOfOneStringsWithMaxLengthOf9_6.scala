...
class OneSetOfOneStringsWithMaxLengthOf9_6 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: OneSetOfOneStringsWithMaxLengthOf9_6 => c.URI == URI
    case _ => false
  }

  override def toString = "OneSetOfOneStringsWithMaxLengthOf9_6("+ URI +")"

   def copy(oneSetOfOneStringsWithMaxLengthOf9: Set[String] = this._oneSetOfOneStringsWithMaxLengthOf9): OneSetOfOneStringsWithMaxLengthOf9_6 = {
  ...
  com.dslplatform.api.Guards.checkCollectionNulls(oneSetOfOneStringsWithMaxLengthOf9)
    new OneSetOfOneStringsWithMaxLengthOf9_6(_URI = this.URI, __locator = this.__locator, _ID = _ID, _oneSetOfOneStringsWithMaxLengthOf9 = oneSetOfOneStringsWithMaxLengthOf9)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneSetOfOneStringsWithMaxLengthOf9_6): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneSetOfOneStringsWithMaxLengthOf9_6](URI), duration)
  }
...
object OneSetOfOneStringsWithMaxLengthOf9_6 extends AggregateRootCompanion[OneSetOfOneStringsWithMaxLengthOf9_6]{
