...
public final class NullableListOfOneGuidsValue1 implements java.io.Serializable {
    public NullableListOfOneGuidsValue1(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1824345036;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof NullableListOfOneGuidsValue1)) return false;
        final NullableListOfOneGuidsValue1 other = (NullableListOfOneGuidsValue1) obj;
    ...
    public String toString() {
        return "NullableListOfOneGuidsValue1(" + nullableListOfOneGuids + ')';
    }
    ...
    public NullableListOfOneGuidsValue1 setNullableListOfOneGuids(
