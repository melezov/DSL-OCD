...
public final class OneArrayOfOneDecimalsWithScaleOf9Value3 implements
        java.io.Serializable {
    public OneArrayOfOneDecimalsWithScaleOf9Value3(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1321286562;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfOneDecimalsWithScaleOf9Value3))
            return false;
        final OneArrayOfOneDecimalsWithScaleOf9Value3 other = (OneArrayOfOneDecimalsWithScaleOf9Value3) obj;
    ...
    public String toString() {
        return "OneArrayOfOneDecimalsWithScaleOf9Value3("
    ...
    public OneArrayOfOneDecimalsWithScaleOf9Value3 setOneArrayOfOneDecimalsWithScaleOf9(
