...
class OneListOfOneDates_6 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: OneListOfOneDates_6 => c.URI == URI
    case _ => false
  }

  override def toString = "OneListOfOneDates_6("+ URI +")"

   def copy(oneListOfOneDates: IndexedSeq[org.joda.time.LocalDate] = this._oneListOfOneDates): OneListOfOneDates_6 = {
  ...
  com.dslplatform.api.Guards.checkCollectionNulls(oneListOfOneDates)
    new OneListOfOneDates_6(_URI = this.URI, __locator = this.__locator, _ID = _ID, _oneListOfOneDates = oneListOfOneDates)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneListOfOneDates_6): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneListOfOneDates_6](URI), duration)
  }
...
object OneListOfOneDates_6 extends AggregateRootCompanion[OneListOfOneDates_6]{
