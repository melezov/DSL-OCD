...
public final class OneListOfOneDecimalsWithScaleOf9Value2 implements
        java.io.Serializable {
    public OneListOfOneDecimalsWithScaleOf9Value2(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1421147142;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneListOfOneDecimalsWithScaleOf9Value2))
            return false;
        final OneListOfOneDecimalsWithScaleOf9Value2 other = (OneListOfOneDecimalsWithScaleOf9Value2) obj;
    ...
    public String toString() {
        return "OneListOfOneDecimalsWithScaleOf9Value2("
    ...
    public OneListOfOneDecimalsWithScaleOf9Value2 setOneListOfOneDecimalsWithScaleOf9(
