...
class OneSetOfNullableUrls_6 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: OneSetOfNullableUrls_6 => c.URI == URI
    case _ => false
  }

  override def toString = "OneSetOfNullableUrls_6("+ URI +")"

   def copy(oneSetOfNullableUrls: Set[Option[java.net.URI]] = this._oneSetOfNullableUrls): OneSetOfNullableUrls_6 = {
  ...
  com.dslplatform.api.Guards.checkCollectionOptionRefNulls(oneSetOfNullableUrls)
    new OneSetOfNullableUrls_6(_URI = this.URI, __locator = this.__locator, _ID = _ID, _oneSetOfNullableUrls = oneSetOfNullableUrls)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneSetOfNullableUrls_6): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneSetOfNullableUrls_6](URI), duration)
  }
...
object OneSetOfNullableUrls_6 extends AggregateRootCompanion[OneSetOfNullableUrls_6]{
