...
public final class NullableArrayOfOneRectanglesValue7 implements
        java.io.Serializable {
    public NullableArrayOfOneRectanglesValue7(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1173915851;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof NullableArrayOfOneRectanglesValue7)) return false;
        final NullableArrayOfOneRectanglesValue7 other = (NullableArrayOfOneRectanglesValue7) obj;
    ...
    public String toString() {
        return "NullableArrayOfOneRectanglesValue7("
    ...
    public NullableArrayOfOneRectanglesValue7 setNullableArrayOfOneRectangles(
