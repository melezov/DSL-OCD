...
public final class OneArrayOfOneImagesValue5 implements java.io.Serializable {
    public OneArrayOfOneImagesValue5(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1231038616;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfOneImagesValue5)) return false;
        final OneArrayOfOneImagesValue5 other = (OneArrayOfOneImagesValue5) obj;
    ...
    public String toString() {
        return "OneArrayOfOneImagesValue5(" + oneArrayOfOneImages + ')';
    }
    ...
    public OneArrayOfOneImagesValue5 setOneArrayOfOneImages(
