...
public final class OneArrayOfNullableStringsWithMaxLengthOf9Value3 implements
        java.io.Serializable {
    public OneArrayOfNullableStringsWithMaxLengthOf9Value3(
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfNullableStringsWithMaxLengthOf9Value3))
            return false;
        final OneArrayOfNullableStringsWithMaxLengthOf9Value3 other = (OneArrayOfNullableStringsWithMaxLengthOf9Value3) obj;
    ...
    public String toString() {
        return "OneArrayOfNullableStringsWithMaxLengthOf9Value3("
    ...
    public OneArrayOfNullableStringsWithMaxLengthOf9Value3 setOneArrayOfNullableStringsWithMaxLengthOf9(
            final String[] value) {
        if (value == null)
