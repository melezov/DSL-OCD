...
public final class OneSetOfOneXmlsValue1 implements java.io.Serializable {
    public OneSetOfOneXmlsValue1(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 2026860449;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneSetOfOneXmlsValue1)) return false;
        final OneSetOfOneXmlsValue1 other = (OneSetOfOneXmlsValue1) obj;
    ...
    public String toString() {
        return "OneSetOfOneXmlsValue1(" + oneSetOfOneXmls + ')';
    }
    ...
    public OneSetOfOneXmlsValue1 setOneSetOfOneXmls(
