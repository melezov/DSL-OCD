...
public final class OneSetOfOneIntegersValue5 implements java.io.Serializable {
    public OneSetOfOneIntegersValue5(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1053006638;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneSetOfOneIntegersValue5)) return false;
        final OneSetOfOneIntegersValue5 other = (OneSetOfOneIntegersValue5) obj;
    ...
    public String toString() {
        return "OneSetOfOneIntegersValue5(" + oneSetOfOneIntegers + ')';
    }
    ...
    public OneSetOfOneIntegersValue5 setOneSetOfOneIntegers(
