...
class OneArrayOfNullableBinaries_6 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: OneArrayOfNullableBinaries_6 => c.URI == URI
    case _ => false
  }

  override def toString = "OneArrayOfNullableBinaries_6("+ URI +")"

   def copy(oneArrayOfNullableBinaries: Array[Option[Array[Byte]]] = this._oneArrayOfNullableBinaries): OneArrayOfNullableBinaries_6 = {
  ...
  com.dslplatform.api.Guards.checkArrayOptionRefNulls(oneArrayOfNullableBinaries)
    new OneArrayOfNullableBinaries_6(_URI = this.URI, __locator = this.__locator, _ID = _ID, _oneArrayOfNullableBinaries = oneArrayOfNullableBinaries)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneArrayOfNullableBinaries_6): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneArrayOfNullableBinaries_6](URI), duration)
  }
...
object OneArrayOfNullableBinaries_6 extends AggregateRootCompanion[OneArrayOfNullableBinaries_6]{
  ...
  def apply(
    ...
    com.dslplatform.api.Guards.checkArrayOptionRefNulls(oneArrayOfNullableBinaries)
    require(oneArrayOfNullableBinaries ne null, "Null value was provided for property \"oneArrayOfNullableBinaries\"")
    new OneArrayOfNullableBinaries_6(
      __locator = None
