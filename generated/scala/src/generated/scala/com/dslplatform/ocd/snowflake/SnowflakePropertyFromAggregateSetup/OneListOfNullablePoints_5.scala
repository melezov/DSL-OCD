...
class OneListOfNullablePoints_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: OneListOfNullablePoints_5 => c.URI == URI
    case _ => false
  }

  override def toString = "OneListOfNullablePoints_5("+ URI +")"

   def copy(oneListOfNullablePoints: IndexedSeq[Option[java.awt.geom.Point2D]] = this._oneListOfNullablePoints): OneListOfNullablePoints_5 = {
  ...
  com.dslplatform.api.Guards.checkCollectionOptionRefNulls(oneListOfNullablePoints)
    new OneListOfNullablePoints_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _oneListOfNullablePoints = oneListOfNullablePoints)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneListOfNullablePoints_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneListOfNullablePoints_5](URI), duration)
  }
...
object OneListOfNullablePoints_5 extends AggregateRootCompanion[OneListOfNullablePoints_5]{
