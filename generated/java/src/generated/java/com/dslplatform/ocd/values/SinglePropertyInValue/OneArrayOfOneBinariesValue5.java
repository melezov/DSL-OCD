...
public final class OneArrayOfOneBinariesValue5 implements java.io.Serializable {
    public OneArrayOfOneBinariesValue5(
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfOneBinariesValue5)) return false;
        final OneArrayOfOneBinariesValue5 other = (OneArrayOfOneBinariesValue5) obj;
    ...
    public String toString() {
        return "OneArrayOfOneBinariesValue5(" + oneArrayOfOneBinaries + ')';
    }
    ...
    public OneArrayOfOneBinariesValue5 setOneArrayOfOneBinaries(
            final byte[][] value) {
        if (value == null)
