...
class OneListOfOneBinaries_6 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: OneListOfOneBinaries_6 => c.URI == URI
    case _ => false
  }

  override def toString = "OneListOfOneBinaries_6("+ URI +")"

   def copy(oneListOfOneBinaries: IndexedSeq[Array[Byte]] = this._oneListOfOneBinaries): OneListOfOneBinaries_6 = {
  ...
  com.dslplatform.api.Guards.checkCollectionNulls(oneListOfOneBinaries)
    new OneListOfOneBinaries_6(_URI = this.URI, __locator = this.__locator, _ID = _ID, _oneListOfOneBinaries = oneListOfOneBinaries)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneListOfOneBinaries_6): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneListOfOneBinaries_6](URI), duration)
  }
...
object OneListOfOneBinaries_6 extends AggregateRootCompanion[OneListOfOneBinaries_6]{
