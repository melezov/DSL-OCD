...
public final class NullableArrayOfOneTimestampsValue5 implements
        java.io.Serializable {
    public NullableArrayOfOneTimestampsValue5(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1628714210;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof NullableArrayOfOneTimestampsValue5)) return false;
        final NullableArrayOfOneTimestampsValue5 other = (NullableArrayOfOneTimestampsValue5) obj;
    ...
    public String toString() {
        return "NullableArrayOfOneTimestampsValue5("
    ...
    public NullableArrayOfOneTimestampsValue5 setNullableArrayOfOneTimestamps(
