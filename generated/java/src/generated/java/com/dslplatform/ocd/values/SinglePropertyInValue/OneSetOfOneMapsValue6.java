...
public final class OneSetOfOneMapsValue6 implements java.io.Serializable {
    public OneSetOfOneMapsValue6(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1780008029;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneSetOfOneMapsValue6)) return false;
        final OneSetOfOneMapsValue6 other = (OneSetOfOneMapsValue6) obj;
    ...
    public String toString() {
        return "OneSetOfOneMapsValue6(" + oneSetOfOneMaps + ')';
    }
    ...
    public OneSetOfOneMapsValue6 setOneSetOfOneMaps(
