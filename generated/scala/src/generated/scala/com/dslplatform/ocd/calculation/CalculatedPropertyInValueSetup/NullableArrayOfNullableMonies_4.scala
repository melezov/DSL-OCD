...
case class NullableArrayOfNullableMonies_4 @com.fasterxml.jackson.annotation.JsonIgnore() (
     nullableArrayOfNullableMonies: Option[Array[Option[BigDecimal]]] = None,
     calculatedNullableArrayOfNullableMonies: Option[Array[Option[BigDecimal]]] = None,
     persistedNullableArrayOfNullableMonies: Option[Array[Option[BigDecimal]]] = None
  ) {
  ...
  , @com.fasterxml.jackson.annotation.JsonProperty("persistedNullableArrayOfNullableMonies") persistedNullableArrayOfNullableMonies: Option[Array[Option[BigDecimal]]]
    ...
    this( nullableArrayOfNullableMonies = nullableArrayOfNullableMonies, calculatedNullableArrayOfNullableMonies = calculatedNullableArrayOfNullableMonies, persistedNullableArrayOfNullableMonies = persistedNullableArrayOfNullableMonies)
