...
public final class OneArrayOfNullableBooleansValue1 implements
        java.io.Serializable {
    public OneArrayOfNullableBooleansValue1(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1126981926;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfNullableBooleansValue1)) return false;
        final OneArrayOfNullableBooleansValue1 other = (OneArrayOfNullableBooleansValue1) obj;
    ...
    public String toString() {
        return "OneArrayOfNullableBooleansValue1(" + oneArrayOfNullableBooleans
                + ')';
    }
    ...
    public OneArrayOfNullableBooleansValue1 setOneArrayOfNullableBooleans(
            final Boolean[] value) {
        if (value == null)
