...
public final class OneArrayOfNullableUrlsValue2 implements java.io.Serializable {
    public OneArrayOfNullableUrlsValue2(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1798579536;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfNullableUrlsValue2)) return false;
        final OneArrayOfNullableUrlsValue2 other = (OneArrayOfNullableUrlsValue2) obj;
    ...
    public String toString() {
        return "OneArrayOfNullableUrlsValue2(" + oneArrayOfNullableUrls + ')';
    }
    ...
    public OneArrayOfNullableUrlsValue2 setOneArrayOfNullableUrls(
