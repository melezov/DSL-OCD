...
case class NullableArrayOfOneGuids_4 @com.fasterxml.jackson.annotation.JsonIgnore() (
     nullableArrayOfOneGuids: Option[Array[java.util.UUID]] = None,
     calculatedNullableArrayOfOneGuids: Option[Array[java.util.UUID]] = None,
     persistedNullableArrayOfOneGuids: Option[Array[java.util.UUID]] = None
  ) {
  ...
  , @com.fasterxml.jackson.annotation.JsonProperty("persistedNullableArrayOfOneGuids") persistedNullableArrayOfOneGuids: Option[Array[java.util.UUID]]
    ...
    this( nullableArrayOfOneGuids = nullableArrayOfOneGuids, calculatedNullableArrayOfOneGuids = calculatedNullableArrayOfOneGuids, persistedNullableArrayOfOneGuids = persistedNullableArrayOfOneGuids)
