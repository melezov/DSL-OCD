...
public class DomHelper {
    ...
    public Element table_striped(final Object... children) {
        return this.appendChildren(this.table(this.attr("class", "table table-striped")), children);
    }

    public Element table_error(final Object... children) {
        return this.appendChildren(this.table(this.attr("class", "table"), this.style("width: 1500px")), children);
    }
    ...
    public Element div_container(final Object... children) {
        return this.appendChildren(this.div(this.attr("class", "container")), children);
    }
