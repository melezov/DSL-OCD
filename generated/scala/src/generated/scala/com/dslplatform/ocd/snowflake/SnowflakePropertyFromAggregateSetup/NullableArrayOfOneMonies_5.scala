...
class NullableArrayOfOneMonies_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableArrayOfOneMonies_5 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableArrayOfOneMonies_5("+ URI +")"

   def copy(nullableArrayOfOneMonies: Option[Array[BigDecimal]] = this._nullableArrayOfOneMonies): NullableArrayOfOneMonies_5 = {
  ...
  com.dslplatform.api.Guards.checkArrayNulls(nullableArrayOfOneMonies)
    new NullableArrayOfOneMonies_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableArrayOfOneMonies = nullableArrayOfOneMonies)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableArrayOfOneMonies_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableArrayOfOneMonies_5](URI), duration)
  }
...
object NullableArrayOfOneMonies_5 extends AggregateRootCompanion[NullableArrayOfOneMonies_5]{
  ...
  def apply(
    ...
    require(nullableArrayOfOneMonies ne null, "Null value was provided for property \"nullableArrayOfOneMonies\"")
    if (nullableArrayOfOneMonies.isDefined) require(nullableArrayOfOneMonies.get ne null, "Null value was provided for property \"nullableArrayOfOneMonies\"")
    new NullableArrayOfOneMonies_5(
      __locator = None
