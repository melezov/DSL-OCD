...
class OneArrayOfNullableDoubles_6 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: OneArrayOfNullableDoubles_6 => c.URI == URI
    case _ => false
  }

  override def toString = "OneArrayOfNullableDoubles_6("+ URI +")"

   def copy(oneArrayOfNullableDoubles: Array[Option[Double]] = this._oneArrayOfNullableDoubles): OneArrayOfNullableDoubles_6 = {
  ...
  com.dslplatform.api.Guards.checkArrayOptionValNulls(oneArrayOfNullableDoubles)
    new OneArrayOfNullableDoubles_6(_URI = this.URI, __locator = this.__locator, _ID = _ID, _oneArrayOfNullableDoubles = oneArrayOfNullableDoubles)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneArrayOfNullableDoubles_6): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneArrayOfNullableDoubles_6](URI), duration)
  }
...
object OneArrayOfNullableDoubles_6 extends AggregateRootCompanion[OneArrayOfNullableDoubles_6]{
  ...
  def apply(
    ...
    com.dslplatform.api.Guards.checkArrayOptionValNulls(oneArrayOfNullableDoubles)
    require(oneArrayOfNullableDoubles ne null, "Null value was provided for property \"oneArrayOfNullableDoubles\"")
    new OneArrayOfNullableDoubles_6(
      __locator = None
