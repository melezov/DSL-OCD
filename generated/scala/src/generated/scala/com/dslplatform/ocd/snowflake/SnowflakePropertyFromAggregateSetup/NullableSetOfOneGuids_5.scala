...
class NullableSetOfOneGuids_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableSetOfOneGuids_5 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableSetOfOneGuids_5("+ URI +")"

   def copy(nullableSetOfOneGuids: Option[Set[java.util.UUID]] = this._nullableSetOfOneGuids): NullableSetOfOneGuids_5 = {
  ...
  com.dslplatform.api.Guards.checkCollectionNulls(nullableSetOfOneGuids)
    new NullableSetOfOneGuids_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableSetOfOneGuids = nullableSetOfOneGuids)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableSetOfOneGuids_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableSetOfOneGuids_5](URI), duration)
  }
...
object NullableSetOfOneGuids_5 extends AggregateRootCompanion[NullableSetOfOneGuids_5]{
