...
class OneArrayOfNullableImages_3 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: OneArrayOfNullableImages_3 => c.URI == URI
    case _ => false
  }

  override def toString = "OneArrayOfNullableImages_3("+ URI +")"

   def copy(oneArrayOfNullableImages: Array[Option[java.awt.image.BufferedImage]] = this._oneArrayOfNullableImages): OneArrayOfNullableImages_3 = {
  ...
  com.dslplatform.api.Guards.checkArrayOptionRefNulls(oneArrayOfNullableImages)
    new OneArrayOfNullableImages_3(_URI = this.URI, __locator = this.__locator, _ID = _ID, _oneArrayOfNullableImages = oneArrayOfNullableImages)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.aggregates.SurrogatePrimaryKeyWithOnePropertyInAggregate.OneArrayOfNullableImages_3): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.aggregates.SurrogatePrimaryKeyWithOnePropertyInAggregate.OneArrayOfNullableImages_3](URI), duration)
  }
...
object OneArrayOfNullableImages_3 extends AggregateRootCompanion[OneArrayOfNullableImages_3]{
  ...
  def apply(
    ...
    com.dslplatform.api.Guards.checkArrayOptionRefNulls(oneArrayOfNullableImages)
    require(oneArrayOfNullableImages ne null, "Null value was provided for property \"oneArrayOfNullableImages\"")
    new OneArrayOfNullableImages_3(
      __locator = None
