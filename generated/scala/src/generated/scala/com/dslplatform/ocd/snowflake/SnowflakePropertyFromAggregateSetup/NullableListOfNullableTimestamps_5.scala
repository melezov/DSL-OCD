...
class NullableListOfNullableTimestamps_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableListOfNullableTimestamps_5 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableListOfNullableTimestamps_5("+ URI +")"

   def copy(nullableListOfNullableTimestamps: Option[IndexedSeq[Option[org.joda.time.DateTime]]] = this._nullableListOfNullableTimestamps): NullableListOfNullableTimestamps_5 = {
  ...
  com.dslplatform.api.Guards.checkCollectionOptionRefNulls(nullableListOfNullableTimestamps)
    new NullableListOfNullableTimestamps_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableListOfNullableTimestamps = nullableListOfNullableTimestamps)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableListOfNullableTimestamps_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableListOfNullableTimestamps_5](URI), duration)
  }
...
object NullableListOfNullableTimestamps_5 extends AggregateRootCompanion[NullableListOfNullableTimestamps_5]{
  ...
  def apply(
    ...
    require(nullableListOfNullableTimestamps ne null, "Null value was provided for property \"nullableListOfNullableTimestamps\"")
    if (nullableListOfNullableTimestamps.isDefined) require(nullableListOfNullableTimestamps.get ne null, "Null value was provided for property \"nullableListOfNullableTimestamps\"")
    new NullableListOfNullableTimestamps_5(
      __locator = None
