...
public final class OneArrayOfNullableBooleansValue2 implements
        java.io.Serializable {
    public OneArrayOfNullableBooleansValue2(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1601901429;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfNullableBooleansValue2)) return false;
        final OneArrayOfNullableBooleansValue2 other = (OneArrayOfNullableBooleansValue2) obj;
    ...
    public String toString() {
        return "OneArrayOfNullableBooleansValue2(" + oneArrayOfNullableBooleans
                + ')';
    }
    ...
    public OneArrayOfNullableBooleansValue2 setOneArrayOfNullableBooleans(
            final Boolean[] value) {
        if (value == null)
