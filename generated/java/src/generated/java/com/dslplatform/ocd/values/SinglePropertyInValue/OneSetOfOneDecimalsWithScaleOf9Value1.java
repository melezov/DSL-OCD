...
public final class OneSetOfOneDecimalsWithScaleOf9Value1 implements
        java.io.Serializable {
    public OneSetOfOneDecimalsWithScaleOf9Value1(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1336709705;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneSetOfOneDecimalsWithScaleOf9Value1))
            return false;
        final OneSetOfOneDecimalsWithScaleOf9Value1 other = (OneSetOfOneDecimalsWithScaleOf9Value1) obj;
    ...
    public String toString() {
        return "OneSetOfOneDecimalsWithScaleOf9Value1("
    ...
    public OneSetOfOneDecimalsWithScaleOf9Value1 setOneSetOfOneDecimalsWithScaleOf9(
