...
public final class OneSetOfOneIntegersValue3 implements java.io.Serializable {
    public OneSetOfOneIntegersValue3(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1053006636;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneSetOfOneIntegersValue3)) return false;
        final OneSetOfOneIntegersValue3 other = (OneSetOfOneIntegersValue3) obj;
    ...
    public String toString() {
        return "OneSetOfOneIntegersValue3(" + oneSetOfOneIntegers + ')';
    }
    ...
    public OneSetOfOneIntegersValue3 setOneSetOfOneIntegers(
