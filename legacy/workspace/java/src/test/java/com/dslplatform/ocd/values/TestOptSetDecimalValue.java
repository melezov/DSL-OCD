...
public class TestOptSetDecimalValue {
    ...
    public void testLackOfSetterNullGuard() {
        final OptSetDecimalValue value = new OptSetDecimalValue();
    ...
    public void testValueEquality() {
      final OptSetDecimalValue v1 = new OptSetDecimalValue();
      final OptSetDecimalValue v2 = new OptSetDecimalValue();
