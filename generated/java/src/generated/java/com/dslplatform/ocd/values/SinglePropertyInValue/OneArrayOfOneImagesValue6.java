...
public final class OneArrayOfOneImagesValue6 implements java.io.Serializable {
    public OneArrayOfOneImagesValue6(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1231038615;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfOneImagesValue6)) return false;
        final OneArrayOfOneImagesValue6 other = (OneArrayOfOneImagesValue6) obj;
    ...
    public String toString() {
        return "OneArrayOfOneImagesValue6(" + oneArrayOfOneImages + ')';
    }
    ...
    public OneArrayOfOneImagesValue6 setOneArrayOfOneImages(
