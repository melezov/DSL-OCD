...
public final class OneArrayOfNullableTextsValue6 implements
        java.io.Serializable {
    public OneArrayOfNullableTextsValue6(
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfNullableTextsValue6)) return false;
        final OneArrayOfNullableTextsValue6 other = (OneArrayOfNullableTextsValue6) obj;
    ...
    public String toString() {
        return "OneArrayOfNullableTextsValue6(" + oneArrayOfNullableTexts + ')';
    }
    ...
    public OneArrayOfNullableTextsValue6 setOneArrayOfNullableTexts(
            final String[] value) {
        if (value == null)
