...
class OneListOfOneDecimals_6 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: OneListOfOneDecimals_6 => c.URI == URI
    case _ => false
  }

  override def toString = "OneListOfOneDecimals_6("+ URI +")"

   def copy(oneListOfOneDecimals: IndexedSeq[BigDecimal] = this._oneListOfOneDecimals): OneListOfOneDecimals_6 = {
  ...
  com.dslplatform.api.Guards.checkCollectionNulls(oneListOfOneDecimals)
    new OneListOfOneDecimals_6(_URI = this.URI, __locator = this.__locator, _ID = _ID, _oneListOfOneDecimals = oneListOfOneDecimals)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneListOfOneDecimals_6): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneListOfOneDecimals_6](URI), duration)
  }
...
object OneListOfOneDecimals_6 extends AggregateRootCompanion[OneListOfOneDecimals_6]{
