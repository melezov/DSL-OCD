...
class NullableString_2 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableString_2 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableString_2("+ URI +")"

   def copy(nullableString: Option[String] = this._nullableString): NullableString_2 = {
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.aggregates.SurrogatePrimaryKeyWithOnePropertyInAggregate.NullableString_2): this.type = {
...
object NullableString_2 extends AggregateRootCompanion[NullableString_2]{
