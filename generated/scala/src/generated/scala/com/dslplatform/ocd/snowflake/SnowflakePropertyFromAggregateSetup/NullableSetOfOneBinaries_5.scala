...
class NullableSetOfOneBinaries_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableSetOfOneBinaries_5 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableSetOfOneBinaries_5("+ URI +")"

   def copy(nullableSetOfOneBinaries: Option[Set[Array[Byte]]] = this._nullableSetOfOneBinaries): NullableSetOfOneBinaries_5 = {
  ...
  com.dslplatform.api.Guards.checkCollectionNulls(nullableSetOfOneBinaries)
    new NullableSetOfOneBinaries_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableSetOfOneBinaries = nullableSetOfOneBinaries)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableSetOfOneBinaries_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableSetOfOneBinaries_5](URI), duration)
  }
...
object NullableSetOfOneBinaries_5 extends AggregateRootCompanion[NullableSetOfOneBinaries_5]{
  ...
  def apply(
    ...
    require(nullableSetOfOneBinaries ne null, "Null value was provided for property \"nullableSetOfOneBinaries\"")
    if (nullableSetOfOneBinaries.isDefined) require(nullableSetOfOneBinaries.get ne null, "Null value was provided for property \"nullableSetOfOneBinaries\"")
    new NullableSetOfOneBinaries_5(
      __locator = None
