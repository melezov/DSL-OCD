...
public final class OneSetOfOneBooleansValue3 implements java.io.Serializable {
    public OneSetOfOneBooleansValue3(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1897938442;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneSetOfOneBooleansValue3)) return false;
        final OneSetOfOneBooleansValue3 other = (OneSetOfOneBooleansValue3) obj;
    ...
    public String toString() {
        return "OneSetOfOneBooleansValue3(" + oneSetOfOneBooleans + ')';
    }
    ...
    public OneSetOfOneBooleansValue3 setOneSetOfOneBooleans(
