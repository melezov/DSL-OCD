...
class OneListOfNullableBooleans_6 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: OneListOfNullableBooleans_6 => c.URI == URI
    case _ => false
  }

  override def toString = "OneListOfNullableBooleans_6("+ URI +")"

   def copy(oneListOfNullableBooleans: IndexedSeq[Option[Boolean]] = this._oneListOfNullableBooleans): OneListOfNullableBooleans_6 = {
  ...
  com.dslplatform.api.Guards.checkCollectionOptionValNulls(oneListOfNullableBooleans)
    new OneListOfNullableBooleans_6(_URI = this.URI, __locator = this.__locator, _ID = _ID, _oneListOfNullableBooleans = oneListOfNullableBooleans)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneListOfNullableBooleans_6): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneListOfNullableBooleans_6](URI), duration)
  }
...
object OneListOfNullableBooleans_6 extends AggregateRootCompanion[OneListOfNullableBooleans_6]{
  ...
  def apply(
    ...
    com.dslplatform.api.Guards.checkCollectionOptionValNulls(oneListOfNullableBooleans)
    require(oneListOfNullableBooleans ne null, "Null value was provided for property \"oneListOfNullableBooleans\"")
    new OneListOfNullableBooleans_6(
      __locator = None
