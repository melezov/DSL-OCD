...
class OneListOfNullableTexts_6 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: OneListOfNullableTexts_6 => c.URI == URI
    case _ => false
  }

  override def toString = "OneListOfNullableTexts_6("+ URI +")"

   def copy(oneListOfNullableTexts: IndexedSeq[Option[String]] = this._oneListOfNullableTexts): OneListOfNullableTexts_6 = {
  ...
  com.dslplatform.api.Guards.checkCollectionOptionRefNulls(oneListOfNullableTexts)
    new OneListOfNullableTexts_6(_URI = this.URI, __locator = this.__locator, _ID = _ID, _oneListOfNullableTexts = oneListOfNullableTexts)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneListOfNullableTexts_6): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneListOfNullableTexts_6](URI), duration)
  }
...
object OneListOfNullableTexts_6 extends AggregateRootCompanion[OneListOfNullableTexts_6]{
