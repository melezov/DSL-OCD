...
public final class OneArrayOfNullableTimestampsValue3 implements
        java.io.Serializable {
    public OneArrayOfNullableTimestampsValue3(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1733135472;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfNullableTimestampsValue3)) return false;
        final OneArrayOfNullableTimestampsValue3 other = (OneArrayOfNullableTimestampsValue3) obj;
    ...
    public String toString() {
        return "OneArrayOfNullableTimestampsValue3("
    ...
    public OneArrayOfNullableTimestampsValue3 setOneArrayOfNullableTimestamps(
