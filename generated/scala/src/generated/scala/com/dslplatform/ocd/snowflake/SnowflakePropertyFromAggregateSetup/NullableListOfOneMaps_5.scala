...
class NullableListOfOneMaps_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableListOfOneMaps_5 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableListOfOneMaps_5("+ URI +")"

   def copy(nullableListOfOneMaps: Option[IndexedSeq[Map[String, String]]] = this._nullableListOfOneMaps): NullableListOfOneMaps_5 = {
  ...
  com.dslplatform.api.Guards.checkCollectionNulls(nullableListOfOneMaps)
    new NullableListOfOneMaps_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableListOfOneMaps = nullableListOfOneMaps)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableListOfOneMaps_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableListOfOneMaps_5](URI), duration)
  }
...
object NullableListOfOneMaps_5 extends AggregateRootCompanion[NullableListOfOneMaps_5]{
