...
class NullableListOfNullableIps_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableListOfNullableIps_5 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableListOfNullableIps_5("+ URI +")"

   def copy(nullableListOfNullableIps: Option[IndexedSeq[Option[java.net.InetAddress]]] = this._nullableListOfNullableIps): NullableListOfNullableIps_5 = {
  ...
  com.dslplatform.api.Guards.checkCollectionOptionRefNulls(nullableListOfNullableIps)
    new NullableListOfNullableIps_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableListOfNullableIps = nullableListOfNullableIps)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableListOfNullableIps_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableListOfNullableIps_5](URI), duration)
  }
...
object NullableListOfNullableIps_5 extends AggregateRootCompanion[NullableListOfNullableIps_5]{
  ...
  def apply(
    ...
    require(nullableListOfNullableIps ne null, "Null value was provided for property \"nullableListOfNullableIps\"")
    if (nullableListOfNullableIps.isDefined) require(nullableListOfNullableIps.get ne null, "Null value was provided for property \"nullableListOfNullableIps\"")
    new NullableListOfNullableIps_5(
      __locator = None
