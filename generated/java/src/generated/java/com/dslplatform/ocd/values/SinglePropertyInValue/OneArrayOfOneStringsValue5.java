...
public final class OneArrayOfOneStringsValue5 implements java.io.Serializable {
    public OneArrayOfOneStringsValue5(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1697081792;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfOneStringsValue5)) return false;
        final OneArrayOfOneStringsValue5 other = (OneArrayOfOneStringsValue5) obj;
    ...
    public String toString() {
        return "OneArrayOfOneStringsValue5(" + oneArrayOfOneStrings + ')';
    }
    ...
    public OneArrayOfOneStringsValue5 setOneArrayOfOneStrings(
            final String[] value) {
        if (value == null)
