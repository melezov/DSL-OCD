...
class OneArrayOfNullableIps_3 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: OneArrayOfNullableIps_3 => c.URI == URI
    case _ => false
  }

  override def toString = "OneArrayOfNullableIps_3("+ URI +")"

   def copy(oneArrayOfNullableIps: Array[Option[java.net.InetAddress]] = this._oneArrayOfNullableIps): OneArrayOfNullableIps_3 = {
  ...
  com.dslplatform.api.Guards.checkArrayOptionRefNulls(oneArrayOfNullableIps)
    new OneArrayOfNullableIps_3(_URI = this.URI, __locator = this.__locator, _ID = _ID, _oneArrayOfNullableIps = oneArrayOfNullableIps)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.aggregates.SurrogatePrimaryKeyWithOnePropertyInAggregate.OneArrayOfNullableIps_3): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.aggregates.SurrogatePrimaryKeyWithOnePropertyInAggregate.OneArrayOfNullableIps_3](URI), duration)
  }
...
object OneArrayOfNullableIps_3 extends AggregateRootCompanion[OneArrayOfNullableIps_3]{
