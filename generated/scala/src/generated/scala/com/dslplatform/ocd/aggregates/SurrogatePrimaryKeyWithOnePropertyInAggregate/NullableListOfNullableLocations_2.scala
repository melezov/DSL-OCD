...
class NullableListOfNullableLocations_2 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableListOfNullableLocations_2 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableListOfNullableLocations_2("+ URI +")"

   def copy(nullableListOfNullableLocations: Option[IndexedSeq[Option[java.awt.geom.Point2D]]] = this._nullableListOfNullableLocations): NullableListOfNullableLocations_2 = {
  ...
  com.dslplatform.api.Guards.checkCollectionOptionRefNulls(nullableListOfNullableLocations)
    new NullableListOfNullableLocations_2(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableListOfNullableLocations = nullableListOfNullableLocations)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.aggregates.SurrogatePrimaryKeyWithOnePropertyInAggregate.NullableListOfNullableLocations_2): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.aggregates.SurrogatePrimaryKeyWithOnePropertyInAggregate.NullableListOfNullableLocations_2](URI), duration)
  }

  @com.fasterxml.jackson.annotation.JsonGetter("nullableListOfNullableLocations")
...
object NullableListOfNullableLocations_2 extends AggregateRootCompanion[NullableListOfNullableLocations_2]{
  ...
  def apply(
    ...
    require(nullableListOfNullableLocations ne null, "Null value was provided for property \"nullableListOfNullableLocations\"")
    if (nullableListOfNullableLocations.isDefined) require(nullableListOfNullableLocations.get ne null, "Null value was provided for property \"nullableListOfNullableLocations\"")
    new NullableListOfNullableLocations_2(
      __locator = None
