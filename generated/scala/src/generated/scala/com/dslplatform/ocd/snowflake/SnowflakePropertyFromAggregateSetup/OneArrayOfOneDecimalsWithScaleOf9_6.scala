...
class OneArrayOfOneDecimalsWithScaleOf9_6 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: OneArrayOfOneDecimalsWithScaleOf9_6 => c.URI == URI
    case _ => false
  }

  override def toString = "OneArrayOfOneDecimalsWithScaleOf9_6("+ URI +")"

   def copy(oneArrayOfOneDecimalsWithScaleOf9: Array[BigDecimal] = this._oneArrayOfOneDecimalsWithScaleOf9): OneArrayOfOneDecimalsWithScaleOf9_6 = {
  ...
  com.dslplatform.api.Guards.checkArrayNulls(oneArrayOfOneDecimalsWithScaleOf9)
    new OneArrayOfOneDecimalsWithScaleOf9_6(_URI = this.URI, __locator = this.__locator, _ID = _ID, _oneArrayOfOneDecimalsWithScaleOf9 = oneArrayOfOneDecimalsWithScaleOf9)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneArrayOfOneDecimalsWithScaleOf9_6): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneArrayOfOneDecimalsWithScaleOf9_6](URI), duration)
  }
...
object OneArrayOfOneDecimalsWithScaleOf9_6 extends AggregateRootCompanion[OneArrayOfOneDecimalsWithScaleOf9_6]{
  ...
  def apply(
    ...
    com.dslplatform.api.Guards.checkArrayNulls(oneArrayOfOneDecimalsWithScaleOf9)
    require(oneArrayOfOneDecimalsWithScaleOf9 ne null, "Null value was provided for property \"oneArrayOfOneDecimalsWithScaleOf9\"")
    new OneArrayOfOneDecimalsWithScaleOf9_6(
      __locator = None
