...
class NullableListOfOneRectangles_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableListOfOneRectangles_5 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableListOfOneRectangles_5("+ URI +")"

   def copy(nullableListOfOneRectangles: Option[IndexedSeq[java.awt.geom.Rectangle2D]] = this._nullableListOfOneRectangles): NullableListOfOneRectangles_5 = {
  ...
  com.dslplatform.api.Guards.checkCollectionNulls(nullableListOfOneRectangles)
    new NullableListOfOneRectangles_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableListOfOneRectangles = nullableListOfOneRectangles)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableListOfOneRectangles_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableListOfOneRectangles_5](URI), duration)
  }
...
object NullableListOfOneRectangles_5 extends AggregateRootCompanion[NullableListOfOneRectangles_5]{
  ...
  def apply(
    ...
    require(nullableListOfOneRectangles ne null, "Null value was provided for property \"nullableListOfOneRectangles\"")
    if (nullableListOfOneRectangles.isDefined) require(nullableListOfOneRectangles.get ne null, "Null value was provided for property \"nullableListOfOneRectangles\"")
    new NullableListOfOneRectangles_5(
      __locator = None
