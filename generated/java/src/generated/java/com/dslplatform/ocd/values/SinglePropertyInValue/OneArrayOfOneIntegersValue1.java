...
public final class OneArrayOfOneIntegersValue1 implements java.io.Serializable {
    public OneArrayOfOneIntegersValue1(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1196467561;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfOneIntegersValue1)) return false;
        final OneArrayOfOneIntegersValue1 other = (OneArrayOfOneIntegersValue1) obj;
    ...
    public String toString() {
        return "OneArrayOfOneIntegersValue1(" + oneArrayOfOneIntegers + ')';
    }
    ...
    public OneArrayOfOneIntegersValue1 setOneArrayOfOneIntegers(
            final int[] value) {
        if (value == null)
