...
class OneArrayOfOneDates_6 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: OneArrayOfOneDates_6 => c.URI == URI
    case _ => false
  }

  override def toString = "OneArrayOfOneDates_6("+ URI +")"

   def copy(oneArrayOfOneDates: Array[org.joda.time.LocalDate] = this._oneArrayOfOneDates): OneArrayOfOneDates_6 = {
  ...
  com.dslplatform.api.Guards.checkArrayNulls(oneArrayOfOneDates)
    new OneArrayOfOneDates_6(_URI = this.URI, __locator = this.__locator, _ID = _ID, _oneArrayOfOneDates = oneArrayOfOneDates)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneArrayOfOneDates_6): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneArrayOfOneDates_6](URI), duration)
  }
...
object OneArrayOfOneDates_6 extends AggregateRootCompanion[OneArrayOfOneDates_6]{
