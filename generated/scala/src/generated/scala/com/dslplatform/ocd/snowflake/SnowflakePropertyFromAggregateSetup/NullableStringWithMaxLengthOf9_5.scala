...
class NullableStringWithMaxLengthOf9_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableStringWithMaxLengthOf9_5 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableStringWithMaxLengthOf9_5("+ URI +")"

   def copy(nullableStringWithMaxLengthOf9: Option[String] = this._nullableStringWithMaxLengthOf9): NullableStringWithMaxLengthOf9_5 = {
  ...
  com.dslplatform.api.Guards.checkLength(nullableStringWithMaxLengthOf9, 9)
    new NullableStringWithMaxLengthOf9_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableStringWithMaxLengthOf9 = nullableStringWithMaxLengthOf9)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableStringWithMaxLengthOf9_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableStringWithMaxLengthOf9_5](URI), duration)
  }
...
object NullableStringWithMaxLengthOf9_5 extends AggregateRootCompanion[NullableStringWithMaxLengthOf9_5]{
  ...
  def apply(
    ...
    require(nullableStringWithMaxLengthOf9 ne null, "Null value was provided for property \"nullableStringWithMaxLengthOf9\"")
    if (nullableStringWithMaxLengthOf9.isDefined) require(nullableStringWithMaxLengthOf9.get ne null, "Null value was provided for property \"nullableStringWithMaxLengthOf9\"")
    new NullableStringWithMaxLengthOf9_5(
      __locator = None
