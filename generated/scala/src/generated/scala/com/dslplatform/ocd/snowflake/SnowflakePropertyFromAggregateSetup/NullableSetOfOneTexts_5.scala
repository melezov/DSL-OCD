...
class NullableSetOfOneTexts_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableSetOfOneTexts_5 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableSetOfOneTexts_5("+ URI +")"

   def copy(nullableSetOfOneTexts: Option[Set[String]] = this._nullableSetOfOneTexts): NullableSetOfOneTexts_5 = {
  ...
  com.dslplatform.api.Guards.checkCollectionNulls(nullableSetOfOneTexts)
    new NullableSetOfOneTexts_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableSetOfOneTexts = nullableSetOfOneTexts)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableSetOfOneTexts_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableSetOfOneTexts_5](URI), duration)
  }
...
object NullableSetOfOneTexts_5 extends AggregateRootCompanion[NullableSetOfOneTexts_5]{
