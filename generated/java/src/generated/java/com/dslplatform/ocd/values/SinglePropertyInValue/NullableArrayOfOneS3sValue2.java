...
public final class NullableArrayOfOneS3sValue2 implements java.io.Serializable {
    public NullableArrayOfOneS3sValue2(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 2085385683;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof NullableArrayOfOneS3sValue2)) return false;
        final NullableArrayOfOneS3sValue2 other = (NullableArrayOfOneS3sValue2) obj;
    ...
    public String toString() {
        return "NullableArrayOfOneS3sValue2(" + nullableArrayOfOneS3s + ')';
    }
    ...
    public NullableArrayOfOneS3sValue2 setNullableArrayOfOneS3s(
