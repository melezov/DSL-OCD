...
public final class OneArrayOfNullableFloatsValue5 implements
        java.io.Serializable {
    public OneArrayOfNullableFloatsValue5(
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfNullableFloatsValue5)) return false;
        final OneArrayOfNullableFloatsValue5 other = (OneArrayOfNullableFloatsValue5) obj;
    ...
    public String toString() {
        return "OneArrayOfNullableFloatsValue5(" + oneArrayOfNullableFloats
                + ')';
    }
    ...
    public OneArrayOfNullableFloatsValue5 setOneArrayOfNullableFloats(
            final Float[] value) {
        if (value == null)
