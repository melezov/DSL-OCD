...
public final class NullableArrayOfOneTimestampsValue3 implements
        java.io.Serializable {
    public NullableArrayOfOneTimestampsValue3(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1503453672;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof NullableArrayOfOneTimestampsValue3)) return false;
        final NullableArrayOfOneTimestampsValue3 other = (NullableArrayOfOneTimestampsValue3) obj;
    ...
    public String toString() {
        return "NullableArrayOfOneTimestampsValue3("
    ...
    public NullableArrayOfOneTimestampsValue3 setNullableArrayOfOneTimestamps(
