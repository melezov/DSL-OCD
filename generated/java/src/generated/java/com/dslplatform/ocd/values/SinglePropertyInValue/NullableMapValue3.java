...
public final class NullableMapValue3 implements java.io.Serializable {
    public NullableMapValue3(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 2121618185;
        result = prime * result
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof NullableMapValue3)) return false;
        final NullableMapValue3 other = (NullableMapValue3) obj;
    ...
    public String toString() {
        return "NullableMapValue3(" + nullableMap + ')';
    }
    ...
    public NullableMapValue3 setNullableMap(
