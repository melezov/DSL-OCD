...
class NullableRectangle_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableRectangle_5 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableRectangle_5("+ URI +")"

   def copy(nullableRectangle: Option[java.awt.geom.Rectangle2D] = this._nullableRectangle): NullableRectangle_5 = {
  ...
  if(nullableRectangle.isDefined) require(nullableRectangle.get ne null, "Null value was provided for property \"nullableRectangle\"")
    new NullableRectangle_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableRectangle = nullableRectangle)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableRectangle_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableRectangle_5](URI), duration)
  }
...
object NullableRectangle_5 extends AggregateRootCompanion[NullableRectangle_5]{
