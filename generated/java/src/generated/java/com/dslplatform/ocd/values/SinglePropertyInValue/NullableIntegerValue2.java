...
public final class NullableIntegerValue2 implements java.io.Serializable {
    public NullableIntegerValue2(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1325358454;
        result = prime
                * result
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof NullableIntegerValue2)) return false;
        final NullableIntegerValue2 other = (NullableIntegerValue2) obj;
    ...
    public String toString() {
        return "NullableIntegerValue2(" + nullableInteger + ')';
    }
    ...
    public NullableIntegerValue2 setNullableInteger(final Integer value) {
