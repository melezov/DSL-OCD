...
class OneListOfOneRectangles_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: OneListOfOneRectangles_5 => c.URI == URI
    case _ => false
  }

  override def toString = "OneListOfOneRectangles_5("+ URI +")"

   def copy(oneListOfOneRectangles: IndexedSeq[java.awt.geom.Rectangle2D] = this._oneListOfOneRectangles): OneListOfOneRectangles_5 = {
  ...
  com.dslplatform.api.Guards.checkCollectionNulls(oneListOfOneRectangles)
    new OneListOfOneRectangles_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _oneListOfOneRectangles = oneListOfOneRectangles)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneListOfOneRectangles_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneListOfOneRectangles_5](URI), duration)
  }
...
object OneListOfOneRectangles_5 extends AggregateRootCompanion[OneListOfOneRectangles_5]{
