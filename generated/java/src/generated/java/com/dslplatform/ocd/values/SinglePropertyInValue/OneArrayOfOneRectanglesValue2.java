...
public final class OneArrayOfOneRectanglesValue2 implements
        java.io.Serializable {
    public OneArrayOfOneRectanglesValue2(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1355822067;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfOneRectanglesValue2)) return false;
        final OneArrayOfOneRectanglesValue2 other = (OneArrayOfOneRectanglesValue2) obj;
    ...
    public String toString() {
        return "OneArrayOfOneRectanglesValue2(" + oneArrayOfOneRectangles + ')';
    }
    ...
    public OneArrayOfOneRectanglesValue2 setOneArrayOfOneRectangles(
