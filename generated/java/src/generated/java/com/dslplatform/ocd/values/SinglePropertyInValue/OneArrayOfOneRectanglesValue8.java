...
public final class OneArrayOfOneRectanglesValue8 implements
        java.io.Serializable {
    public OneArrayOfOneRectanglesValue8(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1355822057;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfOneRectanglesValue8)) return false;
        final OneArrayOfOneRectanglesValue8 other = (OneArrayOfOneRectanglesValue8) obj;
    ...
    public String toString() {
        return "OneArrayOfOneRectanglesValue8(" + oneArrayOfOneRectangles + ')';
    }
    ...
    public OneArrayOfOneRectanglesValue8 setOneArrayOfOneRectangles(
