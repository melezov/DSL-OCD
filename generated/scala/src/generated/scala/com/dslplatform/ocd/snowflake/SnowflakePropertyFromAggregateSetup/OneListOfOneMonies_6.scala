...
class OneListOfOneMonies_6 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: OneListOfOneMonies_6 => c.URI == URI
    case _ => false
  }

  override def toString = "OneListOfOneMonies_6("+ URI +")"

   def copy(oneListOfOneMonies: IndexedSeq[BigDecimal] = this._oneListOfOneMonies): OneListOfOneMonies_6 = {
  ...
  com.dslplatform.api.Guards.checkCollectionNulls(oneListOfOneMonies)
    new OneListOfOneMonies_6(_URI = this.URI, __locator = this.__locator, _ID = _ID, _oneListOfOneMonies = oneListOfOneMonies)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneListOfOneMonies_6): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneListOfOneMonies_6](URI), duration)
  }
...
object OneListOfOneMonies_6 extends AggregateRootCompanion[OneListOfOneMonies_6]{
