...
public final class OneArrayOfOneImagesValue3 implements java.io.Serializable {
    public OneArrayOfOneImagesValue3(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1231038610;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfOneImagesValue3)) return false;
        final OneArrayOfOneImagesValue3 other = (OneArrayOfOneImagesValue3) obj;
    ...
    public String toString() {
        return "OneArrayOfOneImagesValue3(" + oneArrayOfOneImages + ')';
    }
    ...
    public OneArrayOfOneImagesValue3 setOneArrayOfOneImages(
