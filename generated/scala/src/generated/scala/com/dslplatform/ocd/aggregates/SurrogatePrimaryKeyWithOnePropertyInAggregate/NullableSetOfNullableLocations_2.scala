...
class NullableSetOfNullableLocations_2 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableSetOfNullableLocations_2 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableSetOfNullableLocations_2("+ URI +")"

   def copy(nullableSetOfNullableLocations: Option[Set[Option[java.awt.geom.Point2D]]] = this._nullableSetOfNullableLocations): NullableSetOfNullableLocations_2 = {
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.aggregates.SurrogatePrimaryKeyWithOnePropertyInAggregate.NullableSetOfNullableLocations_2): this.type = {
...
object NullableSetOfNullableLocations_2 extends AggregateRootCompanion[NullableSetOfNullableLocations_2]{
  ...
  def apply(
    ...
    require(nullableSetOfNullableLocations ne null, "Null value was provided for property \"nullableSetOfNullableLocations\"")
    if (nullableSetOfNullableLocations.isDefined) require(nullableSetOfNullableLocations.get ne null, "Null value was provided for property \"nullableSetOfNullableLocations\"")
    new NullableSetOfNullableLocations_2(
      __locator = None
