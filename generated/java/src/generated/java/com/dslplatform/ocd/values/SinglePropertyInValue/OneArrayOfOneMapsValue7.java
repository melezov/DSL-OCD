...
public final class OneArrayOfOneMapsValue7 implements java.io.Serializable {
    public OneArrayOfOneMapsValue7(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1240123327;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfOneMapsValue7)) return false;
        final OneArrayOfOneMapsValue7 other = (OneArrayOfOneMapsValue7) obj;
    ...
    public String toString() {
        return "OneArrayOfOneMapsValue7(" + oneArrayOfOneMaps + ')';
    }
    ...
    public OneArrayOfOneMapsValue7 setOneArrayOfOneMaps(
