...
public final class NullableListOfNullableDoublesValue2 implements
        java.io.Serializable {
    public NullableListOfNullableDoublesValue2(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1435965558;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof NullableListOfNullableDoublesValue2))
            return false;
        final NullableListOfNullableDoublesValue2 other = (NullableListOfNullableDoublesValue2) obj;
    ...
    public String toString() {
        return "NullableListOfNullableDoublesValue2("
    ...
    public NullableListOfNullableDoublesValue2 setNullableListOfNullableDoubles(
