...
class NullableListOfNullableFloats_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableListOfNullableFloats_5 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableListOfNullableFloats_5("+ URI +")"

   def copy(nullableListOfNullableFloats: Option[IndexedSeq[Option[Float]]] = this._nullableListOfNullableFloats): NullableListOfNullableFloats_5 = {
  ...
  com.dslplatform.api.Guards.checkCollectionOptionValNulls(nullableListOfNullableFloats)
    new NullableListOfNullableFloats_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableListOfNullableFloats = nullableListOfNullableFloats)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableListOfNullableFloats_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableListOfNullableFloats_5](URI), duration)
  }
...
object NullableListOfNullableFloats_5 extends AggregateRootCompanion[NullableListOfNullableFloats_5]{
  ...
  def apply(
    ...
    require(nullableListOfNullableFloats ne null, "Null value was provided for property \"nullableListOfNullableFloats\"")
    if (nullableListOfNullableFloats.isDefined) require(nullableListOfNullableFloats.get ne null, "Null value was provided for property \"nullableListOfNullableFloats\"")
    new NullableListOfNullableFloats_5(
      __locator = None
