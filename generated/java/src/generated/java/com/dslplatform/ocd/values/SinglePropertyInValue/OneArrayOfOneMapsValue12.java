...
public final class OneArrayOfOneMapsValue12 implements java.io.Serializable {
    public OneArrayOfOneMapsValue12(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1270377163;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfOneMapsValue12)) return false;
        final OneArrayOfOneMapsValue12 other = (OneArrayOfOneMapsValue12) obj;
    ...
    public String toString() {
        return "OneArrayOfOneMapsValue12(" + oneArrayOfOneMaps + ')';
    }
    ...
    public OneArrayOfOneMapsValue12 setOneArrayOfOneMaps(
