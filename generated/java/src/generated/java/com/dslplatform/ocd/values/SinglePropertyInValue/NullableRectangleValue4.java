...
public final class NullableRectangleValue4 implements java.io.Serializable {
    public NullableRectangleValue4(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1917131883;
        result = prime
                * result
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof NullableRectangleValue4)) return false;
        final NullableRectangleValue4 other = (NullableRectangleValue4) obj;
    ...
    public String toString() {
        return "NullableRectangleValue4(" + nullableRectangle + ')';
    }
    ...
    public NullableRectangleValue4 setNullableRectangle(
