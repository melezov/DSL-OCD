...
class NullableSetOfOneDecimalsWithScaleOf9_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableSetOfOneDecimalsWithScaleOf9_5 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableSetOfOneDecimalsWithScaleOf9_5("+ URI +")"

   def copy(nullableSetOfOneDecimalsWithScaleOf9: Option[Set[BigDecimal]] = this._nullableSetOfOneDecimalsWithScaleOf9): NullableSetOfOneDecimalsWithScaleOf9_5 = {
  ...
  com.dslplatform.api.Guards.checkCollectionNulls(nullableSetOfOneDecimalsWithScaleOf9)
    new NullableSetOfOneDecimalsWithScaleOf9_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableSetOfOneDecimalsWithScaleOf9 = nullableSetOfOneDecimalsWithScaleOf9)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableSetOfOneDecimalsWithScaleOf9_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableSetOfOneDecimalsWithScaleOf9_5](URI), duration)
  }
...
object NullableSetOfOneDecimalsWithScaleOf9_5 extends AggregateRootCompanion[NullableSetOfOneDecimalsWithScaleOf9_5]{
