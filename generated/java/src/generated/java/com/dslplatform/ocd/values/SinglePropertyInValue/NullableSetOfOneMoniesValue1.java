...
public final class NullableSetOfOneMoniesValue1 implements java.io.Serializable {
    public NullableSetOfOneMoniesValue1(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1223767987;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof NullableSetOfOneMoniesValue1)) return false;
        final NullableSetOfOneMoniesValue1 other = (NullableSetOfOneMoniesValue1) obj;
    ...
    public String toString() {
        return "NullableSetOfOneMoniesValue1(" + nullableSetOfOneMonies + ')';
    }
    ...
    public NullableSetOfOneMoniesValue1 setNullableSetOfOneMonies(
