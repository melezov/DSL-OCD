...
class NullableSetOfNullableStringsWithMaxLengthOf9_2 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableSetOfNullableStringsWithMaxLengthOf9_2 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableSetOfNullableStringsWithMaxLengthOf9_2("+ URI +")"

   def copy(nullableSetOfNullableStringsWithMaxLengthOf9: Option[Set[Option[String]]] = this._nullableSetOfNullableStringsWithMaxLengthOf9): NullableSetOfNullableStringsWithMaxLengthOf9_2 = {
  ...
  com.dslplatform.api.Guards.checkCollectionOptionRefNulls(nullableSetOfNullableStringsWithMaxLengthOf9)
    new NullableSetOfNullableStringsWithMaxLengthOf9_2(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableSetOfNullableStringsWithMaxLengthOf9 = nullableSetOfNullableStringsWithMaxLengthOf9)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.aggregates.SurrogatePrimaryKeyWithOnePropertyInAggregate.NullableSetOfNullableStringsWithMaxLengthOf9_2): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.aggregates.SurrogatePrimaryKeyWithOnePropertyInAggregate.NullableSetOfNullableStringsWithMaxLengthOf9_2](URI), duration)
  }

  @com.fasterxml.jackson.annotation.JsonGetter("nullableSetOfNullableStringsWithMaxLengthOf9")
...
object NullableSetOfNullableStringsWithMaxLengthOf9_2 extends AggregateRootCompanion[NullableSetOfNullableStringsWithMaxLengthOf9_2]{
