...
class NullableArrayOfOneMaps_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableArrayOfOneMaps_5 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableArrayOfOneMaps_5("+ URI +")"

   def copy(nullableArrayOfOneMaps: Option[Array[Map[String, String]]] = this._nullableArrayOfOneMaps): NullableArrayOfOneMaps_5 = {
  ...
  com.dslplatform.api.Guards.checkArrayNulls(nullableArrayOfOneMaps)
    new NullableArrayOfOneMaps_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableArrayOfOneMaps = nullableArrayOfOneMaps)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableArrayOfOneMaps_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableArrayOfOneMaps_5](URI), duration)
  }
...
object NullableArrayOfOneMaps_5 extends AggregateRootCompanion[NullableArrayOfOneMaps_5]{
