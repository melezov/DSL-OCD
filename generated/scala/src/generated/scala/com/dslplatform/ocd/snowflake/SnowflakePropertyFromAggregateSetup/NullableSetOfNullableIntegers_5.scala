...
class NullableSetOfNullableIntegers_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableSetOfNullableIntegers_5 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableSetOfNullableIntegers_5("+ URI +")"

   def copy(nullableSetOfNullableIntegers: Option[Set[Option[Int]]] = this._nullableSetOfNullableIntegers): NullableSetOfNullableIntegers_5 = {
  ...
  com.dslplatform.api.Guards.checkCollectionOptionValNulls(nullableSetOfNullableIntegers)
    new NullableSetOfNullableIntegers_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableSetOfNullableIntegers = nullableSetOfNullableIntegers)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableSetOfNullableIntegers_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableSetOfNullableIntegers_5](URI), duration)
  }
  ...
  , @com.fasterxml.jackson.annotation.JsonProperty("nullableSetOfNullableIntegers") nullableSetOfNullableIntegers: Option[Set[Option[Int]]]
    ...
    this(__locator = Some(__locator), _URI = URI, _ID = ID, _nullableSetOfNullableIntegers = nullableSetOfNullableIntegers)

}

object NullableSetOfNullableIntegers_5 extends AggregateRootCompanion[NullableSetOfNullableIntegers_5]{
  ...
  def apply(
    ...
    require(nullableSetOfNullableIntegers ne null, "Null value was provided for property \"nullableSetOfNullableIntegers\"")
    if (nullableSetOfNullableIntegers.isDefined) require(nullableSetOfNullableIntegers.get ne null, "Null value was provided for property \"nullableSetOfNullableIntegers\"")
    new NullableSetOfNullableIntegers_5(
      __locator = None
