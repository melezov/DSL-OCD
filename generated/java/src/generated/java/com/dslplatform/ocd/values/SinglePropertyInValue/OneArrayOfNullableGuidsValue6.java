...
public final class OneArrayOfNullableGuidsValue6 implements
        java.io.Serializable {
    public OneArrayOfNullableGuidsValue6(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1455438858;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfNullableGuidsValue6)) return false;
        final OneArrayOfNullableGuidsValue6 other = (OneArrayOfNullableGuidsValue6) obj;
    ...
    public String toString() {
        return "OneArrayOfNullableGuidsValue6(" + oneArrayOfNullableGuids + ')';
    }
    ...
    public OneArrayOfNullableGuidsValue6 setOneArrayOfNullableGuids(
