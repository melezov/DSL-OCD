...
class OneArrayOfNullableDecimals_6 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: OneArrayOfNullableDecimals_6 => c.URI == URI
    case _ => false
  }

  override def toString = "OneArrayOfNullableDecimals_6("+ URI +")"

   def copy(oneArrayOfNullableDecimals: Array[Option[BigDecimal]] = this._oneArrayOfNullableDecimals): OneArrayOfNullableDecimals_6 = {
  ...
  com.dslplatform.api.Guards.checkArrayOptionRefNulls(oneArrayOfNullableDecimals)
    new OneArrayOfNullableDecimals_6(_URI = this.URI, __locator = this.__locator, _ID = _ID, _oneArrayOfNullableDecimals = oneArrayOfNullableDecimals)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneArrayOfNullableDecimals_6): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneArrayOfNullableDecimals_6](URI), duration)
  }
...
object OneArrayOfNullableDecimals_6 extends AggregateRootCompanion[OneArrayOfNullableDecimals_6]{
  ...
  def apply(
    ...
    com.dslplatform.api.Guards.checkArrayOptionRefNulls(oneArrayOfNullableDecimals)
    require(oneArrayOfNullableDecimals ne null, "Null value was provided for property \"oneArrayOfNullableDecimals\"")
    new OneArrayOfNullableDecimals_6(
      __locator = None
