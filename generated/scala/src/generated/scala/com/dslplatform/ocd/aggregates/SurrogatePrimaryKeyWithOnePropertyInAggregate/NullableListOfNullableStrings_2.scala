...
class NullableListOfNullableStrings_2 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableListOfNullableStrings_2 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableListOfNullableStrings_2("+ URI +")"

   def copy(nullableListOfNullableStrings: Option[IndexedSeq[Option[String]]] = this._nullableListOfNullableStrings): NullableListOfNullableStrings_2 = {
  ...
  com.dslplatform.api.Guards.checkCollectionOptionRefNulls(nullableListOfNullableStrings)
    new NullableListOfNullableStrings_2(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableListOfNullableStrings = nullableListOfNullableStrings)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.aggregates.SurrogatePrimaryKeyWithOnePropertyInAggregate.NullableListOfNullableStrings_2): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.aggregates.SurrogatePrimaryKeyWithOnePropertyInAggregate.NullableListOfNullableStrings_2](URI), duration)
  }

  @com.fasterxml.jackson.annotation.JsonGetter("nullableListOfNullableStrings")
...
object NullableListOfNullableStrings_2 extends AggregateRootCompanion[NullableListOfNullableStrings_2]{
  ...
  def apply(
    ...
    require(nullableListOfNullableStrings ne null, "Null value was provided for property \"nullableListOfNullableStrings\"")
    if (nullableListOfNullableStrings.isDefined) require(nullableListOfNullableStrings.get ne null, "Null value was provided for property \"nullableListOfNullableStrings\"")
    new NullableListOfNullableStrings_2(
      __locator = None
