...
public final class NullableSetOfOneBooleansValue5 implements
        java.io.Serializable {
    public NullableSetOfOneBooleansValue5(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1564058381;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof NullableSetOfOneBooleansValue5)) return false;
        final NullableSetOfOneBooleansValue5 other = (NullableSetOfOneBooleansValue5) obj;
    ...
    public String toString() {
        return "NullableSetOfOneBooleansValue5(" + nullableSetOfOneBooleans
                + ')';
    }
    ...
    public NullableSetOfOneBooleansValue5 setNullableSetOfOneBooleans(
