...
public final class OneArrayOfNullableRectanglesValue5 implements
        java.io.Serializable {
    public OneArrayOfNullableRectanglesValue5(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1940955305;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfNullableRectanglesValue5)) return false;
        final OneArrayOfNullableRectanglesValue5 other = (OneArrayOfNullableRectanglesValue5) obj;
    ...
    public String toString() {
        return "OneArrayOfNullableRectanglesValue5("
    ...
    public OneArrayOfNullableRectanglesValue5 setOneArrayOfNullableRectangles(
