...
class OneArrayOfOneTimestamps_3 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: OneArrayOfOneTimestamps_3 => c.URI == URI
    case _ => false
  }

  override def toString = "OneArrayOfOneTimestamps_3("+ URI +")"

   def copy(oneArrayOfOneTimestamps: Array[org.joda.time.DateTime] = this._oneArrayOfOneTimestamps): OneArrayOfOneTimestamps_3 = {
  ...
  com.dslplatform.api.Guards.checkArrayNulls(oneArrayOfOneTimestamps)
    new OneArrayOfOneTimestamps_3(_URI = this.URI, __locator = this.__locator, _ID = _ID, _oneArrayOfOneTimestamps = oneArrayOfOneTimestamps)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.aggregates.SurrogatePrimaryKeyWithOnePropertyInAggregate.OneArrayOfOneTimestamps_3): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.aggregates.SurrogatePrimaryKeyWithOnePropertyInAggregate.OneArrayOfOneTimestamps_3](URI), duration)
  }
...
object OneArrayOfOneTimestamps_3 extends AggregateRootCompanion[OneArrayOfOneTimestamps_3]{
