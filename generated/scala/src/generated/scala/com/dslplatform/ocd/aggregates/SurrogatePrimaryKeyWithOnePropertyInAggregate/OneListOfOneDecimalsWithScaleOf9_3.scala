...
class OneListOfOneDecimalsWithScaleOf9_3 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: OneListOfOneDecimalsWithScaleOf9_3 => c.URI == URI
    case _ => false
  }

  override def toString = "OneListOfOneDecimalsWithScaleOf9_3("+ URI +")"

   def copy(oneListOfOneDecimalsWithScaleOf9: IndexedSeq[BigDecimal] = this._oneListOfOneDecimalsWithScaleOf9): OneListOfOneDecimalsWithScaleOf9_3 = {
  ...
  com.dslplatform.api.Guards.checkCollectionNulls(oneListOfOneDecimalsWithScaleOf9)
    new OneListOfOneDecimalsWithScaleOf9_3(_URI = this.URI, __locator = this.__locator, _ID = _ID, _oneListOfOneDecimalsWithScaleOf9 = oneListOfOneDecimalsWithScaleOf9)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.aggregates.SurrogatePrimaryKeyWithOnePropertyInAggregate.OneListOfOneDecimalsWithScaleOf9_3): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.aggregates.SurrogatePrimaryKeyWithOnePropertyInAggregate.OneListOfOneDecimalsWithScaleOf9_3](URI), duration)
  }

  @com.fasterxml.jackson.annotation.JsonGetter("oneListOfOneDecimalsWithScaleOf9")
...
object OneListOfOneDecimalsWithScaleOf9_3 extends AggregateRootCompanion[OneListOfOneDecimalsWithScaleOf9_3]{
  ...
  def apply(
    ...
    com.dslplatform.api.Guards.checkCollectionNulls(oneListOfOneDecimalsWithScaleOf9)
    require(oneListOfOneDecimalsWithScaleOf9 ne null, "Null value was provided for property \"oneListOfOneDecimalsWithScaleOf9\"")
    new OneListOfOneDecimalsWithScaleOf9_3(
      __locator = None
