...
public final class OneArrayOfNullableStringsWithMaxLengthOf9Value5 implements
        java.io.Serializable {
    public OneArrayOfNullableStringsWithMaxLengthOf9Value5(
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneArrayOfNullableStringsWithMaxLengthOf9Value5))
            return false;
        final OneArrayOfNullableStringsWithMaxLengthOf9Value5 other = (OneArrayOfNullableStringsWithMaxLengthOf9Value5) obj;
    ...
    public String toString() {
        return "OneArrayOfNullableStringsWithMaxLengthOf9Value5("
    ...
    public OneArrayOfNullableStringsWithMaxLengthOf9Value5 setOneArrayOfNullableStringsWithMaxLengthOf9(
            final String[] value) {
        if (value == null)
