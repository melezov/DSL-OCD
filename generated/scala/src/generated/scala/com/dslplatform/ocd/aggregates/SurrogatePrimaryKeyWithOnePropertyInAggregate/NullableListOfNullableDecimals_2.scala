...
class NullableListOfNullableDecimals_2 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableListOfNullableDecimals_2 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableListOfNullableDecimals_2("+ URI +")"

   def copy(nullableListOfNullableDecimals: Option[IndexedSeq[Option[BigDecimal]]] = this._nullableListOfNullableDecimals): NullableListOfNullableDecimals_2 = {
  ...
  com.dslplatform.api.Guards.checkCollectionOptionRefNulls(nullableListOfNullableDecimals)
    new NullableListOfNullableDecimals_2(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableListOfNullableDecimals = nullableListOfNullableDecimals)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.aggregates.SurrogatePrimaryKeyWithOnePropertyInAggregate.NullableListOfNullableDecimals_2): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.aggregates.SurrogatePrimaryKeyWithOnePropertyInAggregate.NullableListOfNullableDecimals_2](URI), duration)
  }

  @com.fasterxml.jackson.annotation.JsonGetter("nullableListOfNullableDecimals")
...
object NullableListOfNullableDecimals_2 extends AggregateRootCompanion[NullableListOfNullableDecimals_2]{
  ...
  def apply(
    ...
    require(nullableListOfNullableDecimals ne null, "Null value was provided for property \"nullableListOfNullableDecimals\"")
    if (nullableListOfNullableDecimals.isDefined) require(nullableListOfNullableDecimals.get ne null, "Null value was provided for property \"nullableListOfNullableDecimals\"")
    new NullableListOfNullableDecimals_2(
      __locator = None
