...
class NullableListOfOneStrings_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableListOfOneStrings_5 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableListOfOneStrings_5("+ URI +")"

   def copy(nullableListOfOneStrings: Option[IndexedSeq[String]] = this._nullableListOfOneStrings): NullableListOfOneStrings_5 = {
  ...
  com.dslplatform.api.Guards.checkCollectionNulls(nullableListOfOneStrings)
    new NullableListOfOneStrings_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableListOfOneStrings = nullableListOfOneStrings)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableListOfOneStrings_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableListOfOneStrings_5](URI), duration)
  }
...
object NullableListOfOneStrings_5 extends AggregateRootCompanion[NullableListOfOneStrings_5]{
  ...
  def apply(
    ...
    require(nullableListOfOneStrings ne null, "Null value was provided for property \"nullableListOfOneStrings\"")
    if (nullableListOfOneStrings.isDefined) require(nullableListOfOneStrings.get ne null, "Null value was provided for property \"nullableListOfOneStrings\"")
    new NullableListOfOneStrings_5(
      __locator = None
