...
class OneArrayOfNullableXmls_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: OneArrayOfNullableXmls_5 => c.URI == URI
    case _ => false
  }

  override def toString = "OneArrayOfNullableXmls_5("+ URI +")"

   def copy(oneArrayOfNullableXmls: Array[Option[scala.xml.Elem]] = this._oneArrayOfNullableXmls): OneArrayOfNullableXmls_5 = {
  ...
  com.dslplatform.api.Guards.checkArrayOptionRefNulls(oneArrayOfNullableXmls)
    new OneArrayOfNullableXmls_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _oneArrayOfNullableXmls = oneArrayOfNullableXmls)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneArrayOfNullableXmls_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneArrayOfNullableXmls_5](URI), duration)
  }
...
object OneArrayOfNullableXmls_5 extends AggregateRootCompanion[OneArrayOfNullableXmls_5]{
