...
class NullableArrayOfNullableBinaries_5 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableArrayOfNullableBinaries_5 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableArrayOfNullableBinaries_5("+ URI +")"

   def copy(nullableArrayOfNullableBinaries: Option[Array[Option[Array[Byte]]]] = this._nullableArrayOfNullableBinaries): NullableArrayOfNullableBinaries_5 = {
  ...
  com.dslplatform.api.Guards.checkArrayOptionRefNulls(nullableArrayOfNullableBinaries)
    new NullableArrayOfNullableBinaries_5(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableArrayOfNullableBinaries = nullableArrayOfNullableBinaries)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableArrayOfNullableBinaries_5): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.NullableArrayOfNullableBinaries_5](URI), duration)
  }
...
object NullableArrayOfNullableBinaries_5 extends AggregateRootCompanion[NullableArrayOfNullableBinaries_5]{
  ...
  def apply(
    ...
    require(nullableArrayOfNullableBinaries ne null, "Null value was provided for property \"nullableArrayOfNullableBinaries\"")
    if (nullableArrayOfNullableBinaries.isDefined) require(nullableArrayOfNullableBinaries.get ne null, "Null value was provided for property \"nullableArrayOfNullableBinaries\"")
    new NullableArrayOfNullableBinaries_5(
      __locator = None
