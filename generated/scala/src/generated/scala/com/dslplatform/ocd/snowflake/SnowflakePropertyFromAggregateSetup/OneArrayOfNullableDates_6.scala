...
class OneArrayOfNullableDates_6 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: OneArrayOfNullableDates_6 => c.URI == URI
    case _ => false
  }

  override def toString = "OneArrayOfNullableDates_6("+ URI +")"

   def copy(oneArrayOfNullableDates: Array[Option[org.joda.time.LocalDate]] = this._oneArrayOfNullableDates): OneArrayOfNullableDates_6 = {
  ...
  com.dslplatform.api.Guards.checkArrayOptionRefNulls(oneArrayOfNullableDates)
    new OneArrayOfNullableDates_6(_URI = this.URI, __locator = this.__locator, _ID = _ID, _oneArrayOfNullableDates = oneArrayOfNullableDates)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneArrayOfNullableDates_6): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneArrayOfNullableDates_6](URI), duration)
  }
...
object OneArrayOfNullableDates_6 extends AggregateRootCompanion[OneArrayOfNullableDates_6]{
