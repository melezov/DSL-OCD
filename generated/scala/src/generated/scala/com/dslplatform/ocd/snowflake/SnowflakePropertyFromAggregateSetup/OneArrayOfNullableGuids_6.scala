...
class OneArrayOfNullableGuids_6 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: OneArrayOfNullableGuids_6 => c.URI == URI
    case _ => false
  }

  override def toString = "OneArrayOfNullableGuids_6("+ URI +")"

   def copy(oneArrayOfNullableGuids: Array[Option[java.util.UUID]] = this._oneArrayOfNullableGuids): OneArrayOfNullableGuids_6 = {
  ...
  com.dslplatform.api.Guards.checkArrayOptionRefNulls(oneArrayOfNullableGuids)
    new OneArrayOfNullableGuids_6(_URI = this.URI, __locator = this.__locator, _ID = _ID, _oneArrayOfNullableGuids = oneArrayOfNullableGuids)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneArrayOfNullableGuids_6): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.snowflake.SnowflakePropertyFromAggregateSetup.OneArrayOfNullableGuids_6](URI), duration)
  }
...
object OneArrayOfNullableGuids_6 extends AggregateRootCompanion[OneArrayOfNullableGuids_6]{
