...
class NullableListOfNullableGuids_2 @com.fasterxml.jackson.annotation.JsonIgnore() private(
  ...
  override def equals(o: Any) = o match {
    case c: NullableListOfNullableGuids_2 => c.URI == URI
    case _ => false
  }

  override def toString = "NullableListOfNullableGuids_2("+ URI +")"

   def copy(nullableListOfNullableGuids: Option[IndexedSeq[Option[java.util.UUID]]] = this._nullableListOfNullableGuids): NullableListOfNullableGuids_2 = {
  ...
  com.dslplatform.api.Guards.checkCollectionOptionRefNulls(nullableListOfNullableGuids)
    new NullableListOfNullableGuids_2(_URI = this.URI, __locator = this.__locator, _ID = _ID, _nullableListOfNullableGuids = nullableListOfNullableGuids)
  }
  ...
  private def updateWithAnother(result: com.dslplatform.ocd.aggregates.SurrogatePrimaryKeyWithOnePropertyInAggregate.NullableListOfNullableGuids_2): this.type = {
  ...
  def delete()(implicit ec: ExecutionContext, duration: Duration) = {
    ...
    Await.result(__locator.get.resolve(classOf[CrudProxy]).delete[com.dslplatform.ocd.aggregates.SurrogatePrimaryKeyWithOnePropertyInAggregate.NullableListOfNullableGuids_2](URI), duration)
  }

  @com.fasterxml.jackson.annotation.JsonGetter("nullableListOfNullableGuids")
...
object NullableListOfNullableGuids_2 extends AggregateRootCompanion[NullableListOfNullableGuids_2]{
  ...
  def apply(
    ...
    require(nullableListOfNullableGuids ne null, "Null value was provided for property \"nullableListOfNullableGuids\"")
    if (nullableListOfNullableGuids.isDefined) require(nullableListOfNullableGuids.get ne null, "Null value was provided for property \"nullableListOfNullableGuids\"")
    new NullableListOfNullableGuids_2(
      __locator = None
