...
public final class OneSetOfOneLongsValue3 implements java.io.Serializable {
    public OneSetOfOneLongsValue3(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 1824679214;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof OneSetOfOneLongsValue3)) return false;
        final OneSetOfOneLongsValue3 other = (OneSetOfOneLongsValue3) obj;
    ...
    public String toString() {
        return "OneSetOfOneLongsValue3(" + oneSetOfOneLongs + ')';
    }
    ...
    public OneSetOfOneLongsValue3 setOneSetOfOneLongs(
