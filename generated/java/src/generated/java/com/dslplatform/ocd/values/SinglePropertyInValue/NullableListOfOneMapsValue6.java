...
public final class NullableListOfOneMapsValue6 implements java.io.Serializable {
    public NullableListOfOneMapsValue6(
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + 2144169412;
        return result;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof NullableListOfOneMapsValue6)) return false;
        final NullableListOfOneMapsValue6 other = (NullableListOfOneMapsValue6) obj;
    ...
    public String toString() {
        return "NullableListOfOneMapsValue6(" + nullableListOfOneMaps + ')';
    }
    ...
    public NullableListOfOneMapsValue6 setNullableListOfOneMaps(
